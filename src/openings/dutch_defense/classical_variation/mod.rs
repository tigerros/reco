...
pub const CLASSICAL_VARIATION: [Opening<'static, &str>; 6] = [
    Opening {
        code: Code {
            volume: Volume::A,
            subcategory: RangedU8::new_static::<84>(),
        },
        name: "Dutch Defense",
    ...
    Opening {
        code: Code {
            volume: Volume::A,
            subcategory: RangedU8::new_static::<90>(),
        },
        name: "Dutch Defense",
        variation: &["Classical Variation"],
        moves: &[
    ...
    Opening {
        code: Code {
            volume: Volume::A,
            subcategory: RangedU8::new_static::<91>(),
        },
        name: "Dutch Defense",
        variation: &["Classical Variation"],
        moves: &[
