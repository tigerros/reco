...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Colle System: Pterodactyl Variation.
pub static PTERODACTYL_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<40>(),
    },
    name: Cow::Borrowed(&["Colle System", "Pterodactyl Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
