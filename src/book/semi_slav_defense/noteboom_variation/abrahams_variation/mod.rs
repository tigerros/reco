...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Semi-Slav Defense: Noteboom Variation, Abrahams Variation.
pub static ABRAHAMS_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::D,
        category: RangedU8::new_static::<31>(),
    },
    name: Cow::Borrowed(&["Semi-Slav Defense", "Noteboom Variation", "Abrahams Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
