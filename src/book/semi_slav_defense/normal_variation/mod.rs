...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Semi-Slav Defense: Normal Variation.
pub static NORMAL_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::D,
        category: RangedU8::new_static::<45>(),
    },
    name: Cow::Borrowed(&["Semi-Slav Defense", "Normal Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
