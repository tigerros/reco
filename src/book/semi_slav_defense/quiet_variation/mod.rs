...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Semi-Slav Defense: Quiet Variation.
pub static QUIET_VARIATION: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::D,
