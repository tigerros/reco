...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Semi-Slav Defense: Chigorin Defense.
pub static CHIGORIN_DEFENSE: [Opening<&str>; 4] = [Opening {
    code: Code {
        volume: Volume::D,
        category: RangedU8::new_static::<46>(),
    },
    name: Cow::Borrowed(&["Semi-Slav Defense", "Chigorin Defense"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
