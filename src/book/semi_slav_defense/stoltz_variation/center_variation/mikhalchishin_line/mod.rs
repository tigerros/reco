...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Semi-Slav Defense: Stoltz Variation, Center Variation, Mikhalchishin Line.
pub static MIKHALCHISHIN_LINE: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::D,
        category: RangedU8::new_static::<45>(),
    },
    name: Cow::Borrowed(&["Semi-Slav Defense", "Stoltz Variation", "Center Variation", "Mikhalchishin Line"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
