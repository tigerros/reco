...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Semi-Slav Defense: Stoltz Variation.
pub static STOLTZ_VARIATION: [Opening<&str>; 4] = [Opening {
    code: Code {
        volume: Volume::D,
        category: RangedU8::new_static::<45>(),
    },
    name: Cow::Borrowed(&["Semi-Slav Defense", "Stoltz Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
