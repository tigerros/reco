...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Semi-Slav Defense: Meran Variation, Stahlberg Variation.
pub static STAHLBERG_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::D,
        category: RangedU8::new_static::<49>(),
    },
    name: Cow::Borrowed(&["Semi-Slav Defense", "Meran Variation", "Stahlberg Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
