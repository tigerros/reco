...
# use reco::book::semi_slav_defense::meran_variation::STAHLBERG_VARIATION;
assert_eq!(STAHLBERG_VARIATION.original_name(), "Semi-Slav Defense: Meran Variation, Stahlberg Variation");
```"#)]
