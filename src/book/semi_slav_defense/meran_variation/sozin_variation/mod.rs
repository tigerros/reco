...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Semi-Slav Defense: Meran Variation, Sozin Variation.
pub static SOZIN_VARIATION: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::D,
