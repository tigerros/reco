...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Semi-Slav Defense: Meran Variation.
pub static MERAN_VARIATION: [Opening<&str>; 3] = [Opening {
    code: Code {
        volume: Volume::D,
        category: RangedU8::new_static::<47>(),
    },
    name: Cow::Borrowed(&["Semi-Slav Defense", "Meran Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
