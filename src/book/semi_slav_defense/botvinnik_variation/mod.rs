...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Semi-Slav Defense: Botvinnik Variation.
pub static BOTVINNIK_VARIATION: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::D,
        category: RangedU8::new_static::<44>(),
    },
    name: Cow::Borrowed(&["Semi-Slav Defense", "Botvinnik Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
