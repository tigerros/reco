...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Döry Defense.
pub static DORY_DEFENSE: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<46>(),
    },
    name: Cow::Borrowed(&["Döry Defense"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
