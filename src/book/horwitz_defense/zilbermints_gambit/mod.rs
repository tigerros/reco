...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Horwitz Defense: Zilbermints Gambit.
pub static ZILBERMINTS_GAMBIT: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<40>(),
    },
    name: Cow::Borrowed(&["Horwitz Defense", "Zilbermints Gambit"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
