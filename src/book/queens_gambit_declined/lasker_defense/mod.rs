...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Queen's Gambit Declined: Lasker Defense.
pub static LASKER_DEFENSE: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::D,
        category: RangedU8::new_static::<53>(),
    },
    name: Cow::Borrowed(&["Queen's Gambit Declined", "Lasker Defense"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
