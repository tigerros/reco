...
# use reco::book::queens_gambit_declined::LASKER_DEFENSE;
assert_eq!(LASKER_DEFENSE.original_name(), "Queen's Gambit Declined: Lasker Defense");
```"#)]
pub static LASKER_DEFENSE: Variation = Variation {
    name: "Lasker Defense",
    variations: &[&BERNSTEIN_VARIATION,
&RUSSIAN_VARIATION,
&TEICHMANN_VARIATION,
&MAIN_LINE],
