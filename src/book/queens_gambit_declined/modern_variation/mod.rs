...
# use reco::book::queens_gambit_declined::MODERN_VARIATION;
assert_eq!(MODERN_VARIATION.original_name(), "Queen's Gambit Declined: Modern Variation");
```"#)]
pub static MODERN_VARIATION: Variation = Variation {
    name: "Modern Variation",
    variations: &[&NORMAL_LINE,
&KNIGHT_DEFENSE,
&HERAL_VARIATION],
