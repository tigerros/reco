...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Queen's Gambit Declined: Modern Variation, Normal Line.
pub static NORMAL_LINE: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::D,
        category: RangedU8::new_static::<55>(),
    },
    name: Cow::Borrowed(&["Queen's Gambit Declined", "Modern Variation", "Normal Line"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
