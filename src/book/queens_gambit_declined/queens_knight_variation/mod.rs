...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Queen's Gambit Declined: Queen's Knight Variation.
pub static QUEENS_KNIGHT_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::D,
        category: RangedU8::new_static::<31>(),
    },
    name: Cow::Borrowed(&["Queen's Gambit Declined", "Queen's Knight Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
