...
# use reco::book::queens_gambit_declined::cambridge_springs_defense::CAPABLANCA_VARIATION;
assert_eq!(CAPABLANCA_VARIATION.original_name(), "Queen's Gambit Declined: Cambridge Springs Defense, Capablanca Variation");
```"#)]
