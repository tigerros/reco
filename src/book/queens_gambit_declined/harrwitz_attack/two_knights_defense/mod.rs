...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Queen's Gambit Declined: Harrwitz Attack, Two Knights Defense.
pub static TWO_KNIGHTS_DEFENSE: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::D,
        category: RangedU8::new_static::<37>(),
    },
    name: Cow::Borrowed(&["Queen's Gambit Declined", "Harrwitz Attack", "Two Knights Defense"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
