...
# use reco::book::queens_gambit_declined::harrwitz_attack::TWO_KNIGHTS_DEFENSE;
assert_eq!(TWO_KNIGHTS_DEFENSE.original_name(), "Queen's Gambit Declined: Harrwitz Attack, Two Knights Defense");
```"#)]
