...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Queen's Gambit Declined: Harrwitz Attack.
pub static HARRWITZ_ATTACK: [Opening<&str>; 4] = [Opening {
    code: Code {
        volume: Volume::D,
        category: RangedU8::new_static::<35>(),
    },
    name: Cow::Borrowed(&["Queen's Gambit Declined", "Harrwitz Attack"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
