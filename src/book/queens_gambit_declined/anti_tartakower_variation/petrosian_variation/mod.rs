...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Queen's Gambit Declined: Anti-Tartakower Variation, Petrosian Variation.
pub static PETROSIAN_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::D,
        category: RangedU8::new_static::<55>(),
    },
    name: Cow::Borrowed(&["Queen's Gambit Declined", "Anti-Tartakower Variation", "Petrosian Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
