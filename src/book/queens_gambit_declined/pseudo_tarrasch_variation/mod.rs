...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Queen's Gambit Declined: Pseudo-Tarrasch Variation.
pub static PSEUDO_TARRASCH_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::D,
        category: RangedU8::new_static::<50>(),
    },
    name: Cow::Borrowed(&["Queen's Gambit Declined", "Pseudo-Tarrasch Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
