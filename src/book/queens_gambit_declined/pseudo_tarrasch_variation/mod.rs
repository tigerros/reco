...
# use reco::book::queens_gambit_declined::PSEUDO_TARRASCH_VARIATION;
assert_eq!(PSEUDO_TARRASCH_VARIATION.original_name(), "Queen's Gambit Declined: Pseudo-Tarrasch Variation");
```"#)]
pub static PSEUDO_TARRASCH_VARIATION: Variation = Variation {
    name: "Pseudo-Tarrasch Variation",
    variations: &[&CANAL_VARIATION,
&PRIMITIVE_PILLSBURY_VARIATION],
