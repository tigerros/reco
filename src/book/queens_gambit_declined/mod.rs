...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Queen's Gambit Declined.
pub static QUEENS_GAMBIT_DECLINED: [Opening<&str>; 3] = [Opening {
    code: Code {
        volume: Volume::D,
        category: RangedU8::new_static::<30>(),
    },
    name: Cow::Borrowed(&["Queen's Gambit Declined"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
