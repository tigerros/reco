...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Queen's Gambit Declined: Semi-Tarrasch Defense, Kmoch Variation.
pub static KMOCH_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::D,
        category: RangedU8::new_static::<41>(),
    },
    name: Cow::Borrowed(&["Queen's Gambit Declined", "Semi-Tarrasch Defense", "Kmoch Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
