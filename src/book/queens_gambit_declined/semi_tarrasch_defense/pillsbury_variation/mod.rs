...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Queen's Gambit Declined: Semi-Tarrasch Defense, Pillsbury Variation.
pub static PILLSBURY_VARIATION: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::D,
        category: RangedU8::new_static::<40>(),
    },
    name: Cow::Borrowed(&["Queen's Gambit Declined", "Semi-Tarrasch Defense", "Pillsbury Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
