...
# use reco::book::queens_gambit_declined::SEMI_TARRASCH_DEFENSE;
assert_eq!(SEMI_TARRASCH_DEFENSE.original_name(), "Queen's Gambit Declined: Semi-Tarrasch Defense");
```"#)]
pub static SEMI_TARRASCH_DEFENSE: Variation = Variation {
    name: "Semi-Tarrasch Defense",
    variations: &[&LEVENFISH_VARIATION,
&PILLSBURY_VARIATION,
