...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Queen's Gambit Declined: Semi-Tarrasch Defense.
pub static SEMI_TARRASCH_DEFENSE: [Opening<&str>; 3] = [Opening {
    code: Code {
        volume: Volume::D,
        category: RangedU8::new_static::<40>(),
    },
    name: Cow::Borrowed(&["Queen's Gambit Declined", "Semi-Tarrasch Defense"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
    ...
    setup: Cow::Owned(Setup {
        board: Board::from_bitboards(
            ByRole {
                pawn: Bitboard(63912463644537600),
            ...
            ByColor {
                black: Bitboard(13682837319025950720),
