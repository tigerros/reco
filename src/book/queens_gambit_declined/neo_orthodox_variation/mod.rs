...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Queen's Gambit Declined: Neo-Orthodox Variation.
pub static NEO_ORTHODOX_VARIATION: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::D,
        category: RangedU8::new_static::<54>(),
    },
    name: Cow::Borrowed(&["Queen's Gambit Declined", "Neo-Orthodox Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
