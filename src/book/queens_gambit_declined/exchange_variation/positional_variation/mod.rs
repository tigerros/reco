...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Queen's Gambit Declined: Exchange Variation, Positional Variation.
pub static POSITIONAL_VARIATION: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::D,
        category: RangedU8::new_static::<35>(),
    },
    name: Cow::Borrowed(&["Queen's Gambit Declined", "Exchange Variation", "Positional Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
