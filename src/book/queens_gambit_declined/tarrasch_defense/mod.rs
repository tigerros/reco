...
# use reco::book::queens_gambit_declined::TARRASCH_DEFENSE;
assert_eq!(TARRASCH_DEFENSE.original_name(), "Queen's Gambit Declined: Tarrasch Defense");
```"#)]
pub static TARRASCH_DEFENSE: Variation = Variation {
    name: "Tarrasch Defense",
    variations: &[&STOLTZ_VARIATION,
&PSEUDO_TARRASCH,
