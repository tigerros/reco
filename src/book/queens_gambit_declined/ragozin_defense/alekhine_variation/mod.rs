...
# use reco::book::queens_gambit_declined::ragozin_defense::ALEKHINE_VARIATION;
assert_eq!(ALEKHINE_VARIATION.original_name(), "Queen's Gambit Declined: Ragozin Defense, Alekhine Variation");
```"#)]
