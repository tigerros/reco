...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Queen's Gambit Declined: Tartakower Defense.
pub static TARTAKOWER_DEFENSE: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::D,
        category: RangedU8::new_static::<58>(),
    },
    name: Cow::Borrowed(&["Queen's Gambit Declined", "Tartakower Defense"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
