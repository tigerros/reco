...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Queen's Gambit Declined: Baltic Defense, Queen Attack.
pub static QUEEN_ATTACK: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::D,
        category: RangedU8::new_static::<6>(),
    },
    name: Cow::Borrowed(&["Queen's Gambit Declined", "Baltic Defense", "Queen Attack"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
