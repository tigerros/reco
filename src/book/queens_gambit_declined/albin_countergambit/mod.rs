...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Queen's Gambit Declined: Albin Countergambit.
pub static ALBIN_COUNTERGAMBIT: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::D,
        category: RangedU8::new_static::<8>(),
    },
    name: Cow::Borrowed(&["Queen's Gambit Declined", "Albin Countergambit"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
