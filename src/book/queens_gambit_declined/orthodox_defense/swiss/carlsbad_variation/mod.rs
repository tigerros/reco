...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Queen's Gambit Declined: Orthodox Defense, Swiss, Carlsbad Variation.
pub static CARLSBAD_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::D,
        category: RangedU8::new_static::<63>(),
    },
    name: Cow::Borrowed(&["Queen's Gambit Declined", "Orthodox Defense", "Swiss", "Carlsbad Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
