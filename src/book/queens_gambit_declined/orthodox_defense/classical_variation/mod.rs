...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Queen's Gambit Declined: Orthodox Defense, Classical Variation.
pub static CLASSICAL_VARIATION: [Opening<&str>; 4] = [Opening {
    code: Code {
        volume: Volume::D,
        category: RangedU8::new_static::<68>(),
    },
    name: Cow::Borrowed(&["Queen's Gambit Declined", "Orthodox Defense", "Classical Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
