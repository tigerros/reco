...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Queen's Gambit Declined: Orthodox Defense, Rubinstein Attack.
pub static RUBINSTEIN_ATTACK: [Opening<&str>; 5] = [Opening {
    code: Code {
        volume: Volume::D,
        category: RangedU8::new_static::<64>(),
    },
    name: Cow::Borrowed(&["Queen's Gambit Declined", "Orthodox Defense", "Rubinstein Attack"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Knight,
        from: G1,
    ...
    setup: Cow::Owned(Setup {
        board: Board::from_bitboards(
            ByRole {
                ...
                knight: Bitboard(2251800084480000),
            ...
            ByColor {
                black: Bitboard(7924949994149249024),
    ...
    setup: Cow::Owned(Setup {
        board: Board::from_bitboards(
            ByRole {
                pawn: Bitboard(63636469043028480),
