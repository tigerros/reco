...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Queen's Gambit Declined: Orthodox Defense, Main Line.
pub static MAIN_LINE: [Opening<&str>; 3] = [Opening {
    code: Code {
        volume: Volume::D,
        category: RangedU8::new_static::<63>(),
    },
    name: Cow::Borrowed(&["Queen's Gambit Declined", "Orthodox Defense", "Main Line"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
