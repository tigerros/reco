...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Queen's Gambit Declined: Orthodox Defense.
pub static ORTHODOX_DEFENSE: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::D,
        category: RangedU8::new_static::<60>(),
    },
    name: Cow::Borrowed(&["Queen's Gambit Declined", "Orthodox Defense"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
