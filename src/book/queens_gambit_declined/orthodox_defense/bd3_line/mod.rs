...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Queen's Gambit Declined: Orthodox Defense, Bd3 Line.
pub static BD3_LINE: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::D,
        category: RangedU8::new_static::<66>(),
    },
    name: Cow::Borrowed(&["Queen's Gambit Declined", "Orthodox Defense", "Bd3 Line"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
