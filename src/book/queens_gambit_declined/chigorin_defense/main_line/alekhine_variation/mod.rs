...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Queen's Gambit Declined: Chigorin Defense, Main Line, Alekhine Variation.
pub static ALEKHINE_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::D,
        category: RangedU8::new_static::<7>(),
    },
    name: Cow::Borrowed(&["Queen's Gambit Declined", "Chigorin Defense", "Main Line", "Alekhine Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
