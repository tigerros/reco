...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Queen's Gambit Declined: Chigorin Defense, Main Line.
pub static MAIN_LINE: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::D,
        category: RangedU8::new_static::<7>(),
    },
    name: Cow::Borrowed(&["Queen's Gambit Declined", "Chigorin Defense", "Main Line"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
