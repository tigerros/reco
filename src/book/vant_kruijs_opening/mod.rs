...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Van't Kruijs Opening.
pub static VANT_KRUIJS_OPENING: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<0>(),
    },
    name: Cow::Borrowed(&["Van't Kruijs Opening"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
