...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// King's Pawn Game: Busch-Gass Gambit, Chiodini Gambit.
pub static CHIODINI_GAMBIT: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<40>(),
    },
    name: Cow::Borrowed(&["King's Pawn Game", "Busch-Gass Gambit", "Chiodini Gambit"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
