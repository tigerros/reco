...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// King's Pawn Game: Tayler Opening.
pub static TAYLER_OPENING: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<44>(),
    },
    name: Cow::Borrowed(&["King's Pawn Game", "Tayler Opening"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
