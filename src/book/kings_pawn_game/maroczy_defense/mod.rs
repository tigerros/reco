...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// King's Pawn Game: Maróczy Defense.
pub static MAROCZY_DEFENSE: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<7>(),
    },
    name: Cow::Borrowed(&["King's Pawn Game", "Maróczy Defense"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
