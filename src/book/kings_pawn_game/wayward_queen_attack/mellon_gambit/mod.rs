...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// King's Pawn Game: Wayward Queen Attack, Mellon Gambit.
pub static MELLON_GAMBIT: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<20>(),
    },
    name: Cow::Borrowed(&["King's Pawn Game", "Wayward Queen Attack", "Mellon Gambit"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
