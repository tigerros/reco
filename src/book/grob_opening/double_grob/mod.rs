...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Grob Opening: Double Grob.
pub static DOUBLE_GROB: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<0>(),
    },
    name: Cow::Borrowed(&["Grob Opening", "Double Grob"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: G2,
