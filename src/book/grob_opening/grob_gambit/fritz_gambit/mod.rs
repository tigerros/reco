...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Grob Opening: Grob Gambit, Fritz Gambit.
pub static FRITZ_GAMBIT: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<0>(),
    },
    name: Cow::Borrowed(&["Grob Opening", "Grob Gambit", "Fritz Gambit"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: G2,
