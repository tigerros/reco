...
# use reco::book::grob_opening::GROB_GAMBIT;
assert_eq!(GROB_GAMBIT.original_name(), "Grob Opening: Grob Gambit");
```"#)]
pub static GROB_GAMBIT: Variation = Variation {
    name: "Grob Gambit",
    variations: &[&RICHTER_GROB_GAMBIT,
&FRITZ_GAMBIT,
&KERES_GAMBIT,
&BASMAN_GAMBIT],
