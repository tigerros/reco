...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Grob Opening: Grob Gambit.
pub static GROB_GAMBIT: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<0>(),
    },
    name: Cow::Borrowed(&["Grob Opening", "Grob Gambit"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: G2,
    ...
    setup: Cow::Owned(Setup {
        board: Board::from_bitboards(
            ByRole {
                pawn: Bitboard(69524354681061120),
