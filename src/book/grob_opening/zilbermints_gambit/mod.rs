...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Grob Opening: Zilbermints Gambit.
pub static ZILBERMINTS_GAMBIT: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<0>(),
    },
    name: Cow::Borrowed(&["Grob Opening", "Zilbermints Gambit"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: G2,
