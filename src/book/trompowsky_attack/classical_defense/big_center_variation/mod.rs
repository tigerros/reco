...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Trompowsky Attack: Classical Defense, Big Center Variation.
pub static BIG_CENTER_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<45>(),
    },
    name: Cow::Borrowed(&["Trompowsky Attack", "Classical Defense", "Big Center Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
