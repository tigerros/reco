...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Trompowsky Attack: Edge Variation.
pub static EDGE_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<45>(),
    },
    name: Cow::Borrowed(&["Trompowsky Attack", "Edge Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
