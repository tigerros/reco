...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Queen's Gambit Accepted: Classical Defense, Alekhine System.
pub static ALEKHINE_SYSTEM: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::D,
        category: RangedU8::new_static::<28>(),
    },
    name: Cow::Borrowed(&["Queen's Gambit Accepted", "Classical Defense", "Alekhine System"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
