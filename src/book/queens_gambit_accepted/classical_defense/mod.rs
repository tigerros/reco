...
# use reco::book::queens_gambit_accepted::CLASSICAL_DEFENSE;
assert_eq!(CLASSICAL_DEFENSE.original_name(), "Queen's Gambit Accepted: Classical Defense");
```"#)]
pub static CLASSICAL_DEFENSE: Variation = Variation {
    name: "Classical Defense",
    variations: &[&ALEKHINE_SYSTEM,
&NORMAL_LINE,
&STEINITZ_VARIATION,
&MAIN_LINE,
