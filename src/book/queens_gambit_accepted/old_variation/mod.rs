...
# use reco::book::queens_gambit_accepted::OLD_VARIATION;
assert_eq!(OLD_VARIATION.original_name(), "Queen's Gambit Accepted: Old Variation");
```"#)]
pub static OLD_VARIATION: Variation = Variation {
    name: "Old Variation",
    variations: &[&CHRISTENSEN_GAMBIT,
&NOVIKOV_GAMBIT,
&KORCHNOI_GAMBIT,
&BILLINGER_GAMBIT],
