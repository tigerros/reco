...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Queen's Gambit Accepted: Old Variation, Korchnoi Gambit.
pub static KORCHNOI_GAMBIT: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::D,
        category: RangedU8::new_static::<20>(),
    },
    name: Cow::Borrowed(&["Queen's Gambit Accepted", "Old Variation", "Korchnoi Gambit"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
