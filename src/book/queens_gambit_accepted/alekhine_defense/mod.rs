...
# use reco::book::queens_gambit_accepted::ALEKHINE_DEFENSE;
assert_eq!(ALEKHINE_DEFENSE.original_name(), "Queen's Gambit Accepted: Alekhine Defense");
```"#)]
pub static ALEKHINE_DEFENSE: Variation = Variation {
    name: "Alekhine Defense",
    variations: &[&HABERDITZ_VARIATION,
