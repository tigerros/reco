...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Queen's Gambit Accepted: Normal Variation.
pub static NORMAL_VARIATION: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::D,
        category: RangedU8::new_static::<21>(),
    },
    name: Cow::Borrowed(&["Queen's Gambit Accepted", "Normal Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
