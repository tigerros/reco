...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Four Knights Game: Spanish Variation, Bardeleben Variation.
pub static BARDELEBEN_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<48>(),
    },
    name: Cow::Borrowed(&["Four Knights Game", "Spanish Variation", "Bardeleben Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
