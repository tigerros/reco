...
# use reco::book::four_knights_game::spanish_variation::CLASSICAL_VARIATION;
assert_eq!(CLASSICAL_VARIATION.original_name(), "Four Knights Game: Spanish Variation, Classical Variation");
```"#)]
