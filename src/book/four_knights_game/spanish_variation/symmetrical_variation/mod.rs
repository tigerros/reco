...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Four Knights Game: Spanish Variation, Symmetrical Variation.
pub static SYMMETRICAL_VARIATION: [Opening<&str>; 4] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<49>(),
    },
    name: Cow::Borrowed(&["Four Knights Game", "Spanish Variation", "Symmetrical Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
