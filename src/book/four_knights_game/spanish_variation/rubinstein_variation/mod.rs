...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Four Knights Game: Spanish Variation, Rubinstein Variation.
pub static RUBINSTEIN_VARIATION: [Opening<&str>; 3] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<48>(),
    },
    name: Cow::Borrowed(&["Four Knights Game", "Spanish Variation", "Rubinstein Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
