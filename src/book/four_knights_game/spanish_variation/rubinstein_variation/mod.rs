...
# use reco::book::four_knights_game::spanish_variation::RUBINSTEIN_VARIATION;
assert_eq!(RUBINSTEIN_VARIATION.original_name(), "Four Knights Game: Spanish Variation, Rubinstein Variation");
```"#)]
pub static RUBINSTEIN_VARIATION: Variation = Variation {
    name: "Rubinstein Variation",
    variations: &[&MARSHALL_VARIATION,
&MARSHALL_GAMBIT,
&MAROCZY_VARIATION,
