...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Four Knights Game: Spanish Variation, Janowski Variation.
pub static JANOWSKI_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<49>(),
    },
    name: Cow::Borrowed(&["Four Knights Game", "Spanish Variation", "Janowski Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
