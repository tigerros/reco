...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Four Knights Game: Spanish Variation, Double Spanish.
pub static DOUBLE_SPANISH: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<49>(),
    },
    name: Cow::Borrowed(&["Four Knights Game", "Spanish Variation", "Double Spanish"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
