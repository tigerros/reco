...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Four Knights Game: Scotch Variation, Belgrade Gambit, Modern Defense.
pub static MODERN_DEFENSE: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<47>(),
    },
    name: Cow::Borrowed(&["Four Knights Game", "Scotch Variation", "Belgrade Gambit", "Modern Defense"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
