...
# use reco::book::four_knights_game::SCOTCH_VARIATION;
assert_eq!(SCOTCH_VARIATION.original_name(), "Four Knights Game: Scotch Variation");
```"#)]
pub static SCOTCH_VARIATION: Variation = Variation {
    name: "Scotch Variation",
    variations: &[&KRAUSE_GAMBIT,
&OXFORD_GAMBIT,
&BELGRADE_GAMBIT,
&SCHMID_DEFENSE],
