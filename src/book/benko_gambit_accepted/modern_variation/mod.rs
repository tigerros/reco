...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Benko Gambit Accepted: Modern Variation.
pub static MODERN_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<57>(),
    },
    name: Cow::Borrowed(&["Benko Gambit Accepted", "Modern Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
