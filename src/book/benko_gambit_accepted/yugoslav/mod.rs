...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Benko Gambit Accepted: Yugoslav.
pub static YUGOSLAV: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<59>(),
    },
    name: Cow::Borrowed(&["Benko Gambit Accepted", "Yugoslav"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
    ...
    setup: Cow::Owned(Setup {
        board: Board::from_bitboards(
            ByRole {
                pawn: Bitboard(67562842311680768),
            ...
            ByColor {
                black: Bitboard(13542369176659689472),
    ...
    setup: Cow::Owned(Setup {
        board: Board::from_bitboards(
            ByRole {
                pawn: Bitboard(49618812546376448),
