...
# use reco::book::ENGLUND_GAMBIT_DECLINED;
assert_eq!(ENGLUND_GAMBIT_DECLINED.original_name(), "Englund Gambit Declined");
```"#)]
pub static ENGLUND_GAMBIT_DECLINED: Variation = Variation {
    name: "Englund Gambit Declined",
    variations: &[&REVERSED_BROOKLYN,
...
&REVERSED_ALEKHINE],
    ...
    setup: Setup {
        board: Board::from_bitboards(
            ByRole {
                pawn: Bitboard(67272622513125120),
