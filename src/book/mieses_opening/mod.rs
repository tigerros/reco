...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Mieses Opening.
pub static MIESES_OPENING: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<0>(),
    },
    name: Cow::Borrowed(&["Mieses Opening"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
