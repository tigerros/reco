...
# use reco::book::latvian_gambit::MAYET_ATTACK;
assert_eq!(MAYET_ATTACK.original_name(), "Latvian Gambit: Mayet Attack");
```"#)]
pub static MAYET_ATTACK: Variation = Variation {
    name: "Mayet Attack",
    variations: &[&POLERIO_SVEDENBORG_VARIATION,
