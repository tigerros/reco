...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Latvian Gambit: Behting Variation.
pub static BEHTING_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<40>(),
    },
    name: Cow::Borrowed(&["Latvian Gambit", "Behting Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
