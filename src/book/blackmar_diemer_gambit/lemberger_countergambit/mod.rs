...
# use reco::book::blackmar_diemer_gambit::LEMBERGER_COUNTERGAMBIT;
assert_eq!(LEMBERGER_COUNTERGAMBIT.original_name(), "Blackmar-Diemer Gambit: Lemberger Countergambit");
```"#)]
pub static LEMBERGER_COUNTERGAMBIT: Variation = Variation {
    name: "Lemberger Countergambit",
    variations: &[&ENDGAME_VARIATION,
&LANGE_GAMBIT,
&SNEIDERS_ATTACK,
&RASMUSSEN_ATTACK,
&SOLLER_ATTACK],
