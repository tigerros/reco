...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Blackmar-Diemer Gambit: Zeller Defense.
pub static ZELLER_DEFENSE: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::D,
        category: RangedU8::new_static::<0>(),
    },
    name: Cow::Borrowed(&["Blackmar-Diemer Gambit", "Zeller Defense"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
