...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Owen Defense.
pub static OWEN_DEFENSE: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<0>(),
    },
    name: Cow::Borrowed(&["Owen Defense"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
