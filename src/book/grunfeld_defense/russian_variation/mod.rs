...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Grünfeld Defense: Russian Variation.
pub static RUSSIAN_VARIATION: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::D,
        category: RangedU8::new_static::<96>(),
    },
    name: Cow::Borrowed(&["Grünfeld Defense", "Russian Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
