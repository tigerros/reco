...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Grünfeld Defense: Russian Variation, Keres Variation.
pub static KERES_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::D,
        category: RangedU8::new_static::<98>(),
    },
    name: Cow::Borrowed(&["Grünfeld Defense", "Russian Variation", "Keres Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
