...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Grünfeld Defense: Russian Variation, Byrne Variation.
pub static BYRNE_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::D,
        category: RangedU8::new_static::<97>(),
    },
    name: Cow::Borrowed(&["Grünfeld Defense", "Russian Variation", "Byrne Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
