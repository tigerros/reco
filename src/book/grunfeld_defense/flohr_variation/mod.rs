...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Grünfeld Defense: Flohr Variation.
pub static FLOHR_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::D,
        category: RangedU8::new_static::<90>(),
    },
    name: Cow::Borrowed(&["Grünfeld Defense", "Flohr Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
