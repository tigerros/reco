...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Grünfeld Defense: Counterthrust Variation.
pub static COUNTERTHRUST_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::E,
        category: RangedU8::new_static::<60>(),
    },
    name: Cow::Borrowed(&["Grünfeld Defense", "Counterthrust Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
