...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Grünfeld Defense: Stockholm Variation.
pub static STOCKHOLM_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::D,
        category: RangedU8::new_static::<80>(),
    },
    name: Cow::Borrowed(&["Grünfeld Defense", "Stockholm Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
