...
# use reco::book::grunfeld_defense::BRINCKMANN_ATTACK;
assert_eq!(BRINCKMANN_ATTACK.original_name(), "Grünfeld Defense: Brinckmann Attack");
```"#)]
pub static BRINCKMANN_ATTACK: Variation = Variation {
    name: "Brinckmann Attack",
    variations: &[&GRUNFELD_GAMBIT,
&RESHEVSKY_GAMBIT,
