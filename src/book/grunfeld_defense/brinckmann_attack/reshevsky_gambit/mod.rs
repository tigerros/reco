...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Grünfeld Defense: Brinckmann Attack, Reshevsky Gambit.
pub static RESHEVSKY_GAMBIT: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::D,
        category: RangedU8::new_static::<83>(),
    },
    name: Cow::Borrowed(&["Grünfeld Defense", "Brinckmann Attack", "Reshevsky Gambit"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
