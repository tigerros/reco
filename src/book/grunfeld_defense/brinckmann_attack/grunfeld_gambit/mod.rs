...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Grünfeld Defense: Brinckmann Attack, Grünfeld Gambit.
pub static GRUNFELD_GAMBIT: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::D,
        category: RangedU8::new_static::<83>(),
    },
    name: Cow::Borrowed(&["Grünfeld Defense", "Brinckmann Attack", "Grünfeld Gambit"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
