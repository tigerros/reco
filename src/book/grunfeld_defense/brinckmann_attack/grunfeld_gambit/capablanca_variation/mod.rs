...
# use reco::book::grunfeld_defense::brinckmann_attack::grunfeld_gambit::CAPABLANCA_VARIATION;
assert_eq!(CAPABLANCA_VARIATION.original_name(), "Grünfeld Defense: Brinckmann Attack, Grünfeld Gambit, Capablanca Variation");
```"#)]
