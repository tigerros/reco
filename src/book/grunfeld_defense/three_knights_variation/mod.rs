...
# use reco::book::grunfeld_defense::THREE_KNIGHTS_VARIATION;
assert_eq!(THREE_KNIGHTS_VARIATION.original_name(), "Grünfeld Defense: Three Knights Variation");
```"#)]
pub static THREE_KNIGHTS_VARIATION: Variation = Variation {
    name: "Three Knights Variation",
    variations: &[&BURILLE_VARIATION,
&PETROSIAN_SYSTEM,
&HUNGARIAN_VARIATION,
&VIENNA_VARIATION,
&HUNGARIAN_ATTACK,
