...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Grünfeld Defense: Three Knights Variation, Burille Variation.
pub static BURILLE_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::D,
        category: RangedU8::new_static::<94>(),
    },
    name: Cow::Borrowed(&["Grünfeld Defense", "Three Knights Variation", "Burille Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
