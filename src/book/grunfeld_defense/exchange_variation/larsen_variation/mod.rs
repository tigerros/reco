...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Grünfeld Defense: Exchange Variation, Larsen Variation.
pub static LARSEN_VARIATION: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::D,
        category: RangedU8::new_static::<86>(),
    },
    name: Cow::Borrowed(&["Grünfeld Defense", "Exchange Variation", "Larsen Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
