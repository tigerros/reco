...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Grünfeld Defense: Exchange Variation, Modern Exchange Variation.
pub static MODERN_EXCHANGE_VARIATION: [Opening<&str>; 3] = [Opening {
    code: Code {
        volume: Volume::D,
        category: RangedU8::new_static::<85>(),
    },
    name: Cow::Borrowed(&["Grünfeld Defense", "Exchange Variation", "Modern Exchange Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
