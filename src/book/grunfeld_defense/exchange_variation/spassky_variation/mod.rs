...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Grünfeld Defense: Exchange Variation, Spassky Variation.
pub static SPASSKY_VARIATION: [Opening<&str>; 3] = [Opening {
    code: Code {
        volume: Volume::D,
        category: RangedU8::new_static::<87>(),
    },
    name: Cow::Borrowed(&["Grünfeld Defense", "Exchange Variation", "Spassky Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
