...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Ponziani Opening: Neumann Gambit.
pub static NEUMANN_GAMBIT: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<44>(),
    },
    name: Cow::Borrowed(&["Ponziani Opening", "Neumann Gambit"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
