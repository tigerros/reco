...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Ponziani Opening: Ponziani Countergambit.
pub static PONZIANI_COUNTERGAMBIT: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<44>(),
    },
    name: Cow::Borrowed(&["Ponziani Opening", "Ponziani Countergambit"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
