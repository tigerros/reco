...
# use reco::book::ponziani_opening::SPANISH_VARIATION;
assert_eq!(SPANISH_VARIATION.original_name(), "Ponziani Opening: Spanish Variation");
```"#)]
pub static SPANISH_VARIATION: Variation = Variation {
    name: "Spanish Variation",
    variations: &[&HARRWITZ_ATTACK],
