...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Ponziani Opening: Spanish Variation, Harrwitz Attack, Nikitin Gambit.
pub static NIKITIN_GAMBIT: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<44>(),
    },
    name: Cow::Borrowed(&["Ponziani Opening", "Spanish Variation", "Harrwitz Attack", "Nikitin Gambit"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
