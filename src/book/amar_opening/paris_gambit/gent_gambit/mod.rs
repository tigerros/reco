...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Amar Opening: Paris Gambit, Gent Gambit.
pub static GENT_GAMBIT: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<0>(),
    },
    name: Cow::Borrowed(&["Amar Opening", "Paris Gambit", "Gent Gambit"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Knight,
        from: G1,
