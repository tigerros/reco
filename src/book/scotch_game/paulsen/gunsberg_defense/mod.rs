...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Scotch Game: Paulsen, Gunsberg Defense.
pub static GUNSBERG_DEFENSE: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<45>(),
    },
    name: Cow::Borrowed(&["Scotch Game", "Paulsen", "Gunsberg Defense"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
