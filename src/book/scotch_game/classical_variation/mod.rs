...
# use reco::book::scotch_game::CLASSICAL_VARIATION;
assert_eq!(CLASSICAL_VARIATION.original_name(), "Scotch Game: Classical Variation");
```"#)]
pub static CLASSICAL_VARIATION: Variation = Variation {
    name: "Classical Variation",
    variations: &[&INTERMEZZO_VARIATION,
&MILLENNIUM_VARIATION,
&BLACKBURNE_ATTACK],
