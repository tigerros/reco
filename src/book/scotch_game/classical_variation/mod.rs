...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Scotch Game: Classical Variation.
pub static CLASSICAL_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<45>(),
    },
    name: Cow::Borrowed(&["Scotch Game", "Classical Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
