...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Scotch Game: Relfsson Gambit.
pub static RELFSSON_GAMBIT: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<44>(),
    },
    name: Cow::Borrowed(&["Scotch Game", "Relfsson Gambit"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
