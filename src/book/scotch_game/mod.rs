...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Scotch Game.
pub static SCOTCH_GAME: [Opening<&str>; 4] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<44>(),
    },
    name: Cow::Borrowed(&["Scotch Game"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
