...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Scotch Game: Cochrane-Shumov Defense.
pub static COCHRANE_SHUMOV_DEFENSE: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<44>(),
    },
    name: Cow::Borrowed(&["Scotch Game", "Cochrane-Shumov Defense"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
