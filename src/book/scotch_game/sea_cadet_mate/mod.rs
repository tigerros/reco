...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Scotch Game: Sea-Cadet Mate.
pub static SEA_CADET_MATE: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<44>(),
    },
    name: Cow::Borrowed(&["Scotch Game", "Sea-Cadet Mate"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
