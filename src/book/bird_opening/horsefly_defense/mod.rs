...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Bird Opening: Horsefly Defense.
pub static HORSEFLY_DEFENSE: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<2>(),
    },
    name: Cow::Borrowed(&["Bird Opening", "Horsefly Defense"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: F2,
