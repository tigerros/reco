...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Bird Opening: Williams Gambit.
pub static WILLIAMS_GAMBIT: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<3>(),
    },
    name: Cow::Borrowed(&["Bird Opening", "Williams Gambit"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: F2,
