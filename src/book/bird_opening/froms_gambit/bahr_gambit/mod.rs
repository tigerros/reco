...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Bird Opening: From's Gambit, Bahr Gambit.
pub static BAHR_GAMBIT: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<2>(),
    },
    name: Cow::Borrowed(&["Bird Opening", "From's Gambit", "Bahr Gambit"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: F2,
