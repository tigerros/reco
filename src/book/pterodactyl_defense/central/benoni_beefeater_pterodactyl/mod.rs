...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Pterodactyl Defense: Central, Benoni Beefeater Pterodactyl.
pub static BENONI_BEEFEATER_PTERODACTYL: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<40>(),
    },
    name: Cow::Borrowed(&["Pterodactyl Defense", "Central", "Benoni Beefeater Pterodactyl"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
