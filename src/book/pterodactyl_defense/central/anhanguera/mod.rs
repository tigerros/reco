...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Pterodactyl Defense: Central, Anhanguera.
pub static ANHANGUERA: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<6>(),
    },
    name: Cow::Borrowed(&["Pterodactyl Defense", "Central", "Anhanguera"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
