...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Pterodactyl Defense: Central, Bogolubovia.
pub static BOGOLUBOVIA: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<42>(),
    },
    name: Cow::Borrowed(&["Pterodactyl Defense", "Central", "Bogolubovia"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
