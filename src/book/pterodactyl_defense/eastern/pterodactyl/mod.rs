...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Pterodactyl Defense: Eastern, Pterodactyl.
pub static PTERODACTYL: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<6>(),
    },
    name: Cow::Borrowed(&["Pterodactyl Defense", "Eastern", "Pterodactyl"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
