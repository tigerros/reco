...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Pterodactyl Defense: Fianchetto, Queen Pteranodon.
pub static QUEEN_PTERANODON: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<40>(),
    },
    name: Cow::Borrowed(&["Pterodactyl Defense", "Fianchetto", "Queen Pteranodon"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
