...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Pterodactyl Defense.
pub static PTERODACTYL_DEFENSE: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<42>(),
    },
    name: Cow::Borrowed(&["Pterodactyl Defense"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Knight,
        from: G1,
