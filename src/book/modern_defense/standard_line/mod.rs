...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Modern Defense: Standard Line.
pub static STANDARD_LINE: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<6>(),
    },
    name: Cow::Borrowed(&["Modern Defense", "Standard Line"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
