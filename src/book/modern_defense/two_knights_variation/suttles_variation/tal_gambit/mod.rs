...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Modern Defense: Two Knights Variation, Suttles Variation, Tal Gambit.
pub static TAL_GAMBIT: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<6>(),
    },
    name: Cow::Borrowed(&["Modern Defense", "Two Knights Variation", "Suttles Variation", "Tal Gambit"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
