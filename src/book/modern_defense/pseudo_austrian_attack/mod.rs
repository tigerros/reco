...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Modern Defense: Pseudo-Austrian Attack.
pub static PSEUDO_AUSTRIAN_ATTACK: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<6>(),
    },
    name: Cow::Borrowed(&["Modern Defense", "Pseudo-Austrian Attack"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
