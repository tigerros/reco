...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Modern Defense: Averbakh System.
pub static AVERBAKH_SYSTEM: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<42>(),
    },
    name: Cow::Borrowed(&["Modern Defense", "Averbakh System"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
