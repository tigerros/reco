...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Modern Defense: Kotov Variation.
pub static KOTOV_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<42>(),
    },
    name: Cow::Borrowed(&["Modern Defense", "Kotov Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
