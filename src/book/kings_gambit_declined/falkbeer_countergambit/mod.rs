...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// King's Gambit Declined: Falkbeer Countergambit.
pub static FALKBEER_COUNTERGAMBIT: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<31>(),
    },
    name: Cow::Borrowed(&["King's Gambit Declined", "Falkbeer Countergambit"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
