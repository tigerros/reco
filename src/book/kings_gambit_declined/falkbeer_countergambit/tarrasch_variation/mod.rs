...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// King's Gambit Declined: Falkbeer Countergambit, Tarrasch Variation.
pub static TARRASCH_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<32>(),
    },
    name: Cow::Borrowed(&["King's Gambit Declined", "Falkbeer Countergambit", "Tarrasch Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
