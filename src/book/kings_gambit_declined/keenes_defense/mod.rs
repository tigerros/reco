...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// King's Gambit Declined: Keene's Defense.
pub static KEENES_DEFENSE: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<30>(),
    },
    name: Cow::Borrowed(&["King's Gambit Declined", "Keene's Defense"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
