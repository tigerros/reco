...
# use reco::book::kings_gambit_declined::panteldakis_countergambit::SHIRAZI_LINE;
assert_eq!(SHIRAZI_LINE.original_name(), "King's Gambit Declined: Panteldakis Countergambit, Shirazi Line");
```"#)]
pub static SHIRAZI_LINE: Variation = Variation {
    name: "Shirazi Line",
    variations: &[],
