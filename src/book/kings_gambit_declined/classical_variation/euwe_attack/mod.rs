...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// King's Gambit Declined: Classical Variation, Euwe Attack.
pub static EUWE_ATTACK: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<30>(),
    },
    name: Cow::Borrowed(&["King's Gambit Declined", "Classical Variation", "Euwe Attack"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
