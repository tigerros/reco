...
# use reco::book::kings_gambit_declined::CLASSICAL_VARIATION;
assert_eq!(CLASSICAL_VARIATION.original_name(), "King's Gambit Declined: Classical Variation");
```"#)]
pub static CLASSICAL_VARIATION: Variation = Variation {
    name: "Classical Variation",
    variations: &[&RUBINSTEIN_COUNTERGAMBIT,
