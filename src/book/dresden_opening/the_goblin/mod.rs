...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Dresden Opening: The Goblin.
pub static THE_GOBLIN: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<44>(),
    },
    name: Cow::Borrowed(&["Dresden Opening", "The Goblin"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
