...
# use reco::book::petrovs_defense::MOODY_GAMBIT;
assert_eq!(MOODY_GAMBIT.original_name(), "Petrov's Defense: Moody Gambit");
```"#)]
pub static MOODY_GAMBIT: Variation = Variation {
    name: "Moody Gambit",
    variations: &[],
