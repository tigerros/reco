...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Petrov's Defense: Italian Variation.
pub static ITALIAN_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<42>(),
    },
    name: Cow::Borrowed(&["Petrov's Defense", "Italian Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
