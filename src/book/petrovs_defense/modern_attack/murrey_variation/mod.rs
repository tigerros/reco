...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Petrov's Defense: Modern Attack, Murrey Variation.
pub static MURREY_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<43>(),
    },
    name: Cow::Borrowed(&["Petrov's Defense", "Modern Attack", "Murrey Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
