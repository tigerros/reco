...
# use reco::book::petrovs_defense::MODERN_ATTACK;
assert_eq!(MODERN_ATTACK.original_name(), "Petrov's Defense: Modern Attack");
```"#)]
pub static MODERN_ATTACK: Variation = Variation {
    name: "Modern Attack",
    variations: &[&MURREY_VARIATION,
