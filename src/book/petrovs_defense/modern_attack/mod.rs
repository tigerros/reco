...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Petrov's Defense: Modern Attack.
pub static MODERN_ATTACK: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<43>(),
    },
    name: Cow::Borrowed(&["Petrov's Defense", "Modern Attack"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
