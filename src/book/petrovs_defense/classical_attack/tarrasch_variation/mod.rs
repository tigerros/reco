...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Petrov's Defense: Classical Attack, Tarrasch Variation.
pub static TARRASCH_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<42>(),
    },
    name: Cow::Borrowed(&["Petrov's Defense", "Classical Attack", "Tarrasch Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
    ...
    setup: Cow::Owned(Setup {
        board: Board::from_bitboards(
            ...
            ByColor {
                black: Bitboard(7775192113473388544),
