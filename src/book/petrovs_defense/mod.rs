...
# use reco::book::PETROVS_DEFENSE;
assert_eq!(PETROVS_DEFENSE.original_name(), "Petrov's Defense");
```"#)]
pub static PETROVS_DEFENSE: Variation = Variation {
    name: "Petrov's Defense",
    variations: &[&THREE_KNIGHTS_GAME,
&MOODY_GAMBIT,
