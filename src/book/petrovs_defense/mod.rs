...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Petrov's Defense.
pub static PETROVS_DEFENSE: [Opening<&str>; 5] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<42>(),
    },
    name: Cow::Borrowed(&["Petrov's Defense"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
...
pub use kaufmann_attack::KAUFMANN_ATTACK;
pub mod millennium_attack;
