...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Alekhine Defense: Modern Variation, Alekhine Variation.
pub static ALEKHINE_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<5>(),
    },
    name: Cow::Borrowed(&["Alekhine Defense", "Modern Variation", "Alekhine Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
