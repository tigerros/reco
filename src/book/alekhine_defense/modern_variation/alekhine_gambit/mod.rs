...
# use reco::book::alekhine_defense::modern_variation::ALEKHINE_GAMBIT;
assert_eq!(ALEKHINE_GAMBIT.original_name(), "Alekhine Defense: Modern Variation, Alekhine Gambit");
```"#)]
