...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Alekhine Defense: Four Pawns Attack.
pub static FOUR_PAWNS_ATTACK: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<3>(),
    },
    name: Cow::Borrowed(&["Alekhine Defense", "Four Pawns Attack"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
    ...
    setup: Cow::Owned(Setup {
        board: Board::from_bitboards(
            ...
            ByColor {
                black: Bitboard(13832535775608045568),
