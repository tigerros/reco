...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Alekhine Defense: Balogh Variation.
pub static BALOGH_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<3>(),
    },
    name: Cow::Borrowed(&["Alekhine Defense", "Balogh Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
