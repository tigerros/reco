...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Alekhine Defense: Krejcik Variation.
pub static KREJCIK_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<2>(),
    },
    name: Cow::Borrowed(&["Alekhine Defense", "Krejcik Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
