...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Alekhine Defense: Two Pawns Attack.
pub static TWO_PAWNS_ATTACK: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<2>(),
    },
    name: Cow::Borrowed(&["Alekhine Defense", "Two Pawns Attack"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
