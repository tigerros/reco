...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Tarrasch Defense: Prague Variation, Main Line.
pub static MAIN_LINE: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::D,
        category: RangedU8::new_static::<34>(),
    },
    name: Cow::Borrowed(&["Tarrasch Defense", "Prague Variation", "Main Line"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
    ...
    setup: Cow::Owned(Setup {
        board: Board::from_bitboards(
            ...
            ByColor {
                black: Bitboard(11381480317253582848),
