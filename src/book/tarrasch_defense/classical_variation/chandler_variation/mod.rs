...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Tarrasch Defense: Classical Variation, Chandler Variation.
pub static CHANDLER_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::D,
        category: RangedU8::new_static::<34>(),
    },
    name: Cow::Borrowed(&["Tarrasch Defense", "Classical Variation", "Chandler Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
