...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Tarrasch Defense: von Hennig Gambit.
pub static VON_HENNIG_GAMBIT: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::D,
        category: RangedU8::new_static::<32>(),
    },
    name: Cow::Borrowed(&["Tarrasch Defense", "von Hennig Gambit"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
