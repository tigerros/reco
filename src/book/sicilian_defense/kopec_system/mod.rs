...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Sicilian Defense: Kopec System.
pub static KOPEC_SYSTEM: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<50>(),
    },
    name: Cow::Borrowed(&["Sicilian Defense", "Kopec System"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
