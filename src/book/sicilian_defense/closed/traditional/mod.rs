...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Sicilian Defense: Closed, Traditional.
pub static TRADITIONAL: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<23>(),
    },
    name: Cow::Borrowed(&["Sicilian Defense", "Closed", "Traditional"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
