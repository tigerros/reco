...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Sicilian Defense: Moscow Variation, Moscow Gambit.
pub static MOSCOW_GAMBIT: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<51>(),
    },
    name: Cow::Borrowed(&["Sicilian Defense", "Moscow Variation", "Moscow Gambit"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
    ...
    setup: Cow::Owned(Setup {
        board: Board::from_bitboards(
            ByRole {
                ...
                bishop: Bitboard(2305843284360036352),
