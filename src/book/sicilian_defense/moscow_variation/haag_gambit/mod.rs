...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Sicilian Defense: Moscow Variation, Haag Gambit.
pub static HAAG_GAMBIT: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<52>(),
    },
    name: Cow::Borrowed(&["Sicilian Defense", "Moscow Variation", "Haag Gambit"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
