...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Sicilian Defense: Lasker-Pelikan Variation, Sveshnikov Variation.
pub static SVESHNIKOV_VARIATION: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<33>(),
    },
    name: Cow::Borrowed(&["Sicilian Defense", "Lasker-Pelikan Variation", "Sveshnikov Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
