...
# use reco::book::sicilian_defense::LASKER_PELIKAN_VARIATION;
assert_eq!(LASKER_PELIKAN_VARIATION.original_name(), "Sicilian Defense: Lasker-Pelikan Variation");
```"#)]
pub static LASKER_PELIKAN_VARIATION: Variation = Variation {
    name: "Lasker-Pelikan Variation",
    variations: &[&SVESHNIKOV_VARIATION,
&BIRD_VARIATION,
&RETREAT_VARIATION,
&EXCHANGE_VARIATION,
