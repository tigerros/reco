...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Sicilian Defense: Lasker-Pelikan Variation.
pub static LASKER_PELIKAN_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<33>(),
    },
    name: Cow::Borrowed(&["Sicilian Defense", "Lasker-Pelikan Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
