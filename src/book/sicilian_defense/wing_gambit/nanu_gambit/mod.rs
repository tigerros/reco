...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Sicilian Defense: Wing Gambit, Nanu Gambit.
pub static NANU_GAMBIT: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<20>(),
    },
    name: Cow::Borrowed(&["Sicilian Defense", "Wing Gambit", "Nanu Gambit"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
