...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Sicilian Defense: King David's Opening.
pub static KING_DAVIDS_OPENING: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<20>(),
    },
    name: Cow::Borrowed(&["Sicilian Defense", "King David's Opening"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
