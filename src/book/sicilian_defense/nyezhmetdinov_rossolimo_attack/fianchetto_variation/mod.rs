...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Sicilian Defense: Nyezhmetdinov-Rossolimo Attack, Fianchetto Variation.
pub static FIANCHETTO_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<31>(),
    },
    name: Cow::Borrowed(&["Sicilian Defense", "Nyezhmetdinov-Rossolimo Attack", "Fianchetto Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
    ...
    setup: Cow::Owned(Setup {
        board: Board::from_bitboards(
            ByRole {
                pawn: Bitboard(52706206837436160),
