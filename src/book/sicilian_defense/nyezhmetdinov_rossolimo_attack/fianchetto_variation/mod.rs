...
# use reco::book::sicilian_defense::nyezhmetdinov_rossolimo_attack::FIANCHETTO_VARIATION;
assert_eq!(FIANCHETTO_VARIATION.original_name(), "Sicilian Defense: Nyezhmetdinov-Rossolimo Attack, Fianchetto Variation");
```"#)]
pub static FIANCHETTO_VARIATION: Variation = Variation {
    name: "Fianchetto Variation",
    variations: &[&TOTSKY_ATTACK,
&LUTIKOV_GAMBIT,
&GUFELD_GAMBIT],
