...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Sicilian Defense: Nyezhmetdinov-Rossolimo Attack, Fianchetto Variation, Totsky Attack.
pub static TOTSKY_ATTACK: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<31>(),
    },
    name: Cow::Borrowed(&["Sicilian Defense", "Nyezhmetdinov-Rossolimo Attack", "Fianchetto Variation", "Totsky Attack"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
