...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Sicilian Defense: Nyezhmetdinov-Rossolimo Attack.
pub static NYEZHMETDINOV_ROSSOLIMO_ATTACK: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<30>(),
    },
    name: Cow::Borrowed(&["Sicilian Defense", "Nyezhmetdinov-Rossolimo Attack"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
