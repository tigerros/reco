...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Sicilian Defense: Alapin Variation, Barmen Defense, Endgame Variation.
pub static ENDGAME_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<22>(),
    },
    name: Cow::Borrowed(&["Sicilian Defense", "Alapin Variation", "Barmen Defense", "Endgame Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
