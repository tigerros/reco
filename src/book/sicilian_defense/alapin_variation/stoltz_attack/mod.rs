...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Sicilian Defense: Alapin Variation, Stoltz Attack.
pub static STOLTZ_ATTACK: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<22>(),
    },
    name: Cow::Borrowed(&["Sicilian Defense", "Alapin Variation", "Stoltz Attack"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
