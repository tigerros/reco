...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Sicilian Defense: Najdorf Variation, Opocensky Variation.
pub static OPOCENSKY_VARIATION: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<92>(),
    },
    name: Cow::Borrowed(&["Sicilian Defense", "Najdorf Variation", "Opocensky Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
