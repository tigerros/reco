...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Sicilian Defense: Najdorf Variation.
pub static NAJDORF_VARIATION: [Opening<&str>; 5] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<90>(),
    },
    name: Cow::Borrowed(&["Sicilian Defense", "Najdorf Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
