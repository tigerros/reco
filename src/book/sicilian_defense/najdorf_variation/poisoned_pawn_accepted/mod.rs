...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Sicilian Defense: Najdorf Variation, Poisoned Pawn Accepted.
pub static POISONED_PAWN_ACCEPTED: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<97>(),
    },
    name: Cow::Borrowed(&["Sicilian Defense", "Najdorf Variation", "Poisoned Pawn Accepted"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
