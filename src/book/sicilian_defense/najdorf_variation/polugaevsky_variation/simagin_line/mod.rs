...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Sicilian Defense: Najdorf Variation, Polugaevsky Variation, Simagin Line.
pub static SIMAGIN_LINE: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<96>(),
    },
    name: Cow::Borrowed(&["Sicilian Defense", "Najdorf Variation", "Polugaevsky Variation", "Simagin Line"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
