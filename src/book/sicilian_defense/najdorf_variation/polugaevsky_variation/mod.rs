...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Sicilian Defense: Najdorf Variation, Polugaevsky Variation.
pub static POLUGAEVSKY_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<96>(),
    },
    name: Cow::Borrowed(&["Sicilian Defense", "Najdorf Variation", "Polugaevsky Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
