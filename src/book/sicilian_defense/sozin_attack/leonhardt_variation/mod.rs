...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Sicilian Defense: Sozin Attack, Leonhardt Variation.
pub static LEONHARDT_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<88>(),
    },
    name: Cow::Borrowed(&["Sicilian Defense", "Sozin Attack", "Leonhardt Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
