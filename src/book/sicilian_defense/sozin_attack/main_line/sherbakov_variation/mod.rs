...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Sicilian Defense: Sozin Attack, Main Line, Sherbakov Variation.
pub static SHERBAKOV_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<89>(),
    },
    name: Cow::Borrowed(&["Sicilian Defense", "Sozin Attack", "Main Line", "Sherbakov Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
