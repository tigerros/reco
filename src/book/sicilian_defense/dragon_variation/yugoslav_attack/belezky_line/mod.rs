...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Sicilian Defense: Dragon Variation, Yugoslav Attack, Belezky Line.
pub static BELEZKY_LINE: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<75>(),
    },
    name: Cow::Borrowed(&["Sicilian Defense", "Dragon Variation", "Yugoslav Attack", "Belezky Line"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
