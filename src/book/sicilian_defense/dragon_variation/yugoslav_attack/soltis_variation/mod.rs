...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Sicilian Defense: Dragon Variation, Yugoslav Attack, Soltis Variation.
pub static SOLTIS_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<79>(),
    },
    name: Cow::Borrowed(&["Sicilian Defense", "Dragon Variation", "Yugoslav Attack", "Soltis Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
