...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Sicilian Defense: Dragon Variation, Yugoslav Attack.
pub static YUGOSLAV_ATTACK: [Opening<&str>; 5] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<76>(),
    },
    name: Cow::Borrowed(&["Sicilian Defense", "Dragon Variation", "Yugoslav Attack"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
