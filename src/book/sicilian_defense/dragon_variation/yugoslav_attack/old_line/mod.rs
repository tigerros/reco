...
# use reco::book::sicilian_defense::dragon_variation::yugoslav_attack::OLD_LINE;
assert_eq!(OLD_LINE.original_name(), "Sicilian Defense: Dragon Variation, Yugoslav Attack, Old Line");
```"#)]
