...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Sicilian Defense: Dragon Variation, Yugoslav Attack, Modern Line.
pub static MODERN_LINE: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<76>(),
    },
    name: Cow::Borrowed(&["Sicilian Defense", "Dragon Variation", "Yugoslav Attack", "Modern Line"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
