...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Sicilian Defense: Dragon Variation, Classical Variation, Grigoriev Variation.
pub static GRIGORIEV_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<72>(),
    },
    name: Cow::Borrowed(&["Sicilian Defense", "Dragon Variation", "Classical Variation", "Grigoriev Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
