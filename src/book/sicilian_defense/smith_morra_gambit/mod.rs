...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Sicilian Defense: Smith-Morra Gambit.
pub static SMITH_MORRA_GAMBIT: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<21>(),
    },
    name: Cow::Borrowed(&["Sicilian Defense", "Smith-Morra Gambit"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
