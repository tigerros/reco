...
# use reco::book::sicilian_defense::GODIVA_VARIATION;
assert_eq!(GODIVA_VARIATION.original_name(), "Sicilian Defense: Godiva Variation");
```"#)]
pub static GODIVA_VARIATION: Variation = Variation {
    name: "Godiva Variation",
    variations: &[],
