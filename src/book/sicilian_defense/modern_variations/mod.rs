...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Sicilian Defense: Modern Variations.
pub static MODERN_VARIATIONS: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<50>(),
    },
    name: Cow::Borrowed(&["Sicilian Defense", "Modern Variations"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
