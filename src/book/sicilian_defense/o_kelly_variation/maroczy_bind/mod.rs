...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Sicilian Defense: O'Kelly Variation, Maróczy Bind.
pub static MAROCZY_BIND: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<28>(),
    },
    name: Cow::Borrowed(&["Sicilian Defense", "O'Kelly Variation", "Maróczy Bind"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
    ...
    setup: Cow::Owned(Setup {
        board: Board::from_bitboards(
            ByRole {
                pawn: Bitboard(70369861204765440),
