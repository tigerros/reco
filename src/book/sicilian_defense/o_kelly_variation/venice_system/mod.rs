...
# use reco::book::sicilian_defense::o_kelly_variation::VENICE_SYSTEM;
assert_eq!(VENICE_SYSTEM.original_name(), "Sicilian Defense: O'Kelly Variation, Venice System");
```"#)]
pub static VENICE_SYSTEM: Variation = Variation {
    name: "Venice System",
    variations: &[&GAMBIT_LINE,
&LJUBOJEVIC_LINE,
&BARCZA_LINE,
&STEINER_LINE],
