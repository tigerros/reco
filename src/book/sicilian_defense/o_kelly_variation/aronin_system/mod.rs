...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Sicilian Defense: O'Kelly Variation, Aronin System.
pub static ARONIN_SYSTEM: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<28>(),
    },
    name: Cow::Borrowed(&["Sicilian Defense", "O'Kelly Variation", "Aronin System"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
