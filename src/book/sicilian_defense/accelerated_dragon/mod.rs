...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Sicilian Defense: Accelerated Dragon.
pub static ACCELERATED_DRAGON: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<32>(),
    },
    name: Cow::Borrowed(&["Sicilian Defense", "Accelerated Dragon"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
