...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Sicilian Defense: Accelerated Dragon, Simagin Variation.
pub static SIMAGIN_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<37>(),
    },
    name: Cow::Borrowed(&["Sicilian Defense", "Accelerated Dragon", "Simagin Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
