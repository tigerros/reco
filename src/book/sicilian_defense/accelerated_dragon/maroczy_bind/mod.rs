...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Sicilian Defense: Accelerated Dragon, Maróczy Bind.
pub static MAROCZY_BIND: [Opening<&str>; 3] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<36>(),
    },
    name: Cow::Borrowed(&["Sicilian Defense", "Accelerated Dragon", "Maróczy Bind"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
