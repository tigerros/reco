...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Sicilian Defense: Nimzowitsch Variation.
pub static NIMZOWITSCH_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<29>(),
    },
    name: Cow::Borrowed(&["Sicilian Defense", "Nimzowitsch Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
