...
# use reco::book::sicilian_defense::NIMZOWITSCH_VARIATION;
assert_eq!(NIMZOWITSCH_VARIATION.original_name(), "Sicilian Defense: Nimzowitsch Variation");
```"#)]
pub static NIMZOWITSCH_VARIATION: Variation = Variation {
    name: "Nimzowitsch Variation",
    variations: &[&CLOSED_VARIATION,
&ADVANCE_VARIATION,
&MAIN_LINE,
&EXCHANGE_VARIATION],
