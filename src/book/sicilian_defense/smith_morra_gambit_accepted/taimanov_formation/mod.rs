...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Sicilian Defense: Smith-Morra Gambit Accepted, Taimanov Formation.
pub static TAIMANOV_FORMATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<21>(),
    },
    name: Cow::Borrowed(&["Sicilian Defense", "Smith-Morra Gambit Accepted", "Taimanov Formation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
