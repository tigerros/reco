...
# use reco::book::sicilian_defense::kan_variation::WING_ATTACK;
assert_eq!(WING_ATTACK.original_name(), "Sicilian Defense: Kan Variation, Wing Attack");
```"#)]
pub static WING_ATTACK: Variation = Variation {
    name: "Wing Attack",
    variations: &[&SPRAGGETT_ATTACK,
