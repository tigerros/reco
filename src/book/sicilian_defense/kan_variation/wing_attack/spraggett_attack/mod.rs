...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Sicilian Defense: Kan Variation, Wing Attack, Spraggett Attack.
pub static SPRAGGETT_ATTACK: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<43>(),
    },
    name: Cow::Borrowed(&["Sicilian Defense", "Kan Variation", "Wing Attack", "Spraggett Attack"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
