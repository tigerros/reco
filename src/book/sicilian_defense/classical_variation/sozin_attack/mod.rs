...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Sicilian Defense: Classical Variation, Sozin Attack.
pub static SOZIN_ATTACK: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<57>(),
    },
    name: Cow::Borrowed(&["Sicilian Defense", "Classical Variation", "Sozin Attack"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
