...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Sicilian Defense: Hyperaccelerated Pterodactyl, Exchange Variation.
pub static EXCHANGE_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<27>(),
    },
    name: Cow::Borrowed(&["Sicilian Defense", "Hyperaccelerated Pterodactyl", "Exchange Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
