...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Sicilian Defense: Scheveningen Variation, Classical Variation, Paulsen Variation.
pub static PAULSEN_VARIATION: [Opening<&str>; 3] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<85>(),
    },
    name: Cow::Borrowed(&["Sicilian Defense", "Scheveningen Variation", "Classical Variation", "Paulsen Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
