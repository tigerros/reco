...
# use reco::book::sicilian_defense::scheveningen_variation::CLASSICAL_VARIATION;
assert_eq!(CLASSICAL_VARIATION.original_name(), "Sicilian Defense: Scheveningen Variation, Classical Variation");
```"#)]
pub static CLASSICAL_VARIATION: Variation = Variation {
    name: "Classical Variation",
    variations: &[&PAULSEN_VARIATION],
