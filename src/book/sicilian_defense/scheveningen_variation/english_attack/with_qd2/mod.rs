...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Sicilian Defense: Scheveningen Variation, English Attack, with Qd2.
pub static WITH_QD2: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<80>(),
    },
    name: Cow::Borrowed(&["Sicilian Defense", "Scheveningen Variation", "English Attack", "with Qd2"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
