...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Sicilian Defense: Scheveningen Variation, Modern Variation.
pub static MODERN_VARIATION: [Opening<&str>; 3] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<83>(),
    },
    name: Cow::Borrowed(&["Sicilian Defense", "Scheveningen Variation", "Modern Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
    ...
    setup: Cow::Owned(Setup {
        board: Board::from_bitboards(
            ByRole {
                ...
                bishop: Bitboard(6755399442108416),
                rook: Bitboard(2377900603251621921),
                queen: Bitboard(576460752303423496),
                king: Bitboard(4611686018427387968)
            },
            ByColor {
                black: Bitboard(7636763563834474496),
