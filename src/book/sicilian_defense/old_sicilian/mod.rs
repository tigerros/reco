...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Sicilian Defense: Old Sicilian.
pub static OLD_SICILIAN: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<30>(),
    },
    name: Cow::Borrowed(&["Sicilian Defense", "Old Sicilian"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
