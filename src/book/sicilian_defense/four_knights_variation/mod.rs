...
# use reco::book::sicilian_defense::FOUR_KNIGHTS_VARIATION;
assert_eq!(FOUR_KNIGHTS_VARIATION.original_name(), "Sicilian Defense: Four Knights Variation");
```"#)]
pub static FOUR_KNIGHTS_VARIATION: Variation = Variation {
    name: "Four Knights Variation",
    variations: &[&COBRA_VARIATION,
&EXCHANGE_VARIATION],
