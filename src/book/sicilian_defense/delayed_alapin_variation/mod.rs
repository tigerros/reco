...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Sicilian Defense: Delayed Alapin Variation.
pub static DELAYED_ALAPIN_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<22>(),
    },
    name: Cow::Borrowed(&["Sicilian Defense", "Delayed Alapin Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
