...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Sicilian Defense: Richter-Rauzer Variation, Neo-Modern Variation.
pub static NEO_MODERN_VARIATION: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<67>(),
    },
    name: Cow::Borrowed(&["Sicilian Defense", "Richter-Rauzer Variation", "Neo-Modern Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
