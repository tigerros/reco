...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Sicilian Defense: Richter-Rauzer Variation.
pub static RICHTER_RAUZER_VARIATION: [Opening<&str>; 3] = [Opening {
    code: Code {
        volume: Volume::B,
