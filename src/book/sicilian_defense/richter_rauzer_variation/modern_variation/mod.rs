...
# use reco::book::sicilian_defense::richter_rauzer_variation::MODERN_VARIATION;
assert_eq!(MODERN_VARIATION.original_name(), "Sicilian Defense: Richter-Rauzer Variation, Modern Variation");
```"#)]
