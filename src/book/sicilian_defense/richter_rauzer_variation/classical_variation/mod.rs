...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Sicilian Defense: Richter-Rauzer Variation, Classical Variation.
pub static CLASSICAL_VARIATION: [Opening<&str>; 4] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<63>(),
    },
    name: Cow::Borrowed(&["Sicilian Defense", "Richter-Rauzer Variation", "Classical Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
