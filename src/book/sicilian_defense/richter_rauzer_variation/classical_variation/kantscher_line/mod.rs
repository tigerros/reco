...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Sicilian Defense: Richter-Rauzer Variation, Classical Variation, Kantscher Line.
pub static KANTSCHER_LINE: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<63>(),
    },
    name: Cow::Borrowed(&["Sicilian Defense", "Richter-Rauzer Variation", "Classical Variation", "Kantscher Line"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
