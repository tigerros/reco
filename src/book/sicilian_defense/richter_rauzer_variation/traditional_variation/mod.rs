...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Sicilian Defense: Richter-Rauzer Variation, Traditional Variation.
pub static TRADITIONAL_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<63>(),
    },
    name: Cow::Borrowed(&["Sicilian Defense", "Richter-Rauzer Variation", "Traditional Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
