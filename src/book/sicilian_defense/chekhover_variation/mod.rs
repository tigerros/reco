...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Sicilian Defense: Chekhover Variation.
pub static CHEKHOVER_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<53>(),
    },
    name: Cow::Borrowed(&["Sicilian Defense", "Chekhover Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
    ...
    setup: Cow::Owned(Setup {
        board: Board::from_bitboards(
            ...
            ByColor {
                black: Bitboard(18443093695105335296),
