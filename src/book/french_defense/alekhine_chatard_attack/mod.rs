...
# use reco::book::french_defense::ALEKHINE_CHATARD_ATTACK;
assert_eq!(ALEKHINE_CHATARD_ATTACK.original_name(), "French Defense: Alekhine-Chatard Attack");
```"#)]
pub static ALEKHINE_CHATARD_ATTACK: Variation = Variation {
