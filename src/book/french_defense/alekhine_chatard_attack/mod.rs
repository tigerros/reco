...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// French Defense: Alekhine-Chatard Attack.
pub static ALEKHINE_CHATARD_ATTACK: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<13>(),
    },
    name: Cow::Borrowed(&["French Defense", "Alekhine-Chatard Attack"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
    ...
    setup: Cow::Owned(Setup {
        board: Board::from_bitboards(
            ...
            ByColor {
                black: Bitboard(11528951197637541888),
