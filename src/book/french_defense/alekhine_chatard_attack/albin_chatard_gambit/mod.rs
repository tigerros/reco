...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// French Defense: Alekhine-Chatard Attack, Albin-Chatard Gambit.
pub static ALBIN_CHATARD_GAMBIT: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<13>(),
    },
    name: Cow::Borrowed(&["French Defense", "Alekhine-Chatard Attack", "Albin-Chatard Gambit"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
