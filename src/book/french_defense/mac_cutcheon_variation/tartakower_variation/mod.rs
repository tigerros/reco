...
# use reco::book::french_defense::mac_cutcheon_variation::TARTAKOWER_VARIATION;
assert_eq!(TARTAKOWER_VARIATION.original_name(), "French Defense: MacCutcheon Variation, Tartakower Variation");
```"#)]
