...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// French Defense: MacCutcheon Variation.
pub static MAC_CUTCHEON_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<12>(),
    },
    name: Cow::Borrowed(&["French Defense", "MacCutcheon Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
