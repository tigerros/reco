...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// French Defense: Classical Variation, Normal Variation.
pub static NORMAL_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<13>(),
    },
    name: Cow::Borrowed(&["French Defense", "Classical Variation", "Normal Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
