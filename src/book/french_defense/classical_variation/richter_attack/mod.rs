...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// French Defense: Classical Variation, Richter Attack.
pub static RICHTER_ATTACK: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::C,
