...
# use reco::book::french_defense::classical_variation::TARTAKOWER_VARIATION;
assert_eq!(TARTAKOWER_VARIATION.original_name(), "French Defense: Classical Variation, Tartakower Variation");
```"#)]
