...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// French Defense: Classical Variation, Rubinstein Variation.
pub static RUBINSTEIN_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<14>(),
    },
    name: Cow::Borrowed(&["French Defense", "Classical Variation", "Rubinstein Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
