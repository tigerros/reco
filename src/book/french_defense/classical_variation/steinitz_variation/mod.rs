...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// French Defense: Classical Variation, Steinitz Variation.
pub static STEINITZ_VARIATION: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<11>(),
    },
    name: Cow::Borrowed(&["French Defense", "Classical Variation", "Steinitz Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
