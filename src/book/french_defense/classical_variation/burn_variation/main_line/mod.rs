...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// French Defense: Classical Variation, Burn Variation, Main Line.
pub static MAIN_LINE: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<11>(),
    },
    name: Cow::Borrowed(&["French Defense", "Classical Variation", "Burn Variation", "Main Line"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
