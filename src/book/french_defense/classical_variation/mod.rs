...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// French Defense: Classical Variation.
pub static CLASSICAL_VARIATION: [Opening<&str>; 3] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<11>(),
    },
    name: Cow::Borrowed(&["French Defense", "Classical Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
