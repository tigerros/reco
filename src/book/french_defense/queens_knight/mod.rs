...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// French Defense: Queen's Knight.
pub static QUEENS_KNIGHT: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<0>(),
    },
    name: Cow::Borrowed(&["French Defense", "Queen's Knight"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
