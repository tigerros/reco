...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// French Defense: Steinitz Variation, Brodsky-Jones Variation.
pub static BRODSKY_JONES_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<11>(),
    },
    name: Cow::Borrowed(&["French Defense", "Steinitz Variation", "Brodsky-Jones Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
