...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// French Defense: Steinitz Variation.
pub static STEINITZ_VARIATION: [Opening<&str>; 5] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<11>(),
    },
    name: Cow::Borrowed(&["French Defense", "Steinitz Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
    ...
    setup: Cow::Owned(Setup {
        board: Board::from_bitboards(
            ByRole {
                pawn: Bitboard(64758039554680320),
                knight: Bitboard(146366987891900416),
                bishop: Bitboard(2594073385365405732),
                rook: Bitboard(9295429630892703873),
                queen: Bitboard(576460752303423496),
