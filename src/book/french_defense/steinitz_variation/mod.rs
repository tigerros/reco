...
# use reco::book::french_defense::STEINITZ_VARIATION;
assert_eq!(STEINITZ_VARIATION.original_name(), "French Defense: Steinitz Variation");
```"#)]
pub static STEINITZ_VARIATION: Variation = Variation {
    name: "Steinitz Variation",
    variations: &[&BRODSKY_JONES_VARIATION,
