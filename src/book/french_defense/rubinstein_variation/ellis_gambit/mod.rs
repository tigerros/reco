...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// French Defense: Rubinstein Variation, Ellis Gambit.
pub static ELLIS_GAMBIT: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<10>(),
    },
    name: Cow::Borrowed(&["French Defense", "Rubinstein Variation", "Ellis Gambit"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
