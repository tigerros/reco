...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// French Defense: Exchange Variation.
pub static EXCHANGE_VARIATION: [Opening<&str>; 3] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<1>(),
    },
    name: Cow::Borrowed(&["French Defense", "Exchange Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
