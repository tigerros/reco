...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// French Defense: Hecht-Reefschläger Variation.
pub static HECHT_REEFSCHLAGER_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<10>(),
    },
    name: Cow::Borrowed(&["French Defense", "Hecht-Reefschläger Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
