...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// French Defense: Advance Variation, Milner-Barry Gambit, Sørensen Variation.
pub static SORENSEN_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<2>(),
    },
    name: Cow::Borrowed(&["French Defense", "Advance Variation", "Milner-Barry Gambit", "Sørensen Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
