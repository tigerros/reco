...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// French Defense: Advance Variation, Milner-Barry Gambit, Hector Variation.
pub static HECTOR_VARIATION: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<2>(),
    },
    name: Cow::Borrowed(&["French Defense", "Advance Variation", "Milner-Barry Gambit", "Hector Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
