...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// French Defense: Advance Variation, Main Line.
pub static MAIN_LINE: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<2>(),
    },
    name: Cow::Borrowed(&["French Defense", "Advance Variation", "Main Line"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
