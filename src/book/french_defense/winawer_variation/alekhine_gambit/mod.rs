...
# use reco::book::french_defense::winawer_variation::ALEKHINE_GAMBIT;
assert_eq!(ALEKHINE_GAMBIT.original_name(), "French Defense: Winawer Variation, Alekhine Gambit");
```"#)]
pub static ALEKHINE_GAMBIT: Variation = Variation {
    name: "Alekhine Gambit",
    variations: &[&KAN_VARIATION,
