...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// French Defense: Winawer Variation, Advance Variation.
pub static ADVANCE_VARIATION: [Opening<&str>; 8] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<16>(),
    },
    name: Cow::Borrowed(&["French Defense", "Winawer Variation", "Advance Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
