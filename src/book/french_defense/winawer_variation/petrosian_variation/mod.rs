...
# use reco::book::french_defense::winawer_variation::PETROSIAN_VARIATION;
assert_eq!(PETROSIAN_VARIATION.original_name(), "French Defense: Winawer Variation, Petrosian Variation");
```"#)]
