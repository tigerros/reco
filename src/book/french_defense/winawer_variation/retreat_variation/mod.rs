...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// French Defense: Winawer Variation, Retreat Variation.
pub static RETREAT_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<17>(),
    },
    name: Cow::Borrowed(&["French Defense", "Winawer Variation", "Retreat Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
