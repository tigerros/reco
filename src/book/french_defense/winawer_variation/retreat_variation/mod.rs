...
# use reco::book::french_defense::winawer_variation::RETREAT_VARIATION;
assert_eq!(RETREAT_VARIATION.original_name(), "French Defense: Winawer Variation, Retreat Variation");
```"#)]
pub static RETREAT_VARIATION: Variation = Variation {
    name: "Retreat Variation",
    variations: &[&ARMENIAN_LINE],
