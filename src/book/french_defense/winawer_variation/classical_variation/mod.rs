...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// French Defense: Winawer Variation, Classical Variation.
pub static CLASSICAL_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<18>(),
    },
    name: Cow::Borrowed(&["French Defense", "Winawer Variation", "Classical Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
    ...
    setup: Cow::Owned(Setup {
        board: Board::from_bitboards(
            ...
            ByColor {
                black: Bitboard(15557421081500319744),
