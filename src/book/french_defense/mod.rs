...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// French Defense.
pub static FRENCH_DEFENSE: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<0>(),
    },
    name: Cow::Borrowed(&["French Defense"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
