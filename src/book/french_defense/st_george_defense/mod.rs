...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// French Defense: St. George Defense.
pub static ST_GEORGE_DEFENSE: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<0>(),
    },
    name: Cow::Borrowed(&["French Defense", "St. George Defense"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
    ...
    setup: Cow::Owned(Setup {
        board: Board::from_bitboards(
            ByRole {
                pawn: Bitboard(67009736557520640),
