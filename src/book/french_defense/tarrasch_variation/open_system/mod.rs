...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// French Defense: Tarrasch Variation, Open System.
pub static OPEN_SYSTEM: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<7>(),
    },
    name: Cow::Borrowed(&["French Defense", "Tarrasch Variation", "Open System"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
