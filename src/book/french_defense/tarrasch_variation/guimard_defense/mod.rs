...
# use reco::book::french_defense::tarrasch_variation::GUIMARD_DEFENSE;
assert_eq!(GUIMARD_DEFENSE.original_name(), "French Defense: Tarrasch Variation, Guimard Defense");
```"#)]
