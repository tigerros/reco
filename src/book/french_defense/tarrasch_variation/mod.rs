...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// French Defense: Tarrasch Variation.
pub static TARRASCH_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<3>(),
    },
    name: Cow::Borrowed(&["French Defense", "Tarrasch Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
