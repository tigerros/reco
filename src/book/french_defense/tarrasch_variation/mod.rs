...
# use reco::book::french_defense::TARRASCH_VARIATION;
assert_eq!(TARRASCH_VARIATION.original_name(), "French Defense: Tarrasch Variation");
```"#)]
pub static TARRASCH_VARIATION: Variation = Variation {
    name: "Tarrasch Variation",
    variations: &[&ELISKASES_VARIATION,
&OPEN_SYSTEM,
&CHISTYAKOV_DEFENSE,
&HABERDITZ_VARIATION,
&MODERN_SYSTEM,
