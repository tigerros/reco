...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// King's Knight Opening: Normal Variation.
pub static NORMAL_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<44>(),
    },
    name: Cow::Borrowed(&["King's Knight Opening", "Normal Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
