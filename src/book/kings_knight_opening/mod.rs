...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// King's Knight Opening.
pub static KINGS_KNIGHT_OPENING: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<40>(),
    },
    name: Cow::Borrowed(&["King's Knight Opening"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
