...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Barnes Opening: Gedult Gambit.
pub static GEDULT_GAMBIT: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<0>(),
    },
    name: Cow::Borrowed(&["Barnes Opening", "Gedult Gambit"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: F2,
