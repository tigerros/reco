...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Barnes Opening: Fool's Mate.
pub static FOOLS_MATE: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<0>(),
    },
    name: Cow::Borrowed(&["Barnes Opening", "Fool's Mate"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: F2,
