...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Barnes Opening: Walkerling.
pub static WALKERLING: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<20>(),
    },
    name: Cow::Borrowed(&["Barnes Opening", "Walkerling"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: F2,
