...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Sodium Attack.
pub static SODIUM_ATTACK: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<0>(),
    },
    name: Cow::Borrowed(&["Sodium Attack"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Knight,
        from: B1,
