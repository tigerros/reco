...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Réti Opening: Anglo-Slav Variation, Bogoljubow Variation.
pub static BOGOLJUBOW_VARIATION: [Opening<&str>; 3] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<12>(),
    },
    name: Cow::Borrowed(&["Réti Opening", "Anglo-Slav Variation", "Bogoljubow Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Knight,
        from: G1,
