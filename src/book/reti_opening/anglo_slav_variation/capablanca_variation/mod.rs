...
# use reco::book::reti_opening::anglo_slav_variation::CAPABLANCA_VARIATION;
assert_eq!(CAPABLANCA_VARIATION.original_name(), "Réti Opening: Anglo-Slav Variation, Capablanca Variation");
```"#)]
