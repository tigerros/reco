...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Réti Opening: Penguin Variation.
pub static PENGUIN_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<9>(),
    },
    name: Cow::Borrowed(&["Réti Opening", "Penguin Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Knight,
        from: G1,
