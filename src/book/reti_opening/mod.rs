...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Réti Opening.
pub static RETI_OPENING: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<9>(),
    },
    name: Cow::Borrowed(&["Réti Opening"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Knight,
        from: G1,
