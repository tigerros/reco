...
# use reco::book::RETI_OPENING;
assert_eq!(RETI_OPENING.original_name(), "Réti Opening");
```"#)]
pub static RETI_OPENING: Variation = Variation {
    name: "Réti Opening",
    variations: &[&PENGUIN_VARIATION,
&ADVANCE_VARIATION,
&RETI_GAMBIT,
&RETI_ACCEPTED,
&ZILBERMINTS_GAMBIT,
&REVERSED_BLUMENFELD_GAMBIT,
&ANGLO_SLAV_VARIATION],
    parent: None,
    lines: &[Line {
    code: Code {
        volume: Volume::A,
...
pub mod reti_gambit;
pub use reti_gambit::RETI_GAMBIT;
...
pub use anglo_slav_variation::ANGLO_SLAV_VARIATION;
