...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Portuguese Opening.
pub static PORTUGUESE_OPENING: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<20>(),
    },
    name: Cow::Borrowed(&["Portuguese Opening"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
