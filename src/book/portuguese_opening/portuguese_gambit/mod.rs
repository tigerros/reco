...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Portuguese Opening: Portuguese Gambit.
pub static PORTUGUESE_GAMBIT: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<20>(),
    },
    name: Cow::Borrowed(&["Portuguese Opening", "Portuguese Gambit"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
