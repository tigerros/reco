...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Hippopotamus Defense.
pub static HIPPOPOTAMUS_DEFENSE: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<0>(),
    },
    name: Cow::Borrowed(&["Hippopotamus Defense"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
    ...
    setup: Cow::Owned(Setup {
        board: Board::from_bitboards(
            ByRole {
                pawn: Bitboard(44860074883080960),
            ...
            ByColor {
                black: Bitboard(13808001273145851904),
