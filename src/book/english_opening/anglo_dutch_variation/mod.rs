...
# use reco::book::english_opening::ANGLO_DUTCH_VARIATION;
assert_eq!(ANGLO_DUTCH_VARIATION.original_name(), "English Opening: Anglo-Dutch Variation");
```"#)]
pub static ANGLO_DUTCH_VARIATION: Variation = Variation {
    name: "Anglo-Dutch Variation",
    variations: &[&FERENC_GAMBIT,
&CHABANON_GAMBIT],
