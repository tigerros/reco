...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// English Opening: Symmetrical, Hedgehog, Flexible Formation.
pub static FLEXIBLE_FORMATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<30>(),
    },
    name: Cow::Borrowed(&["English Opening", "Symmetrical", "Hedgehog", "Flexible Formation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: C2,
