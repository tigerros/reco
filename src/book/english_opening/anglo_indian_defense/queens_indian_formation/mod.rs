...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// English Opening: Anglo-Indian Defense, Queen's Indian Formation.
pub static QUEENS_INDIAN_FORMATION: [Opening<&str>; 3] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<15>(),
    },
    name: Cow::Borrowed(&["English Opening", "Anglo-Indian Defense", "Queen's Indian Formation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: C2,
