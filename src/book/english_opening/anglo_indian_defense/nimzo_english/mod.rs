...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// English Opening: Anglo-Indian Defense, Nimzo-English.
pub static NIMZO_ENGLISH: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<17>(),
    },
    name: Cow::Borrowed(&["English Opening", "Anglo-Indian Defense", "Nimzo-English"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: C2,
