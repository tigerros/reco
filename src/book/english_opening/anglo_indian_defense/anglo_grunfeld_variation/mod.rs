...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// English Opening: Anglo-Indian Defense, Anglo-Grünfeld Variation.
pub static ANGLO_GRUNFELD_VARIATION: [Opening<&str>; 4] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<16>(),
    },
    name: Cow::Borrowed(&["English Opening", "Anglo-Indian Defense", "Anglo-Grünfeld Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: C2,
