...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// English Opening: Anglo-Indian Defense.
pub static ANGLO_INDIAN_DEFENSE: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<15>(),
    },
    name: Cow::Borrowed(&["English Opening", "Anglo-Indian Defense"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: C2,
