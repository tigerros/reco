...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// English Opening: Anglo-Lithuanian Variation.
pub static ANGLO_LITHUANIAN_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<10>(),
    },
    name: Cow::Borrowed(&["English Opening", "Anglo-Lithuanian Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: C2,
