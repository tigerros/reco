...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// English Opening: Agincourt Defense, Catalan Defense.
pub static CATALAN_DEFENSE: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<13>(),
    },
    name: Cow::Borrowed(&["English Opening", "Agincourt Defense", "Catalan Defense"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: C2,
