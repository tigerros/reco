...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// English Opening: Agincourt Defense, Keres Defense.
pub static KERES_DEFENSE: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<14>(),
    },
    name: Cow::Borrowed(&["English Opening", "Agincourt Defense", "Keres Defense"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: C2,
