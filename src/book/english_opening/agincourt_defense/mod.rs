...
# use reco::book::english_opening::AGINCOURT_DEFENSE;
assert_eq!(AGINCOURT_DEFENSE.original_name(), "English Opening: Agincourt Defense");
```"#)]
pub static AGINCOURT_DEFENSE: Variation = Variation {
    name: "Agincourt Defense",
    variations: &[&TARRASCH_DEFENSE,
&KERES_DEFENSE,
