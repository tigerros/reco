...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// English Opening: King's English Variation, Four Knights Variation, Fianchetto Line.
pub static FIANCHETTO_LINE: [Opening<&str>; 4] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<29>(),
    },
    name: Cow::Borrowed(&["English Opening", "King's English Variation", "Four Knights Variation", "Fianchetto Line"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: C2,
