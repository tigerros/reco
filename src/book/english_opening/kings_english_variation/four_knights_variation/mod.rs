...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// English Opening: King's English Variation, Four Knights Variation.
pub static FOUR_KNIGHTS_VARIATION: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<28>(),
    },
    name: Cow::Borrowed(&["English Opening", "King's English Variation", "Four Knights Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: C2,
