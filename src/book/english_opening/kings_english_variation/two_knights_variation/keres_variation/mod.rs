...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// English Opening: King's English Variation, Two Knights Variation, Keres Variation.
pub static KERES_VARIATION: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<23>(),
    },
    name: Cow::Borrowed(&["English Opening", "King's English Variation", "Two Knights Variation", "Keres Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: C2,
