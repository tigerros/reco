...
# use reco::book::english_opening::kings_english_variation::two_knights_variation::KERES_VARIATION;
assert_eq!(KERES_VARIATION.original_name(), "English Opening: King's English Variation, Two Knights Variation, Keres Variation");
```"#)]
