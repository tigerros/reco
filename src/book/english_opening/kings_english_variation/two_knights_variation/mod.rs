...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// English Opening: King's English Variation, Two Knights Variation.
pub static TWO_KNIGHTS_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<22>(),
    },
    name: Cow::Borrowed(&["English Opening", "King's English Variation", "Two Knights Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: C2,
