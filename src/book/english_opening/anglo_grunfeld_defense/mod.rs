...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// English Opening: Anglo-Grünfeld Defense.
pub static ANGLO_GRUNFELD_DEFENSE: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<16>(),
    },
    name: Cow::Borrowed(&["English Opening", "Anglo-Grünfeld Defense"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: C2,
