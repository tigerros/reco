...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// English Opening: Anglo-Grünfeld Defense, Korchnoi Variation.
pub static KORCHNOI_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<16>(),
    },
    name: Cow::Borrowed(&["English Opening", "Anglo-Grünfeld Defense", "Korchnoi Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: C2,
