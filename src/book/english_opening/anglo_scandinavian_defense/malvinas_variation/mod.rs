...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// English Opening: Anglo-Scandinavian Defense, Malvinas Variation.
pub static MALVINAS_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<10>(),
    },
    name: Cow::Borrowed(&["English Opening", "Anglo-Scandinavian Defense", "Malvinas Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: C2,
