...
# use reco::book::english_opening::ANGLO_SCANDINAVIAN_DEFENSE;
assert_eq!(ANGLO_SCANDINAVIAN_DEFENSE.original_name(), "English Opening: Anglo-Scandinavian Defense");
```"#)]
pub static ANGLO_SCANDINAVIAN_DEFENSE: Variation = Variation {
    name: "Anglo-Scandinavian Defense",
    variations: &[&MALVINAS_VARIATION,
&LOHN_GAMBIT,
&SCHULZ_GAMBIT],
