...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// English Opening: Symmetrical Variation.
pub static SYMMETRICAL_VARIATION: [Opening<&str>; 4] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<30>(),
    },
    name: Cow::Borrowed(&["English Opening", "Symmetrical Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: C2,
