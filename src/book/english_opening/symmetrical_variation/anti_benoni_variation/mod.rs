...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// English Opening: Symmetrical Variation, Anti-Benoni Variation.
pub static ANTI_BENONI_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<31>(),
    },
    name: Cow::Borrowed(&["English Opening", "Symmetrical Variation", "Anti-Benoni Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: C2,
