...
# use reco::book::english_opening::symmetrical_variation::THREE_KNIGHTS_VARIATION;
assert_eq!(THREE_KNIGHTS_VARIATION.original_name(), "English Opening: Symmetrical Variation, Three Knights Variation");
```"#)]
