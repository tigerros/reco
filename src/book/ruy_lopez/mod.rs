...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Ruy Lopez.
pub static RUY_LOPEZ: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<60>(),
    },
    name: Cow::Borrowed(&["Ruy Lopez"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
