...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Ruy Lopez: Steinitz Defense.
pub static STEINITZ_DEFENSE: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<62>(),
    },
    name: Cow::Borrowed(&["Ruy Lopez", "Steinitz Defense"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
    ...
    setup: Cow::Owned(Setup {
        board: Board::from_bitboards(
            ...
            ByColor {
                black: Bitboard(18295605274074939392),
