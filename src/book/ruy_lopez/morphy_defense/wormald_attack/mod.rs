...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Ruy Lopez: Morphy Defense, Wormald Attack.
pub static WORMALD_ATTACK: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<77>(),
    },
    name: Cow::Borrowed(&["Ruy Lopez", "Morphy Defense", "Wormald Attack"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
