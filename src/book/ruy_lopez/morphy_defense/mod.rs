...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Ruy Lopez: Morphy Defense.
pub static MORPHY_DEFENSE: [Opening<&str>; 3] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<70>(),
    },
    name: Cow::Borrowed(&["Ruy Lopez", "Morphy Defense"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
