...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Ruy Lopez: Morphy Defense, Modern Steinitz Defense.
pub static MODERN_STEINITZ_DEFENSE: [Opening<&str>; 10] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<71>(),
    },
    name: Cow::Borrowed(&["Ruy Lopez", "Morphy Defense", "Modern Steinitz Defense"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
