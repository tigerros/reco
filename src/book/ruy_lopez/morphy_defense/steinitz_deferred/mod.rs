...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Ruy Lopez: Morphy Defense, Steinitz Deferred.
pub static STEINITZ_DEFERRED: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<79>(),
    },
    name: Cow::Borrowed(&["Ruy Lopez", "Morphy Defense", "Steinitz Deferred"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
