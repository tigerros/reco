...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Ruy Lopez: Closed, Lutikov Variation.
pub static LUTIKOV_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<90>(),
    },
    name: Cow::Borrowed(&["Ruy Lopez", "Closed", "Lutikov Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
