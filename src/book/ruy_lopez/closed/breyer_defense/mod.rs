...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Ruy Lopez: Closed, Breyer Defense.
pub static BREYER_DEFENSE: [Opening<&str>; 3] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<94>(),
    },
    name: Cow::Borrowed(&["Ruy Lopez", "Closed", "Breyer Defense"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
