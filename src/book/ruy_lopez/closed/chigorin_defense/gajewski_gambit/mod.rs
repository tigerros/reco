...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Ruy Lopez: Closed, Chigorin Defense, Gajewski Gambit.
pub static GAJEWSKI_GAMBIT: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<96>(),
    },
    name: Cow::Borrowed(&["Ruy Lopez", "Closed", "Chigorin Defense", "Gajewski Gambit"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
