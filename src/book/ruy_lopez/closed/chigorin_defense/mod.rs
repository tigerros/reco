...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Ruy Lopez: Closed, Chigorin Defense.
pub static CHIGORIN_DEFENSE: [Opening<&str>; 6] = [Opening {
    code: Code {
        volume: Volume::C,
