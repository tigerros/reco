...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Ruy Lopez: Closed, Worrall Attack, Castling Line.
pub static CASTLING_LINE: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<86>(),
    },
    name: Cow::Borrowed(&["Ruy Lopez", "Closed", "Worrall Attack", "Castling Line"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
