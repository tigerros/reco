...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Ruy Lopez: Closed, Breyer.
pub static BREYER: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<95>(),
    },
    name: Cow::Borrowed(&["Ruy Lopez", "Closed", "Breyer"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
