...
# use reco::book::ruy_lopez::closed::FLOHR_SYSTEM;
assert_eq!(FLOHR_SYSTEM.original_name(), "Ruy Lopez: Closed, Flohr System");
```"#)]
pub static FLOHR_SYSTEM: Variation = Variation {
    name: "Flohr System",
    variations: &[],
