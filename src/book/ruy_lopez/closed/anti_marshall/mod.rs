...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Ruy Lopez: Closed, Anti-Marshall.
pub static ANTI_MARSHALL: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<88>(),
    },
    name: Cow::Borrowed(&["Ruy Lopez", "Closed", "Anti-Marshall"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
