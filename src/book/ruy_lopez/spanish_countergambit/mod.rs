...
# use reco::book::ruy_lopez::SPANISH_COUNTERGAMBIT;
assert_eq!(SPANISH_COUNTERGAMBIT.original_name(), "Ruy Lopez: Spanish Countergambit");
```"#)]
pub static SPANISH_COUNTERGAMBIT: Variation = Variation {
    name: "Spanish Countergambit",
    variations: &[&HARDING_COUNTERGAMBIT,
&HARDING_GAMBIT],
