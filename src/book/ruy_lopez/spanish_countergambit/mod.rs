...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Ruy Lopez: Spanish Countergambit.
pub static SPANISH_COUNTERGAMBIT: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<60>(),
    },
    name: Cow::Borrowed(&["Ruy Lopez", "Spanish Countergambit"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
