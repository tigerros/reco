...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Ruy Lopez: Exchange Variation, Keres Variation.
pub static KERES_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<68>(),
    },
    name: Cow::Borrowed(&["Ruy Lopez", "Exchange Variation", "Keres Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
