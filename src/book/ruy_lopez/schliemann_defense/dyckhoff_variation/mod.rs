...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Ruy Lopez: Schliemann Defense, Dyckhoff Variation.
pub static DYCKHOFF_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<63>(),
    },
    name: Cow::Borrowed(&["Ruy Lopez", "Schliemann Defense", "Dyckhoff Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
