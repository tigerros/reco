...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Ruy Lopez: Open.
pub static OPEN: [Opening<&str>; 5] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<80>(),
    },
    name: Cow::Borrowed(&["Ruy Lopez", "Open"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
