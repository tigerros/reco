...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Ruy Lopez: Open, Howell Attack, Ekstrom Variation.
pub static EKSTROM_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<81>(),
    },
    name: Cow::Borrowed(&["Ruy Lopez", "Open", "Howell Attack", "Ekstrom Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
