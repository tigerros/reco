...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Ruy Lopez: Open, Howell Attack.
pub static HOWELL_ATTACK: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<81>(),
    },
    name: Cow::Borrowed(&["Ruy Lopez", "Open", "Howell Attack"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
