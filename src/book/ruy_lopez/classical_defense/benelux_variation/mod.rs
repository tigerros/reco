...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Ruy Lopez: Classical Defense, Benelux Variation.
pub static BENELUX_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<64>(),
    },
    name: Cow::Borrowed(&["Ruy Lopez", "Classical Defense", "Benelux Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
