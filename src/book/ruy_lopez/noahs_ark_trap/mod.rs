...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Ruy Lopez: Noah's Ark Trap.
pub static NOAHS_ARK_TRAP: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<71>(),
    },
    name: Cow::Borrowed(&["Ruy Lopez", "Noah's Ark Trap"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
    ...
    setup: Cow::Owned(Setup {
        board: Board::from_bitboards(
            ByRole {
                pawn: Bitboard(63060316426135296),
            ...
            ByColor {
                black: Bitboard(18293631607753408512),
                white: Bitboard(402843543)
            }
        ),
        promoted: Bitboard(0),
        pockets: None,
    ...
    setup: Cow::Owned(Setup {
        board: Board::from_bitboards(
            ...
            ByColor {
                black: Bitboard(11380641364111785984),
                white: Bitboard(402843479)
            }
        ),
        promoted: Bitboard(0),
        pockets: None,
