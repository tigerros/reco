...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Ruy Lopez: Berlin Defense, Rio de Janeiro Variation.
pub static RIO_DE_JANEIRO_VARIATION: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<67>(),
    },
    name: Cow::Borrowed(&["Ruy Lopez", "Berlin Defense", "Rio de Janeiro Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
