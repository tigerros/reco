...
# use reco::book::ruy_lopez::berlin_defense::L_HERMET_VARIATION;
assert_eq!(L_HERMET_VARIATION.original_name(), "Ruy Lopez: Berlin Defense, l'Hermet Variation");
```"#)]
pub static L_HERMET_VARIATION: Variation = Variation {
    name: "l'Hermet Variation",
    variations: &[&BERLIN_WALL_DEFENSE,
&WESTERINEN_LINE],
