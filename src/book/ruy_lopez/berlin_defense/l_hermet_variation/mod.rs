...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Ruy Lopez: Berlin Defense, l'Hermet Variation.
pub static L_HERMET_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<67>(),
    },
    name: Cow::Borrowed(&["Ruy Lopez", "Berlin Defense", "l'Hermet Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
