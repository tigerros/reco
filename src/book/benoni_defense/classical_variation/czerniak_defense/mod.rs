...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Benoni Defense: Classical Variation, Czerniak Defense.
pub static CZERNIAK_DEFENSE: [Opening<&str>; 3] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<76>(),
    },
    name: Cow::Borrowed(&["Benoni Defense", "Classical Variation", "Czerniak Defense"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
