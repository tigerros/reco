...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Benoni Defense: Classical Variation, Czerniak Defense, Tal Line.
pub static TAL_LINE: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<77>(),
    },
    name: Cow::Borrowed(&["Benoni Defense", "Classical Variation", "Czerniak Defense", "Tal Line"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
