...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Benoni Defense: Classical Variation, Main Line.
pub static MAIN_LINE: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<73>(),
    },
    name: Cow::Borrowed(&["Benoni Defense", "Classical Variation", "Main Line"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
