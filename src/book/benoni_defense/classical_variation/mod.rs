...
# use reco::book::benoni_defense::CLASSICAL_VARIATION;
assert_eq!(CLASSICAL_VARIATION.original_name(), "Benoni Defense: Classical Variation");
```"#)]
pub static CLASSICAL_VARIATION: Variation = Variation {
    name: "Classical Variation",
    variations: &[&NEW_YORK_VARIATION,
