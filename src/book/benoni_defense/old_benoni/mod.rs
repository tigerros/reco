...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Benoni Defense: Old Benoni.
pub static OLD_BENONI: [Opening<&str>; 4] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<43>(),
    },
    name: Cow::Borrowed(&["Benoni Defense", "Old Benoni"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
