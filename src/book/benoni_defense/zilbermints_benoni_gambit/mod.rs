...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Benoni Defense: Zilbermints-Benoni Gambit.
pub static ZILBERMINTS_BENONI_GAMBIT: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<43>(),
    },
    name: Cow::Borrowed(&["Benoni Defense", "Zilbermints-Benoni Gambit"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
