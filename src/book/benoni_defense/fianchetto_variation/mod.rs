...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Benoni Defense: Fianchetto Variation.
pub static FIANCHETTO_VARIATION: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<61>(),
    },
    name: Cow::Borrowed(&["Benoni Defense", "Fianchetto Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
