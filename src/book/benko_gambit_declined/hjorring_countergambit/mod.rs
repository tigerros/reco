...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Benko Gambit Declined: Hjørring Countergambit.
pub static HJORRING_COUNTERGAMBIT: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<57>(),
    },
    name: Cow::Borrowed(&["Benko Gambit Declined", "Hjørring Countergambit"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
