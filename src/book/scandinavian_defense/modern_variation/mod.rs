...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Scandinavian Defense: Modern Variation.
pub static MODERN_VARIATION: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<1>(),
    },
    name: Cow::Borrowed(&["Scandinavian Defense", "Modern Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
