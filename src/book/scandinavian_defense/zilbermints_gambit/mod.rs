...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Scandinavian Defense: Zilbermints Gambit.
pub static ZILBERMINTS_GAMBIT: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<1>(),
    },
    name: Cow::Borrowed(&["Scandinavian Defense", "Zilbermints Gambit"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
    ...
    setup: Cow::Owned(Setup {
        board: Board::from_bitboards(
            ByRole {
                pawn: Bitboard(69524353909320960),
