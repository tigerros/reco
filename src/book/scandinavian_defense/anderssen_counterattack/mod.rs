...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Scandinavian Defense: Anderssen Counterattack.
pub static ANDERSSEN_COUNTERATTACK: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<1>(),
    },
    name: Cow::Borrowed(&["Scandinavian Defense", "Anderssen Counterattack"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
