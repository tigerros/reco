...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Scandinavian Defense: Portuguese Gambit, Correspondence Refutation.
pub static CORRESPONDENCE_REFUTATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<1>(),
    },
    name: Cow::Borrowed(&["Scandinavian Defense", "Portuguese Gambit", "Correspondence Refutation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
