...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Scandinavian Defense: Portuguese Gambit, Classical Variation.
pub static CLASSICAL_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<1>(),
    },
    name: Cow::Borrowed(&["Scandinavian Defense", "Portuguese Gambit", "Classical Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
