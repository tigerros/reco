...
# use reco::book::scandinavian_defense::PORTUGUESE_GAMBIT;
assert_eq!(PORTUGUESE_GAMBIT.original_name(), "Scandinavian Defense: Portuguese Gambit");
```"#)]
pub static PORTUGUESE_GAMBIT: Variation = Variation {
    name: "Portuguese Gambit",
    variations: &[&ELBOW_VARIATION,
&CLASSICAL_VARIATION,
