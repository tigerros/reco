...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Queen's Pawn Game: Chigorin Variation, Anti-Veresov.
pub static ANTI_VERESOV: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::D,
        category: RangedU8::new_static::<0>(),
    },
    name: Cow::Borrowed(&["Queen's Pawn Game", "Chigorin Variation", "Anti-Veresov"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
