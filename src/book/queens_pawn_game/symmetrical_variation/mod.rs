...
# use reco::book::queens_pawn_game::SYMMETRICAL_VARIATION;
assert_eq!(SYMMETRICAL_VARIATION.original_name(), "Queen's Pawn Game: Symmetrical Variation");
```"#)]
pub static SYMMETRICAL_VARIATION: Variation = Variation {
    name: "Symmetrical Variation",
    variations: &[&PSEUDO_CATALAN],
