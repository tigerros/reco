...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Queen's Pawn Game.
pub static QUEENS_PAWN_GAME: [Opening<&str>; 5] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<40>(),
    },
    name: Cow::Borrowed(&["Queen's Pawn Game"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
