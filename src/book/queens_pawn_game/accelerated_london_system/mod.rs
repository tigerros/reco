...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Queen's Pawn Game: Accelerated London System.
pub static ACCELERATED_LONDON_SYSTEM: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::D,
        category: RangedU8::new_static::<0>(),
    },
    name: Cow::Borrowed(&["Queen's Pawn Game", "Accelerated London System"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
