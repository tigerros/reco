...
# use reco::book::queens_pawn_game::accelerated_london_system::STEINITZ_COUNTERGAMBIT;
assert_eq!(STEINITZ_COUNTERGAMBIT.original_name(), "Queen's Pawn Game: Accelerated London System, Steinitz Countergambit");
```"#)]
pub static STEINITZ_COUNTERGAMBIT: Variation = Variation {
    name: "Steinitz Countergambit",
    variations: &[&MORRIS_COUNTERGAMBIT_ACCEPTED,
&MORRIS_COUNTERGAMBIT],
