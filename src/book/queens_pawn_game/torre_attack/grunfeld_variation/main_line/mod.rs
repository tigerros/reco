...
# use reco::book::queens_pawn_game::torre_attack::grunfeld_variation::MAIN_LINE;
assert_eq!(MAIN_LINE.original_name(), "Queen's Pawn Game: Torre Attack, Grünfeld Variation, Main Line");
```"#)]
pub static MAIN_LINE: Variation = Variation {
    name: "Main Line",
    variations: &[],
    parent: Some(&super::GRUNFELD_VARIATION),
    lines: &[Line {
    code: Code {
        volume: Volume::A,
