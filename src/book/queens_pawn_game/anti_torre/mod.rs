...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Queen's Pawn Game: Anti-Torre.
pub static ANTI_TORRE: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::D,
        category: RangedU8::new_static::<2>(),
    },
    name: Cow::Borrowed(&["Queen's Pawn Game", "Anti-Torre"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Knight,
        from: G1,
