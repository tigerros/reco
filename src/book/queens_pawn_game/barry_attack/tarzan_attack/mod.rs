...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Queen's Pawn Game: Barry Attack, Tarzan Attack.
pub static TARZAN_ATTACK: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<48>(),
    },
    name: Cow::Borrowed(&["Queen's Pawn Game", "Barry Attack", "Tarzan Attack"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
