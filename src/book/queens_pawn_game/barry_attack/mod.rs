...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Queen's Pawn Game: Barry Attack.
pub static BARRY_ATTACK: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<48>(),
    },
    name: Cow::Borrowed(&["Queen's Pawn Game", "Barry Attack"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
