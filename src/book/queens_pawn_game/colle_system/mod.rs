...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Queen's Pawn Game: Colle System.
pub static COLLE_SYSTEM: [Opening<&str>; 3] = [Opening {
    code: Code {
        volume: Volume::D,
        category: RangedU8::new_static::<4>(),
    },
    name: Cow::Borrowed(&["Queen's Pawn Game", "Colle System"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
