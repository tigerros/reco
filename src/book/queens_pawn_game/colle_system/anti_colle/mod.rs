...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Queen's Pawn Game: Colle System, Anti-Colle.
pub static ANTI_COLLE: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::D,
        category: RangedU8::new_static::<4>(),
    },
    name: Cow::Borrowed(&["Queen's Pawn Game", "Colle System", "Anti-Colle"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
