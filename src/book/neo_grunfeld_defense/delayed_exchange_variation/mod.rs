...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Neo-Grünfeld Defense: Delayed Exchange Variation.
pub static DELAYED_EXCHANGE_VARIATION: [Opening<&str>; 4] = [Opening {
    code: Code {
        volume: Volume::D,
        category: RangedU8::new_static::<74>(),
    },
    name: Cow::Borrowed(&["Neo-Grünfeld Defense", "Delayed Exchange Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
