...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Neo-Grünfeld Defense: with g3.
pub static WITH_G3: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::D,
        category: RangedU8::new_static::<70>(),
    },
    name: Cow::Borrowed(&["Neo-Grünfeld Defense", "with g3"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
