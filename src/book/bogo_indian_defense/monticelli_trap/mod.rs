...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Bogo-Indian Defense: Monticelli Trap.
pub static MONTICELLI_TRAP: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::E,
        category: RangedU8::new_static::<11>(),
    },
    name: Cow::Borrowed(&["Bogo-Indian Defense", "Monticelli Trap"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
