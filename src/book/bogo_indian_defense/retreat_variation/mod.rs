...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Bogo-Indian Defense: Retreat Variation.
pub static RETREAT_VARIATION: [Opening<&str>; 8] = [Opening {
    code: Code {
        volume: Volume::E,
        category: RangedU8::new_static::<11>(),
    },
    name: Cow::Borrowed(&["Bogo-Indian Defense", "Retreat Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
