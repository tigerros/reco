...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Bogo-Indian Defense: Grünfeld Variation.
pub static GRUNFELD_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::E,
        category: RangedU8::new_static::<11>(),
    },
    name: Cow::Borrowed(&["Bogo-Indian Defense", "Grünfeld Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
