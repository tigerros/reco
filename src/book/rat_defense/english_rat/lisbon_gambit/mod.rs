...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Rat Defense: English Rat, Lisbon Gambit.
pub static LISBON_GAMBIT: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<41>(),
    },
    name: Cow::Borrowed(&["Rat Defense", "English Rat", "Lisbon Gambit"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
