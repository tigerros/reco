...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Latvian Gambit Accepted: Bronstein Gambit.
pub static BRONSTEIN_GAMBIT: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<40>(),
    },
    name: Cow::Borrowed(&["Latvian Gambit Accepted", "Bronstein Gambit"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
