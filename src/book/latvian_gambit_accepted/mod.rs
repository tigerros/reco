...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Latvian Gambit Accepted.
pub static LATVIAN_GAMBIT_ACCEPTED: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<40>(),
    },
    name: Cow::Borrowed(&["Latvian Gambit Accepted"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
