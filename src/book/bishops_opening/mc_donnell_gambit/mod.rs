...
# use reco::book::bishops_opening::MC_DONNELL_GAMBIT;
assert_eq!(MC_DONNELL_GAMBIT.original_name(), "Bishop's Opening: McDonnell Gambit");
```"#)]
pub static MC_DONNELL_GAMBIT: Variation = Variation {
    name: "McDonnell Gambit",
    variations: &[&LA_BOURDONNAIS_DENKER_GAMBIT,
&MC_DONNELL_DOUBLE_GAMBIT],
