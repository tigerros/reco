...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Bishop's Opening: Lopez Variation.
pub static LOPEZ_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<23>(),
    },
    name: Cow::Borrowed(&["Bishop's Opening", "Lopez Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
