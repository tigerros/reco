...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Bishop's Opening: Boden-Kieseritzky Gambit.
pub static BODEN_KIESERITZKY_GAMBIT: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<27>(),
    },
    name: Cow::Borrowed(&["Bishop's Opening", "Boden-Kieseritzky Gambit"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
