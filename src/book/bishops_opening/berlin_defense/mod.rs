...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Bishop's Opening: Berlin Defense.
pub static BERLIN_DEFENSE: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<24>(),
    },
    name: Cow::Borrowed(&["Bishop's Opening", "Berlin Defense"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
