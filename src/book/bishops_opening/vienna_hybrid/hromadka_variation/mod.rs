...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Bishop's Opening: Vienna Hybrid, Hromádka Variation.
pub static HROMADKA_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<28>(),
    },
    name: Cow::Borrowed(&["Bishop's Opening", "Vienna Hybrid", "Hromádka Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
