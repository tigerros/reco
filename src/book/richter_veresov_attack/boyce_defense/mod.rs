...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Richter-Veresov Attack: Boyce Defense.
pub static BOYCE_DEFENSE: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::D,
        category: RangedU8::new_static::<1>(),
    },
    name: Cow::Borrowed(&["Richter-Veresov Attack", "Boyce Defense"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
