...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Richter-Veresov Attack.
pub static RICHTER_VERESOV_ATTACK: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::D,
        category: RangedU8::new_static::<1>(),
    },
    name: Cow::Borrowed(&["Richter-Veresov Attack"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
