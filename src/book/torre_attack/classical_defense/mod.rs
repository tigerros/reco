...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Torre Attack: Classical Defense.
pub static CLASSICAL_DEFENSE: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<46>(),
    },
    name: Cow::Borrowed(&["Torre Attack", "Classical Defense"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
