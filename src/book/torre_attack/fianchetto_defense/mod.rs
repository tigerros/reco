...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Torre Attack: Fianchetto Defense.
pub static FIANCHETTO_DEFENSE: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<48>(),
    },
    name: Cow::Borrowed(&["Torre Attack", "Fianchetto Defense"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
