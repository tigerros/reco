...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Bongcloud Attack.
pub static BONGCLOUD_ATTACK: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<20>(),
    },
    name: Cow::Borrowed(&["Bongcloud Attack"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
