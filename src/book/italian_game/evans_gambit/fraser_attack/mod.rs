...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Italian Game: Evans Gambit, Fraser Attack.
pub static FRASER_ATTACK: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<51>(),
    },
    name: Cow::Borrowed(&["Italian Game", "Evans Gambit", "Fraser Attack"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
