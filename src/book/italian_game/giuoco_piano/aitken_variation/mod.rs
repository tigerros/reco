...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Italian Game: Giuoco Piano, Aitken Variation.
pub static AITKEN_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<54>(),
    },
    name: Cow::Borrowed(&["Italian Game", "Giuoco Piano", "Aitken Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
