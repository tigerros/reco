...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Italian Game: Evans Gambit Declined, Hirschbach Variation.
pub static HIRSCHBACH_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<51>(),
    },
    name: Cow::Borrowed(&["Italian Game", "Evans Gambit Declined", "Hirschbach Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
