...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Italian Game: Evans Gambit Declined.
pub static EVANS_GAMBIT_DECLINED: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<51>(),
    },
    name: Cow::Borrowed(&["Italian Game", "Evans Gambit Declined"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
