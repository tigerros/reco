...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Italian Game: Two Knights Defense, Maróczy Variation.
pub static MAROCZY_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<58>(),
    },
    name: Cow::Borrowed(&["Italian Game", "Two Knights Defense", "Maróczy Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
