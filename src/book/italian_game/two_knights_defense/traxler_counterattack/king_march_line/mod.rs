...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Italian Game: Two Knights Defense, Traxler Counterattack, King March Line.
pub static KING_MARCH_LINE: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<57>(),
    },
    name: Cow::Borrowed(&["Italian Game", "Two Knights Defense", "Traxler Counterattack", "King March Line"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
