...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Italian Game: Two Knights Defense.
pub static TWO_KNIGHTS_DEFENSE: [Opening<&str>; 3] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<55>(),
    },
    name: Cow::Borrowed(&["Italian Game", "Two Knights Defense"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
