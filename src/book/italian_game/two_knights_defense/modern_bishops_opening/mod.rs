...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Italian Game: Two Knights Defense, Modern Bishop's Opening.
pub static MODERN_BISHOPS_OPENING: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<55>(),
    },
    name: Cow::Borrowed(&["Italian Game", "Two Knights Defense", "Modern Bishop's Opening"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
