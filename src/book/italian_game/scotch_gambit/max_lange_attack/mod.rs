...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Italian Game: Scotch Gambit, Max Lange Attack.
pub static MAX_LANGE_ATTACK: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<56>(),
    },
    name: Cow::Borrowed(&["Italian Game", "Scotch Gambit", "Max Lange Attack"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
    ...
    setup: Cow::Owned(Setup {
        board: Board::from_bitboards(
            ...
            ByColor {
                black: Bitboard(13683910425597444096),
                white: Bitboard(77311567775)
            }
        ),
        promoted: Bitboard(0),
        pockets: None,
