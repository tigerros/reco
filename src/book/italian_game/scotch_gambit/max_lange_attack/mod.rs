...
# use reco::book::italian_game::scotch_gambit::MAX_LANGE_ATTACK;
assert_eq!(MAX_LANGE_ATTACK.original_name(), "Italian Game: Scotch Gambit, Max Lange Attack");
```"#)]
pub static MAX_LANGE_ATTACK: Variation = Variation {
    name: "Max Lange Attack",
    variations: &[&SPIELMANN_DEFENSE,
&LONG_VARIATION],
