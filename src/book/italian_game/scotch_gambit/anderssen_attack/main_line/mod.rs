...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Italian Game: Scotch Gambit, Anderssen Attack, Main Line.
pub static MAIN_LINE: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<56>(),
    },
    name: Cow::Borrowed(&["Italian Game", "Scotch Gambit", "Anderssen Attack", "Main Line"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
