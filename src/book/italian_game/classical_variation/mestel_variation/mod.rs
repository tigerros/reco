...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Italian Game: Classical Variation, Mestel Variation.
pub static MESTEL_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<53>(),
    },
    name: Cow::Borrowed(&["Italian Game", "Classical Variation", "Mestel Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
