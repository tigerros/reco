...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Italian Game: Classical Variation, Giuoco Pianissimo, with d6.
pub static WITH_D6: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<54>(),
    },
    name: Cow::Borrowed(&["Italian Game", "Classical Variation", "Giuoco Pianissimo", "with d6"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
