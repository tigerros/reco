...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Italian Game: Classical Variation, Giuoco Pianissimo.
pub static GIUOCO_PIANISSIMO: [Opening<&str>; 5] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<54>(),
    },
    name: Cow::Borrowed(&["Italian Game", "Classical Variation", "Giuoco Pianissimo"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
