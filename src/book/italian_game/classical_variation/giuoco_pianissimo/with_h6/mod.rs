...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Italian Game: Classical Variation, Giuoco Pianissimo, with h6.
pub static WITH_H6: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<54>(),
    },
    name: Cow::Borrowed(&["Italian Game", "Classical Variation", "Giuoco Pianissimo", "with h6"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
