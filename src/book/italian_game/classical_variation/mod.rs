...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Italian Game: Classical Variation.
pub static CLASSICAL_VARIATION: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<53>(),
    },
    name: Cow::Borrowed(&["Italian Game", "Classical Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
...
}];pub mod albin_gambit;
pub use albin_gambit::ALBIN_GAMBIT;
pub mod center_attack;
pub use center_attack::CENTER_ATTACK;
pub mod center_holding_variation;
pub use center_holding_variation::CENTER_HOLDING_VARIATION;
pub mod closed_variation;
pub use closed_variation::CLOSED_VARIATION;
pub mod eisinger_variation;
pub use eisinger_variation::EISINGER_VARIATION;
...
pub mod mestel_variation;
pub use mestel_variation::MESTEL_VARIATION;
