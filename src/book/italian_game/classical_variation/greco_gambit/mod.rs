...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Italian Game: Classical Variation, Greco Gambit.
pub static GRECO_GAMBIT: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<54>(),
    },
    name: Cow::Borrowed(&["Italian Game", "Classical Variation", "Greco Gambit"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
    ...
    setup: Cow::Owned(Setup {
        board: Board::from_bitboards(
            ByRole {
                pawn: Bitboard(65020822833914624),
            ...
            ByColor {
                black: Bitboard(11378102617667272704),
