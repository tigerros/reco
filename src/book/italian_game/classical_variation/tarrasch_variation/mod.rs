...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Italian Game: Classical Variation, Tarrasch Variation.
pub static TARRASCH_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<53>(),
    },
    name: Cow::Borrowed(&["Italian Game", "Classical Variation", "Tarrasch Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
    ...
    setup: Cow::Owned(Setup {
        board: Board::from_bitboards(
            ByRole {
                pawn: Bitboard(64749209395683840),
            ...
            ByColor {
                black: Bitboard(10805876101688066048),
                white: Bitboard(497312351)
            }
        ),
        promoted: Bitboard(0),
        pockets: None,
