...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Italian Game: Giuoco Pianissimo.
pub static GIUOCO_PIANISSIMO: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<50>(),
    },
    name: Cow::Borrowed(&["Italian Game", "Giuoco Pianissimo"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
