...
# use reco::book::italian_game::GIUOCO_PIANISSIMO;
assert_eq!(GIUOCO_PIANISSIMO.original_name(), "Italian Game: Giuoco Pianissimo");
```"#)]
pub static GIUOCO_PIANISSIMO: Variation = Variation {
    name: "Giuoco Pianissimo",
    variations: &[&ITALIAN_FOUR_KNIGHTS_VARIATION,
&LUCCHINI_GAMBIT,
&DUBOIS_VARIATION,
&CANAL_VARIATION,
&NORMAL],
