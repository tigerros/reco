...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Indian Defense: Anti-Nimzo-Indian.
pub static ANTI_NIMZO_INDIAN: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::E,
        category: RangedU8::new_static::<10>(),
    },
    name: Cow::Borrowed(&["Indian Defense", "Anti-Nimzo-Indian"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
