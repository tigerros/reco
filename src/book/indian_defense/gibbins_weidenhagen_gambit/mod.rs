...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Indian Defense: Gibbins-Weidenhagen Gambit.
pub static GIBBINS_WEIDENHAGEN_GAMBIT: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<45>(),
    },
    name: Cow::Borrowed(&["Indian Defense", "Gibbins-Weidenhagen Gambit"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
    ...
    setup: Cow::Owned(Setup {
        board: Board::from_bitboards(
            ByRole {
                pawn: Bitboard(71776120269223680),
