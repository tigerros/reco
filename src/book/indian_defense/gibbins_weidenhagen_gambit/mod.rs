...
# use reco::book::indian_defense::GIBBINS_WEIDENHAGEN_GAMBIT;
assert_eq!(GIBBINS_WEIDENHAGEN_GAMBIT.original_name(), "Indian Defense: Gibbins-Weidenhagen Gambit");
```"#)]
pub static GIBBINS_WEIDENHAGEN_GAMBIT: Variation = Variation {
    name: "Gibbins-Weidenhagen Gambit",
    variations: &[&STUMMER_GAMBIT,
&MALTESE_FALCON,
&OSHIMA_DEFENSE],
