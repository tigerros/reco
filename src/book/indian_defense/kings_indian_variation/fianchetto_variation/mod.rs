...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Indian Defense: King's Indian Variation, Fianchetto Variation.
pub static FIANCHETTO_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::E,
        category: RangedU8::new_static::<60>(),
    },
    name: Cow::Borrowed(&["Indian Defense", "King's Indian Variation", "Fianchetto Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
