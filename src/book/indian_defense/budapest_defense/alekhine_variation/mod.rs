...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Indian Defense: Budapest Defense, Alekhine Variation.
pub static ALEKHINE_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<52>(),
    },
    name: Cow::Borrowed(&["Indian Defense", "Budapest Defense", "Alekhine Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
