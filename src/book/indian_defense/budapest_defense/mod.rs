...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Indian Defense: Budapest Defense.
pub static BUDAPEST_DEFENSE: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<51>(),
    },
    name: Cow::Borrowed(&["Indian Defense", "Budapest Defense"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
