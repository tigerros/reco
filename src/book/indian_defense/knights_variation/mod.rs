...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Indian Defense: Knights Variation.
pub static KNIGHTS_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<46>(),
    },
    name: Cow::Borrowed(&["Indian Defense", "Knights Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
