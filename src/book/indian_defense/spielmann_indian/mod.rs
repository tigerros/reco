...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Indian Defense: Spielmann-Indian.
pub static SPIELMANN_INDIAN: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<46>(),
    },
    name: Cow::Borrowed(&["Indian Defense", "Spielmann-Indian"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
