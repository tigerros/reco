...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Indian Defense: Maddigan Gambit.
pub static MADDIGAN_GAMBIT: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<45>(),
    },
    name: Cow::Borrowed(&["Indian Defense", "Maddigan Gambit"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
