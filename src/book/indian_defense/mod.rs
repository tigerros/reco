...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Indian Defense.
pub static INDIAN_DEFENSE: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<45>(),
    },
    name: Cow::Borrowed(&["Indian Defense"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
