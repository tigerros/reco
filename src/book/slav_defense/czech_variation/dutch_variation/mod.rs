...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Slav Defense: Czech Variation, Dutch Variation.
pub static DUTCH_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::D,
        category: RangedU8::new_static::<19>(),
    },
    name: Cow::Borrowed(&["Slav Defense", "Czech Variation", "Dutch Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
