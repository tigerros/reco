...
# use reco::book::slav_defense::czech_variation::CARLSBAD_VARIATION;
assert_eq!(CARLSBAD_VARIATION.original_name(), "Slav Defense: Czech Variation, Carlsbad Variation");
```"#)]
