...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Slav Defense: Czech Variation, Krause Attack, Fazekas Gambit.
pub static FAZEKAS_GAMBIT: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::D,
        category: RangedU8::new_static::<17>(),
    },
    name: Cow::Borrowed(&["Slav Defense", "Czech Variation", "Krause Attack", "Fazekas Gambit"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
