...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Slav Defense: Two Knights Attack.
pub static TWO_KNIGHTS_ATTACK: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::D,
        category: RangedU8::new_static::<15>(),
    },
    name: Cow::Borrowed(&["Slav Defense", "Two Knights Attack"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
