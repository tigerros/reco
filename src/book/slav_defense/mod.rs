...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Slav Defense.
pub static SLAV_DEFENSE: [Opening<&str>; 3] = [Opening {
    code: Code {
        volume: Volume::D,
        category: RangedU8::new_static::<10>(),
    },
    name: Cow::Borrowed(&["Slav Defense"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
