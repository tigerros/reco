...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Slav Defense: Bonet Gambit.
pub static BONET_GAMBIT: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::D,
        category: RangedU8::new_static::<11>(),
    },
    name: Cow::Borrowed(&["Slav Defense", "Bonet Gambit"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
