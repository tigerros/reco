...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Slav Defense: Modern Line.
pub static MODERN_LINE: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::D,
        category: RangedU8::new_static::<11>(),
    },
    name: Cow::Borrowed(&["Slav Defense", "Modern Line"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
    ...
    setup: Cow::Owned(Setup {
        board: Board::from_bitboards(
            ByRole {
                pawn: Bitboard(50458787827462912),
            ...
            ByColor {
                black: Bitboard(13813494433305329664),
