...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Slav Defense: Geller Gambit.
pub static GELLER_GAMBIT: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::D,
        category: RangedU8::new_static::<15>(),
    },
    name: Cow::Borrowed(&["Slav Defense", "Geller Gambit"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
