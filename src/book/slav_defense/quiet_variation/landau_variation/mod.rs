...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Slav Defense: Quiet Variation, Landau Variation.
pub static LANDAU_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::D,
        category: RangedU8::new_static::<12>(),
    },
    name: Cow::Borrowed(&["Slav Defense", "Quiet Variation", "Landau Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
