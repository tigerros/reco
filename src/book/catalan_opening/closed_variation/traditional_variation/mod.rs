...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Catalan Opening: Closed Variation, Traditional Variation.
pub static TRADITIONAL_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::E,
        category: RangedU8::new_static::<9>(),
    },
    name: Cow::Borrowed(&["Catalan Opening", "Closed Variation", "Traditional Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
