...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Catalan Opening: Open Defense, Modern Sharp Variation.
pub static MODERN_SHARP_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::E,
        category: RangedU8::new_static::<4>(),
    },
    name: Cow::Borrowed(&["Catalan Opening", "Open Defense", "Modern Sharp Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
