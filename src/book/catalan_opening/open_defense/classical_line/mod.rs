...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Catalan Opening: Open Defense, Classical Line.
pub static CLASSICAL_LINE: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::E,
        category: RangedU8::new_static::<5>(),
    },
    name: Cow::Borrowed(&["Catalan Opening", "Open Defense", "Classical Line"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
