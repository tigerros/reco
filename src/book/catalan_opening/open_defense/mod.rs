...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Catalan Opening: Open Defense.
pub static OPEN_DEFENSE: [Opening<&str>; 4] = [Opening {
    code: Code {
        volume: Volume::E,
        category: RangedU8::new_static::<2>(),
    },
    name: Cow::Borrowed(&["Catalan Opening", "Open Defense"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
