...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Catalan Opening.
pub static CATALAN_OPENING: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::E,
        category: RangedU8::new_static::<0>(),
    },
    name: Cow::Borrowed(&["Catalan Opening"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
