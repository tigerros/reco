...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Catalan Opening: Closed, Botvinnik Variation.
pub static BOTVINNIK_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::E,
        category: RangedU8::new_static::<7>(),
    },
    name: Cow::Borrowed(&["Catalan Opening", "Closed", "Botvinnik Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
