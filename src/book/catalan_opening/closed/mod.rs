...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Catalan Opening: Closed.
pub static CLOSED: [Opening<&str>; 10] = [Opening {
    code: Code {
        volume: Volume::E,
        category: RangedU8::new_static::<1>(),
    },
    name: Cow::Borrowed(&["Catalan Opening", "Closed"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
