...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Vienna Gambit, with Max Lange Defense: Hamppe-Allgaier Gambit.
pub static HAMPPE_ALLGAIER_GAMBIT: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<25>(),
    },
    name: Cow::Borrowed(&["Vienna Gambit", "with Max Lange Defense", "Hamppe-Allgaier Gambit"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
    ...
    setup: Cow::Owned(Setup {
        board: Board::from_bitboards(
            ...
            ByColor {
                black: Bitboard(18279833812177256448),
