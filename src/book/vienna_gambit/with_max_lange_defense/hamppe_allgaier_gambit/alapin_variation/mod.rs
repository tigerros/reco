...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Vienna Gambit, with Max Lange Defense: Hamppe-Allgaier Gambit, Alapin Variation.
pub static ALAPIN_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<25>(),
    },
    name: Cow::Borrowed(&["Vienna Gambit", "with Max Lange Defense", "Hamppe-Allgaier Gambit", "Alapin Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
