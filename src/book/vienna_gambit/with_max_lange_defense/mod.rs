...
# use reco::book::vienna_gambit::WITH_MAX_LANGE_DEFENSE;
assert_eq!(WITH_MAX_LANGE_DEFENSE.original_name(), "Vienna Gambit: with Max Lange Defense");
```"#)]
pub static WITH_MAX_LANGE_DEFENSE: Variation = Variation {
    name: "with Max Lange Defense",
    variations: &[&HAMPPE_MUZIO_GAMBIT,
&QUELLE_GAMBIT,
&PIERCE_GAMBIT,
&STEINITZ_GAMBIT,
