...
# use reco::book::vienna_gambit::with_max_lange_defense::STEINITZ_GAMBIT;
assert_eq!(STEINITZ_GAMBIT.original_name(), "Vienna Gambit: with Max Lange Defense, Steinitz Gambit");
```"#)]
pub static STEINITZ_GAMBIT: Variation = Variation {
    name: "Steinitz Gambit",
    variations: &[&FRASER_MINCKWITZ_DEFENSE,
&PAULSEN_DEFENSE,
&SORENSEN_DEFENSE,
&ZUKERTORT_DEFENSE,
&MAIN_LINE],
