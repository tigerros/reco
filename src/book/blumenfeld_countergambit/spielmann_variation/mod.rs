...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Blumenfeld Countergambit: Spielmann Variation.
pub static SPIELMANN_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::E,
        category: RangedU8::new_static::<10>(),
    },
    name: Cow::Borrowed(&["Blumenfeld Countergambit", "Spielmann Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
