...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Pirc Defense: 150 Attack.
pub static N150_ATTACK: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<7>(),
    },
    name: Cow::Borrowed(&["Pirc Defense", "150 Attack"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
