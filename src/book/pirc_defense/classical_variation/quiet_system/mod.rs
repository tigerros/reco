...
# use reco::book::pirc_defense::classical_variation::QUIET_SYSTEM;
assert_eq!(QUIET_SYSTEM.original_name(), "Pirc Defense: Classical Variation, Quiet System");
```"#)]
pub static QUIET_SYSTEM: Variation = Variation {
    name: "Quiet System",
    variations: &[&PARMA_DEFENSE,
&CHIGORIN_LINE,
&CZECH_DEFENSE],
