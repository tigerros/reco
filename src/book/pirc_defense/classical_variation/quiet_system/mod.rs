...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Pirc Defense: Classical Variation, Quiet System.
pub static QUIET_SYSTEM: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<8>(),
    },
    name: Cow::Borrowed(&["Pirc Defense", "Classical Variation", "Quiet System"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
