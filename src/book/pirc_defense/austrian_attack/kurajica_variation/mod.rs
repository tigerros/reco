...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Pirc Defense: Austrian Attack, Kurajica Variation.
pub static KURAJICA_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<9>(),
    },
    name: Cow::Borrowed(&["Pirc Defense", "Austrian Attack", "Kurajica Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
