...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Pirc Defense: Kholmov System.
pub static KHOLMOV_SYSTEM: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<7>(),
    },
    name: Cow::Borrowed(&["Pirc Defense", "Kholmov System"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
