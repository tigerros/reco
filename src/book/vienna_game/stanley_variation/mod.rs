...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Vienna Game: Stanley Variation.
pub static STANLEY_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<26>(),
    },
    name: Cow::Borrowed(&["Vienna Game", "Stanley Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
