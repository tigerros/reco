...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Vienna Game: Stanley Variation, Monster Declined.
pub static MONSTER_DECLINED: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<27>(),
    },
    name: Cow::Borrowed(&["Vienna Game", "Stanley Variation", "Monster Declined"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
