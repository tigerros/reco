...
# use reco::book::vienna_game::stanley_variation::THREE_KNIGHTS_VARIATION;
assert_eq!(THREE_KNIGHTS_VARIATION.original_name(), "Vienna Game: Stanley Variation, Three Knights Variation");
```"#)]
