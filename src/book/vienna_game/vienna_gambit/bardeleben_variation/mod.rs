...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Vienna Game: Vienna Gambit, Bardeleben Variation.
pub static BARDELEBEN_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<29>(),
    },
    name: Cow::Borrowed(&["Vienna Game", "Vienna Gambit", "Bardeleben Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
