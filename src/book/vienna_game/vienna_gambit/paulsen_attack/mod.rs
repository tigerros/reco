...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Vienna Game: Vienna Gambit, Paulsen Attack.
pub static PAULSEN_ATTACK: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<29>(),
    },
    name: Cow::Borrowed(&["Vienna Game", "Vienna Gambit", "Paulsen Attack"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
