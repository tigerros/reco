...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Vienna Game: Vienna Gambit.
pub static VIENNA_GAMBIT: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<29>(),
    },
    name: Cow::Borrowed(&["Vienna Game", "Vienna Gambit"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
