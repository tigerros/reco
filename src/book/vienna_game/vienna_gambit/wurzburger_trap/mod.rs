...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Vienna Game: Vienna Gambit, Wurzburger Trap.
pub static WURZBURGER_TRAP: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<29>(),
    },
    name: Cow::Borrowed(&["Vienna Game", "Vienna Gambit", "Wurzburger Trap"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
