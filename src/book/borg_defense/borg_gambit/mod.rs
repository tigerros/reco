...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Borg Defense: Borg Gambit.
pub static BORG_GAMBIT: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<40>(),
    },
    name: Cow::Borrowed(&["Borg Defense", "Borg Gambit"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
    ...
    setup: Cow::Owned(Setup {
        board: Board::from_bitboards(
            ByRole {
                pawn: Bitboard(53761995832354560),
                knight: Bitboard(4755801206503243842),
            ...
            ByColor {
                black: Bitboard(16140619864397053952),
