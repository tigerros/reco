...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Borg Defense.
pub static BORG_DEFENSE: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<0>(),
    },
    name: Cow::Borrowed(&["Borg Defense"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
    ...
    setup: Cow::Owned(Setup {
        board: Board::from_bitboards(
            ByRole {
                pawn: Bitboard(53761995698138880),
