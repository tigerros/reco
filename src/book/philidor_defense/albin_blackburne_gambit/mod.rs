...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Philidor Defense: Albin-Blackburne Gambit.
pub static ALBIN_BLACKBURNE_GAMBIT: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<41>(),
    },
    name: Cow::Borrowed(&["Philidor Defense", "Albin-Blackburne Gambit"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
