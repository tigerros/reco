...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Philidor Defense: Lion Variation, Lion's Claw, with Bc4 and h6.
pub static WITH_BC4_AND_H6: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<41>(),
    },
    name: Cow::Borrowed(&["Philidor Defense", "Lion Variation", "Lion's Claw", "with Bc4 and h6"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
