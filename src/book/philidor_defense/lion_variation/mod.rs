...
# use reco::book::philidor_defense::LION_VARIATION;
assert_eq!(LION_VARIATION.original_name(), "Philidor Defense: Lion Variation");
```"#)]
pub static LION_VARIATION: Variation = Variation {
    name: "Lion Variation",
    variations: &[&BISHOP_SACRIFICE,
&FORCING_LINE,
