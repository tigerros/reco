...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Philidor Defense: Nimzowitsch, Larobok Variation.
pub static LAROBOK_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<41>(),
    },
    name: Cow::Borrowed(&["Philidor Defense", "Nimzowitsch", "Larobok Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
