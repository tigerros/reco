...
# use reco::book::philidor_defense::PHILIDOR_COUNTERGAMBIT;
assert_eq!(PHILIDOR_COUNTERGAMBIT.original_name(), "Philidor Defense: Philidor Countergambit");
```"#)]
pub static PHILIDOR_COUNTERGAMBIT: Variation = Variation {
    name: "Philidor Countergambit",
    variations: &[&BERGER_VARIATION,
&ZUKERTORT_VARIATION,
&DEL_RIO_ATTACK],
