...
# use reco::book::philidor_defense::NIMZOWITSCH_VARIATION;
assert_eq!(NIMZOWITSCH_VARIATION.original_name(), "Philidor Defense: Nimzowitsch Variation");
```"#)]
pub static NIMZOWITSCH_VARIATION: Variation = Variation {
    name: "Nimzowitsch Variation",
    variations: &[&KLEIN_VARIATION,
&RELLSTAB_VARIATION,
&SOKOLSKY_VARIATION],
