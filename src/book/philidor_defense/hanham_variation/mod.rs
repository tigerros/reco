...
# use reco::book::philidor_defense::HANHAM_VARIATION;
assert_eq!(HANHAM_VARIATION.original_name(), "Philidor Defense: Hanham Variation");
```"#)]
pub static HANHAM_VARIATION: Variation = Variation {
    name: "Hanham Variation",
    variations: &[&STEINER_VARIATION,
&KRAUSE_VARIATION,
&DELMAR_VARIATION,
...
&SHARP_VARIATION],
    ...
    setup: Setup {
        board: Board::from_bitboards(
            ...
            ByColor {
                black: Bitboard(18297852675842113536),
