...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Rubinstein Opening: Semi-Slav Defense.
pub static SEMI_SLAV_DEFENSE: [Opening<&str>; 3] = [Opening {
    code: Code {
        volume: Volume::D,
        category: RangedU8::new_static::<5>(),
    },
    name: Cow::Borrowed(&["Rubinstein Opening", "Semi-Slav Defense"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
