...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Rubinstein Opening.
pub static RUBINSTEIN_OPENING: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::D,
        category: RangedU8::new_static::<5>(),
    },
    name: Cow::Borrowed(&["Rubinstein Opening"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
