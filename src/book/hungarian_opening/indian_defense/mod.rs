...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Hungarian Opening: Indian Defense.
pub static INDIAN_DEFENSE: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<0>(),
    },
    name: Cow::Borrowed(&["Hungarian Opening", "Indian Defense"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: G2,
