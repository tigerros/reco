...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Hungarian Opening: Slav Formation.
pub static SLAV_FORMATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<0>(),
    },
    name: Cow::Borrowed(&["Hungarian Opening", "Slav Formation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: G2,
