...
# use reco::book::queens_indian_defense::FIANCHETTO_VARIATION;
assert_eq!(FIANCHETTO_VARIATION.original_name(), "Queen's Indian Defense: Fianchetto Variation");
```"#)]
pub static FIANCHETTO_VARIATION: Variation = Variation {
    name: "Fianchetto Variation",
    variations: &[&CHECK_VARIATION,
