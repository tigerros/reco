...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Queen's Indian Defense: Fianchetto Variation, Nimzowitsch Variation.
pub static NIMZOWITSCH_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::E,
        category: RangedU8::new_static::<15>(),
    },
    name: Cow::Borrowed(&["Queen's Indian Defense", "Fianchetto Variation", "Nimzowitsch Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
