...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Queen's Indian Defense: Fianchetto Variation, Kramnik Variation.
pub static KRAMNIK_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::E,
        category: RangedU8::new_static::<17>(),
    },
    name: Cow::Borrowed(&["Queen's Indian Defense", "Fianchetto Variation", "Kramnik Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
