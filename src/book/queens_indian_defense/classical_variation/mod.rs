...
# use reco::book::queens_indian_defense::CLASSICAL_VARIATION;
assert_eq!(CLASSICAL_VARIATION.original_name(), "Queen's Indian Defense: Classical Variation");
```"#)]
pub static CLASSICAL_VARIATION: Variation = Variation {
    name: "Classical Variation",
    variations: &[&TIVIAKOV_DEFENSE,
&TAIMANOV_GAMBIT,
