...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Queen's Indian Defense: Kasparov Variation, Botvinnik Attack.
pub static BOTVINNIK_ATTACK: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::E,
        category: RangedU8::new_static::<12>(),
    },
    name: Cow::Borrowed(&["Queen's Indian Defense", "Kasparov Variation", "Botvinnik Attack"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
