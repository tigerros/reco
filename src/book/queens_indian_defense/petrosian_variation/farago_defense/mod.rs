...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Queen's Indian Defense: Petrosian Variation, Farago Defense.
pub static FARAGO_DEFENSE: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::E,
        category: RangedU8::new_static::<12>(),
    },
    name: Cow::Borrowed(&["Queen's Indian Defense", "Petrosian Variation", "Farago Defense"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
