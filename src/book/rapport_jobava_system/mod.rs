...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Rapport-Jobava System.
pub static RAPPORT_JOBAVA_SYSTEM: [Opening<&str>; 3] = [Opening {
    code: Code {
        volume: Volume::D,
        category: RangedU8::new_static::<1>(),
    },
    name: Cow::Borrowed(&["Rapport-Jobava System"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
