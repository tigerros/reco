...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// King's Indian Defense: Orthodox Variation.
pub static ORTHODOX_VARIATION: [Opening<&str>; 4] = [Opening {
    code: Code {
        volume: Volume::E,
        category: RangedU8::new_static::<91>(),
    },
    name: Cow::Borrowed(&["King's Indian Defense", "Orthodox Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
