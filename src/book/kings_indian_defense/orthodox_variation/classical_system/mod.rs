...
# use reco::book::kings_indian_defense::orthodox_variation::CLASSICAL_SYSTEM;
assert_eq!(CLASSICAL_SYSTEM.original_name(), "King's Indian Defense: Orthodox Variation, Classical System");
```"#)]
pub static CLASSICAL_SYSTEM: Variation = Variation {
