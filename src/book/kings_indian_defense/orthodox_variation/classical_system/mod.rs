...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// King's Indian Defense: Orthodox Variation, Classical System.
pub static CLASSICAL_SYSTEM: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::E,
        category: RangedU8::new_static::<98>(),
    },
    name: Cow::Borrowed(&["King's Indian Defense", "Orthodox Variation", "Classical System"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
    ...
    setup: Cow::Owned(Setup {
        board: Board::from_bitboards(
            ByRole {
                ...
                knight: Bitboard(4538783999721488),
