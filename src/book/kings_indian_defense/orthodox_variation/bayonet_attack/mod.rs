...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// King's Indian Defense: Orthodox Variation, Bayonet Attack.
pub static BAYONET_ATTACK: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::E,
        category: RangedU8::new_static::<97>(),
    },
    name: Cow::Borrowed(&["King's Indian Defense", "Orthodox Variation", "Bayonet Attack"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
