...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// King's Indian Defense: Orthodox Variation, Positional Defense.
pub static POSITIONAL_DEFENSE: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::E,
        category: RangedU8::new_static::<94>(),
    },
    name: Cow::Borrowed(&["King's Indian Defense", "Orthodox Variation", "Positional Defense"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
