...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// King's Indian Defense: Fianchetto Variation, Panno Variation, Blockade Line.
pub static BLOCKADE_LINE: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::E,
        category: RangedU8::new_static::<63>(),
    },
    name: Cow::Borrowed(&["King's Indian Defense", "Fianchetto Variation", "Panno Variation", "Blockade Line"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
