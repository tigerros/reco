...
# use reco::book::kings_indian_defense::fianchetto_variation::PANNO_VARIATION;
assert_eq!(PANNO_VARIATION.original_name(), "King's Indian Defense: Fianchetto Variation, Panno Variation");
```"#)]
pub static PANNO_VARIATION: Variation = Variation {
    name: "Panno Variation",
    variations: &[&BLOCKADE_LINE,
&KORCHNOI_LINE,
&DONNER_LINE],
