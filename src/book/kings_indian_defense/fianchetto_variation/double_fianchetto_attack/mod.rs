...
# use reco::book::kings_indian_defense::fianchetto_variation::DOUBLE_FIANCHETTO_ATTACK;
assert_eq!(DOUBLE_FIANCHETTO_ATTACK.original_name(), "King's Indian Defense: Fianchetto Variation, Double Fianchetto Attack");
```"#)]
