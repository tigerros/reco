...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// King's Indian Defense: Six Pawns Attack.
pub static SIX_PAWNS_ATTACK: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::E,
        category: RangedU8::new_static::<77>(),
    },
    name: Cow::Borrowed(&["King's Indian Defense", "Six Pawns Attack"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
