...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// King's Indian Defense: Averbakh Variation, Nc6 Defense.
pub static NC6_DEFENSE: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::E,
        category: RangedU8::new_static::<73>(),
    },
    name: Cow::Borrowed(&["King's Indian Defense", "Averbakh Variation", "Nc6 Defense"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
