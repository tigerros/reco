...
# use reco::book::kings_indian_defense::petrosian_variation::KERES_DEFENSE;
assert_eq!(KERES_DEFENSE.original_name(), "King's Indian Defense: Petrosian Variation, Keres Defense");
```"#)]
