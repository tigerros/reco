...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// King's Indian Defense: Kramer Variation.
pub static KRAMER_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::E,
        category: RangedU8::new_static::<70>(),
    },
    name: Cow::Borrowed(&["King's Indian Defense", "Kramer Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
