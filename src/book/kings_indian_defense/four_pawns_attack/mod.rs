...
# use reco::book::kings_indian_defense::FOUR_PAWNS_ATTACK;
assert_eq!(FOUR_PAWNS_ATTACK.original_name(), "King's Indian Defense: Four Pawns Attack");
```"#)]
pub static FOUR_PAWNS_ATTACK: Variation = Variation {
    name: "Four Pawns Attack",
    variations: &[&DYNAMIC_ATTACK,
&FLUID_ATTACK,
&FLORENTINE_GAMBIT,
&EXCHANGE_VARIATION,
&MODERN_DEFENSE,
