...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// King's Indian Defense: Sämisch Variation.
pub static SAMISCH_VARIATION: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::E,
        category: RangedU8::new_static::<80>(),
    },
    name: Cow::Borrowed(&["King's Indian Defense", "Sämisch Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
