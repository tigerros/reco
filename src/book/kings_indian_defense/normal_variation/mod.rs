...
# use reco::book::kings_indian_defense::NORMAL_VARIATION;
assert_eq!(NORMAL_VARIATION.original_name(), "King's Indian Defense: Normal Variation");
```"#)]
pub static NORMAL_VARIATION: Variation = Variation {
    name: "Normal Variation",
    variations: &[&DEFERRED_FIANCHETTO,
