...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// King's Indian Defense: Normal Variation, Rare Defenses.
pub static RARE_DEFENSES: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::E,
        category: RangedU8::new_static::<90>(),
    },
    name: Cow::Borrowed(&["King's Indian Defense", "Normal Variation", "Rare Defenses"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
