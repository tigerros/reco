...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Mexican Defense.
pub static MEXICAN_DEFENSE: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<50>(),
    },
    name: Cow::Borrowed(&["Mexican Defense"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
