...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Benko Gambit.
pub static BENKO_GAMBIT: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<57>(),
    },
    name: Cow::Borrowed(&["Benko Gambit"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
