...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Carr Defense.
pub static CARR_DEFENSE: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<0>(),
    },
    name: Cow::Borrowed(&["Carr Defense"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
    ...
    setup: Cow::Owned(Setup {
        board: Board::from_bitboards(
            ByRole {
                pawn: Bitboard(35888059799105280),
