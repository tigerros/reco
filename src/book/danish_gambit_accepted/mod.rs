...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Danish Gambit Accepted.
pub static DANISH_GAMBIT_ACCEPTED: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<21>(),
    },
    name: Cow::Borrowed(&["Danish Gambit Accepted"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
