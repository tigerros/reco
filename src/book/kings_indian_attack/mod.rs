...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// King's Indian Attack.
pub static KINGS_INDIAN_ATTACK: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<5>(),
    },
    name: Cow::Borrowed(&["King's Indian Attack"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Knight,
        from: G1,
