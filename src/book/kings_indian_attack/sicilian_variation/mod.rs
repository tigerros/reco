...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// King's Indian Attack: Sicilian Variation.
pub static SICILIAN_VARIATION: [Opening<&str>; 4] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<7>(),
    },
    name: Cow::Borrowed(&["King's Indian Attack", "Sicilian Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Knight,
        from: G1,
