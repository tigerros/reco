...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// King's Indian Attack: Pachman System.
pub static PACHMAN_SYSTEM: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<7>(),
    },
    name: Cow::Borrowed(&["King's Indian Attack", "Pachman System"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Knight,
        from: G1,
