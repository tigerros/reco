...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Ware Opening.
pub static WARE_OPENING: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<0>(),
    },
    name: Cow::Borrowed(&["Ware Opening"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: A2,
