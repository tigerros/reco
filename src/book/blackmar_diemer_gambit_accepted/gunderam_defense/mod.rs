...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Blackmar-Diemer Gambit Accepted: Gunderam Defense.
pub static GUNDERAM_DEFENSE: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::D,
        category: RangedU8::new_static::<0>(),
    },
    name: Cow::Borrowed(&["Blackmar-Diemer Gambit Accepted", "Gunderam Defense"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
