...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Old Indian Defense.
pub static OLD_INDIAN_DEFENSE: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<41>(),
    },
    name: Cow::Borrowed(&["Old Indian Defense"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
