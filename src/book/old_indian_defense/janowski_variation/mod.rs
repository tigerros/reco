...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Old Indian Defense: Janowski Variation.
pub static JANOWSKI_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<53>(),
    },
    name: Cow::Borrowed(&["Old Indian Defense", "Janowski Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
