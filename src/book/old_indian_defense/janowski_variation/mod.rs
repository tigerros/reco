...
# use reco::book::old_indian_defense::JANOWSKI_VARIATION;
assert_eq!(JANOWSKI_VARIATION.original_name(), "Old Indian Defense: Janowski Variation");
```"#)]
pub static JANOWSKI_VARIATION: Variation = Variation {
    name: "Janowski Variation",
    variations: &[&GRINBERG_GAMBIT,
