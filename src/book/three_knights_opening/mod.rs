...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Three Knights Opening.
pub static THREE_KNIGHTS_OPENING: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<46>(),
    },
    name: Cow::Borrowed(&["Three Knights Opening"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
