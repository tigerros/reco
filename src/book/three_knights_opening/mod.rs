...
# use reco::book::THREE_KNIGHTS_OPENING;
assert_eq!(THREE_KNIGHTS_OPENING.original_name(), "Three Knights Opening");
```"#)]
pub static THREE_KNIGHTS_OPENING: Variation = Variation {
    name: "Three Knights Opening",
    variations: &[&STEINITZ_DEFENSE,
