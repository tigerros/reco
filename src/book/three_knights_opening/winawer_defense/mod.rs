...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Three Knights Opening: Winawer Defense.
pub static WINAWER_DEFENSE: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<46>(),
    },
    name: Cow::Borrowed(&["Three Knights Opening", "Winawer Defense"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
