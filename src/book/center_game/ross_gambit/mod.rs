...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Center Game: Ross Gambit.
pub static ROSS_GAMBIT: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<21>(),
    },
    name: Cow::Borrowed(&["Center Game", "Ross Gambit"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
