...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Center Game: Kieseritzky Variation.
pub static KIESERITZKY_VARIATION: [Opening<&str>; 3] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<21>(),
    },
    name: Cow::Borrowed(&["Center Game", "Kieseritzky Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
