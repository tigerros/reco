...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Center Game: Hall Variation.
pub static HALL_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<22>(),
    },
    name: Cow::Borrowed(&["Center Game", "Hall Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
