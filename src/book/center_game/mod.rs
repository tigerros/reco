...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Center Game.
pub static CENTER_GAME: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<20>(),
    },
    name: Cow::Borrowed(&["Center Game"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
