...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Center Game: Halasz-McDonnell Gambit.
pub static HALASZ_MC_DONNELL_GAMBIT: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<21>(),
    },
    name: Cow::Borrowed(&["Center Game", "Halasz-McDonnell Gambit"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
