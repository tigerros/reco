...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Kádas Opening: Beginner's Trap.
pub static BEGINNERS_TRAP: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<0>(),
    },
    name: Cow::Borrowed(&["Kádas Opening", "Beginner's Trap"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: H2,
