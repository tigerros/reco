...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Kádas Opening: Kádas Gambit.
pub static KADAS_GAMBIT: [Opening<&str>; 3] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<0>(),
    },
    name: Cow::Borrowed(&["Kádas Opening", "Kádas Gambit"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: H2,
    ...
    setup: Cow::Owned(Setup {
        board: Board::from_bitboards(
            ByRole {
                pawn: Bitboard(70650238515313920),
    ...
    setup: Cow::Owned(Setup {
        board: Board::from_bitboards(
            ByRole {
                pawn: Bitboard(68398455982420736),
    ...
    setup: Cow::Owned(Setup {
        board: Board::from_bitboards(
            ByRole {
                pawn: Bitboard(67272521715839744),
                knight: Bitboard(4755801206503243842),
                bishop: Bitboard(2594073385365405732),
                rook: Bitboard(9295429630892703873),
                queen: Bitboard(576460752303423496),
