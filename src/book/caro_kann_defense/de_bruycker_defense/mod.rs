...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Caro-Kann Defense: De Bruycker Defense.
pub static DE_BRUYCKER_DEFENSE: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<12>(),
    },
    name: Cow::Borrowed(&["Caro-Kann Defense", "De Bruycker Defense"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
