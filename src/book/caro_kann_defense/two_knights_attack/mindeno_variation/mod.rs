...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Caro-Kann Defense: Two Knights Attack, Mindeno Variation.
pub static MINDENO_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<11>(),
    },
    name: Cow::Borrowed(&["Caro-Kann Defense", "Two Knights Attack", "Mindeno Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
