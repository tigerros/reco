...
# use reco::book::caro_kann_defense::two_knights_attack::MINDENO_VARIATION;
assert_eq!(MINDENO_VARIATION.original_name(), "Caro-Kann Defense: Two Knights Attack, Mindeno Variation");
```"#)]
