...
# use reco::book::caro_kann_defense::EXCHANGE_VARIATION;
assert_eq!(EXCHANGE_VARIATION.original_name(), "Caro-Kann Defense: Exchange Variation");
```"#)]
pub static EXCHANGE_VARIATION: Variation = Variation {
    name: "Exchange Variation",
    variations: &[&BULLA_ATTACK,
