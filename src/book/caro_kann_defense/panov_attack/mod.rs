...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Caro-Kann Defense: Panov Attack.
pub static PANOV_ATTACK: [Opening<&str>; 3] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<13>(),
    },
    name: Cow::Borrowed(&["Caro-Kann Defense", "Panov Attack"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
