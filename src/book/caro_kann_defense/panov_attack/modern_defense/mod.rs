...
# use reco::book::caro_kann_defense::panov_attack::MODERN_DEFENSE;
assert_eq!(MODERN_DEFENSE.original_name(), "Caro-Kann Defense: Panov Attack, Modern Defense");
```"#)]
pub static MODERN_DEFENSE: Variation = Variation {
    name: "Modern Defense",
    variations: &[&REIFIR_SPIELMANN_LINE,
&MIESES_LINE,
&CZERNIAK_LINE,
&CARLSBAD_LINE],
