...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Caro-Kann Defense: Panov Attack, Modern Defense.
pub static MODERN_DEFENSE: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<13>(),
    },
    name: Cow::Borrowed(&["Caro-Kann Defense", "Panov Attack", "Modern Defense"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
