...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Caro-Kann Defense: Karpov Variation, Modern Main Line.
pub static MODERN_MAIN_LINE: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<17>(),
    },
    name: Cow::Borrowed(&["Caro-Kann Defense", "Karpov Variation", "Modern Main Line"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
