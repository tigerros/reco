...
# use reco::book::caro_kann_defense::karpov_variation::MODERN_VARIATION;
assert_eq!(MODERN_VARIATION.original_name(), "Caro-Kann Defense: Karpov Variation, Modern Variation");
```"#)]
pub static MODERN_VARIATION: Variation = Variation {
    name: "Modern Variation",
    variations: &[&IVANCHUK_DEFENSE,
&KASPAROV_ATTACK],
