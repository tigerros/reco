...
# use reco::book::caro_kann_defense::KARPOV_VARIATION;
assert_eq!(KARPOV_VARIATION.original_name(), "Caro-Kann Defense: Karpov Variation");
```"#)]
pub static KARPOV_VARIATION: Variation = Variation {
    name: "Karpov Variation",
    variations: &[&TIVIAKOV_FISCHER_ATTACK,
&MODERN_MAIN_LINE,
&MODERN_VARIATION,
&SMYSLOV_VARIATION],
