...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Caro-Kann Defense: Modern Variation.
pub static MODERN_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<12>(),
    },
    name: Cow::Borrowed(&["Caro-Kann Defense", "Modern Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
