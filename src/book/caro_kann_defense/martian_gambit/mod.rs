...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Caro-Kann Defense: Martian Gambit.
pub static MARTIAN_GAMBIT: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<18>(),
    },
    name: Cow::Borrowed(&["Caro-Kann Defense", "Martian Gambit"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
