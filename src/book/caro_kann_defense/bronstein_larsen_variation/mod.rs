...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Caro-Kann Defense: Bronstein-Larsen Variation.
pub static BRONSTEIN_LARSEN_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<16>(),
    },
    name: Cow::Borrowed(&["Caro-Kann Defense", "Bronstein-Larsen Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
