...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Caro-Kann Defense: Classical Variation, Flohr Variation.
pub static FLOHR_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<18>(),
    },
    name: Cow::Borrowed(&["Caro-Kann Defense", "Classical Variation", "Flohr Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
