...
# use reco::book::caro_kann_defense::classical_variation::SPASSKY_VARIATION;
assert_eq!(SPASSKY_VARIATION.original_name(), "Caro-Kann Defense: Classical Variation, Spassky Variation");
```"#)]
