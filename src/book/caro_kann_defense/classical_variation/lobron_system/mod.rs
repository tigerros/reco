...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Caro-Kann Defense: Classical Variation, Lobron System.
pub static LOBRON_SYSTEM: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<19>(),
    },
    name: Cow::Borrowed(&["Caro-Kann Defense", "Classical Variation", "Lobron System"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
