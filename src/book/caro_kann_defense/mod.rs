...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Caro-Kann Defense.
pub static CARO_KANN_DEFENSE: [Opening<&str>; 7] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<10>(),
    },
    name: Cow::Borrowed(&["Caro-Kann Defense"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
