...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Zukertort Opening: Black Mustang Defense.
pub static BLACK_MUSTANG_DEFENSE: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<4>(),
    },
    name: Cow::Borrowed(&["Zukertort Opening", "Black Mustang Defense"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Knight,
        from: G1,
