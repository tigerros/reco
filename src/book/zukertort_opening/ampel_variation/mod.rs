...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Zukertort Opening: Ampel Variation.
pub static AMPEL_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<6>(),
    },
    name: Cow::Borrowed(&["Zukertort Opening", "Ampel Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Knight,
        from: G1,
