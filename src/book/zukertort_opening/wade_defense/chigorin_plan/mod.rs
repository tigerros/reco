...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Zukertort Opening: Wade Defense, Chigorin Plan.
pub static CHIGORIN_PLAN: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<41>(),
    },
    name: Cow::Borrowed(&["Zukertort Opening", "Wade Defense", "Chigorin Plan"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
