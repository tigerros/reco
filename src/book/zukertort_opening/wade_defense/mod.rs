...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Zukertort Opening: Wade Defense.
pub static WADE_DEFENSE: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<4>(),
    },
    name: Cow::Borrowed(&["Zukertort Opening", "Wade Defense"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Knight,
        from: G1,
    ...
    setup: Cow::Owned(Setup {
        board: Board::from_bitboards(
            ...
            ByColor {
                black: Bitboard(18155989219934208000),
