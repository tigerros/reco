...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Zukertort Opening: Reversed Mexican Defense.
pub static REVERSED_MEXICAN_DEFENSE: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<6>(),
    },
    name: Cow::Borrowed(&["Zukertort Opening", "Reversed Mexican Defense"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Knight,
        from: G1,
