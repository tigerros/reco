...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Zukertort Opening: Double Fianchetto Attack.
pub static DOUBLE_FIANCHETTO_ATTACK: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<5>(),
    },
    name: Cow::Borrowed(&["Zukertort Opening", "Double Fianchetto Attack"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Knight,
        from: G1,
