...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Zukertort Opening: Reversed Grünfeld.
pub static REVERSED_GRUNFELD: [Opening<&str>; 4] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<8>(),
    },
    name: Cow::Borrowed(&["Zukertort Opening", "Reversed Grünfeld"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Knight,
        from: G1,
