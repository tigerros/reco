...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Mikenas Defense.
pub static MIKENAS_DEFENSE: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<40>(),
    },
    name: Cow::Borrowed(&["Mikenas Defense"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
