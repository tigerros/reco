...
# use reco::book::MIKENAS_DEFENSE;
assert_eq!(MIKENAS_DEFENSE.original_name(), "Mikenas Defense");
```"#)]
pub static MIKENAS_DEFENSE: Variation = Variation {
    name: "Mikenas Defense",
    variations: &[&LITHUANIAN_VARIATION,
