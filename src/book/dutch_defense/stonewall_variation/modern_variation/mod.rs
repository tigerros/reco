...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Dutch Defense: Stonewall Variation, Modern Variation.
pub static MODERN_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<90>(),
    },
    name: Cow::Borrowed(&["Dutch Defense", "Stonewall Variation", "Modern Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
    ...
    setup: Cow::Owned(Setup {
        board: Board::from_bitboards(
            ...
            ByColor {
                black: Bitboard(11512111214985478144),
