...
# use reco::book::dutch_defense::stonewall_variation::MODERN_VARIATION;
assert_eq!(MODERN_VARIATION.original_name(), "Dutch Defense: Stonewall Variation, Modern Variation");
```"#)]
