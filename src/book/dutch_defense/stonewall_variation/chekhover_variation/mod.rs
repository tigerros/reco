...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Dutch Defense: Stonewall Variation, Chekhover Variation.
pub static CHEKHOVER_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<95>(),
    },
    name: Cow::Borrowed(&["Dutch Defense", "Stonewall Variation", "Chekhover Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
