...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Dutch Defense: Stonewall Variation.
pub static STONEWALL_VARIATION: [Opening<&str>; 4] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<92>(),
    },
    name: Cow::Borrowed(&["Dutch Defense", "Stonewall Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
