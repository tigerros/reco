...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Dutch Defense: Classical Variation, Ilyin-Zhenevsky Variation.
pub static ILYIN_ZHENEVSKY_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<97>(),
    },
    name: Cow::Borrowed(&["Dutch Defense", "Classical Variation", "Ilyin-Zhenevsky Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
