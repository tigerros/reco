...
# use reco::book::dutch_defense::CLASSICAL_VARIATION;
assert_eq!(CLASSICAL_VARIATION.original_name(), "Dutch Defense: Classical Variation");
```"#)]
pub static CLASSICAL_VARIATION: Variation = Variation {
    name: "Classical Variation",
    variations: &[&BUENOS_AIRES_VARIATION,
&HUISL_VARIATION,
&BLACKBURNE_ATTACK,
