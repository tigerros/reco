...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Dutch Defense: Classical Variation.
pub static CLASSICAL_VARIATION: [Opening<&str>; 6] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<84>(),
    },
    name: Cow::Borrowed(&["Dutch Defense", "Classical Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
    ...
    setup: Cow::Owned(Setup {
        board: Board::from_bitboards(
            ByRole {
                pawn: Bitboard(58283050005492480),
    ...
    setup: Cow::Owned(Setup {
        board: Board::from_bitboards(
            ...
            ByColor {
                black: Bitboard(8061214772013563904),
                white: Bitboard(207680415)
            }
        ),
        promoted: Bitboard(0),
    ...
    setup: Cow::Owned(Setup {
        board: Board::from_bitboards(
            ...
            ByColor {
                black: Bitboard(8058971768292900864),
