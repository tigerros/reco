...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Dutch Defense: Fianchetto Attack.
pub static FIANCHETTO_ATTACK: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<81>(),
    },
    name: Cow::Borrowed(&["Dutch Defense", "Fianchetto Attack"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
