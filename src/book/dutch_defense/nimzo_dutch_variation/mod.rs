...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Dutch Defense: Nimzo-Dutch Variation.
pub static NIMZO_DUTCH_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<90>(),
    },
    name: Cow::Borrowed(&["Dutch Defense", "Nimzo-Dutch Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
