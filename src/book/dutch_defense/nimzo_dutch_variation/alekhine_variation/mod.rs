...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Dutch Defense: Nimzo-Dutch Variation, Alekhine Variation.
pub static ALEKHINE_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<90>(),
    },
    name: Cow::Borrowed(&["Dutch Defense", "Nimzo-Dutch Variation", "Alekhine Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
