...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Dutch Defense: Leningrad, Basman System.
pub static BASMAN_SYSTEM: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<81>(),
    },
    name: Cow::Borrowed(&["Dutch Defense", "Leningrad", "Basman System"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
