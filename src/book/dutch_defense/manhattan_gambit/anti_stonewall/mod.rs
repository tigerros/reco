...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Dutch Defense: Manhattan Gambit, Anti-Stonewall.
pub static ANTI_STONEWALL: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<80>(),
    },
    name: Cow::Borrowed(&["Dutch Defense", "Manhattan Gambit", "Anti-Stonewall"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
