...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Dutch Defense: Manhattan Gambit, Anti-Modern.
pub static ANTI_MODERN: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<80>(),
    },
    name: Cow::Borrowed(&["Dutch Defense", "Manhattan Gambit", "Anti-Modern"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
