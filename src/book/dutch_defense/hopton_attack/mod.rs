...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Dutch Defense: Hopton Attack.
pub static HOPTON_ATTACK: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<80>(),
    },
    name: Cow::Borrowed(&["Dutch Defense", "Hopton Attack"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
