...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Nimzo-Larsen Attack: Spike Variation.
pub static SPIKE_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<1>(),
    },
    name: Cow::Borrowed(&["Nimzo-Larsen Attack", "Spike Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: B2,
