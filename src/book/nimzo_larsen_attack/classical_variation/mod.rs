...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Nimzo-Larsen Attack: Classical Variation.
pub static CLASSICAL_VARIATION: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<1>(),
    },
    name: Cow::Borrowed(&["Nimzo-Larsen Attack", "Classical Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: B2,
