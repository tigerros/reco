...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Nimzo-Larsen Attack: Norfolk Gambit.
pub static NORFOLK_GAMBIT: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<6>(),
    },
    name: Cow::Borrowed(&["Nimzo-Larsen Attack", "Norfolk Gambit"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Knight,
        from: G1,
