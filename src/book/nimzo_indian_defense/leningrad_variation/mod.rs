...
# use reco::book::nimzo_indian_defense::LENINGRAD_VARIATION;
assert_eq!(LENINGRAD_VARIATION.original_name(), "Nimzo-Indian Defense: Leningrad Variation");
```"#)]
pub static LENINGRAD_VARIATION: Variation = Variation {
    name: "Leningrad Variation",
    variations: &[&AVERBAKH_GAMBIT,
&BENONI_DEFENSE],
