...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Nimzo-Indian Defense: Mikenas Attack.
pub static MIKENAS_ATTACK: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::E,
        category: RangedU8::new_static::<20>(),
    },
    name: Cow::Borrowed(&["Nimzo-Indian Defense", "Mikenas Attack"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
