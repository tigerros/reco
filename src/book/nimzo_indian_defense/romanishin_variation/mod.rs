...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Nimzo-Indian Defense: Romanishin Variation.
pub static ROMANISHIN_VARIATION: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::E,
        category: RangedU8::new_static::<20>(),
    },
    name: Cow::Borrowed(&["Nimzo-Indian Defense", "Romanishin Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
