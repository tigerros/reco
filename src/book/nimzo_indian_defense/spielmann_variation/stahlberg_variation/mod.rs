...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Nimzo-Indian Defense: Spielmann Variation, Stahlberg Variation.
pub static STAHLBERG_VARIATION: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::E,
        category: RangedU8::new_static::<23>(),
    },
    name: Cow::Borrowed(&["Nimzo-Indian Defense", "Spielmann Variation", "Stahlberg Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
