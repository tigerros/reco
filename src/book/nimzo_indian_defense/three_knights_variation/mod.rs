...
# use reco::book::nimzo_indian_defense::THREE_KNIGHTS_VARIATION;
assert_eq!(THREE_KNIGHTS_VARIATION.original_name(), "Nimzo-Indian Defense: Three Knights Variation");
```"#)]
