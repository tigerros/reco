...
# use reco::book::nimzo_indian_defense::samisch_variation::KERES_VARIATION;
assert_eq!(KERES_VARIATION.original_name(), "Nimzo-Indian Defense: Sämisch Variation, Keres Variation");
```"#)]
