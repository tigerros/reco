...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Nimzo-Indian Defense: Sämisch Variation.
pub static SAMISCH_VARIATION: [Opening<&str>; 6] = [Opening {
    code: Code {
        volume: Volume::E,
        category: RangedU8::new_static::<24>(),
    },
    name: Cow::Borrowed(&["Nimzo-Indian Defense", "Sämisch Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
