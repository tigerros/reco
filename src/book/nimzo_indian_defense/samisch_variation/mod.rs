...
# use reco::book::nimzo_indian_defense::SAMISCH_VARIATION;
assert_eq!(SAMISCH_VARIATION.original_name(), "Nimzo-Indian Defense: Sämisch Variation");
```"#)]
pub static SAMISCH_VARIATION: Variation = Variation {
    name: "Sämisch Variation",
    variations: &[&BOTVINNIK_VARIATION,
&KERES_VARIATION,
