...
# use reco::book::nimzo_indian_defense::classical_variation::BERLIN_VARIATION;
assert_eq!(BERLIN_VARIATION.original_name(), "Nimzo-Indian Defense: Classical Variation, Berlin Variation");
```"#)]
pub static BERLIN_VARIATION: Variation = Variation {
    name: "Berlin Variation",
    variations: &[&MACIEJA_SYSTEM,
&PIRC_VARIATION,
&STEINER_VARIATION],
