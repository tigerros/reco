...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Nimzo-Indian Defense: Classical Variation, Belyavsky Gambit.
pub static BELYAVSKY_GAMBIT: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::E,
        category: RangedU8::new_static::<34>(),
    },
    name: Cow::Borrowed(&["Nimzo-Indian Defense", "Classical Variation", "Belyavsky Gambit"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
