...
# use reco::book::nimzo_indian_defense::classical_variation::MODERN_VARIATION;
assert_eq!(MODERN_VARIATION.original_name(), "Nimzo-Indian Defense: Classical Variation, Modern Variation");
```"#)]
pub static MODERN_VARIATION: Variation = Variation {
    ...
    setup: Setup {
        board: Board::from_bitboards(
            ...
            ByColor {
                black: Bitboard(11521069915737948160),
