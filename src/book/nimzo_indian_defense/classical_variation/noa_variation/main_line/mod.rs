...
# use reco::book::nimzo_indian_defense::classical_variation::noa_variation::MAIN_LINE;
assert_eq!(MAIN_LINE.original_name(), "Nimzo-Indian Defense: Classical Variation, Noa Variation, Main Line");
```"#)]
