...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Nimzo-Indian Defense: Classical Variation, Noa Variation.
pub static NOA_VARIATION: [Opening<&str>; 4] = [Opening {
    code: Code {
        volume: Volume::E,
        category: RangedU8::new_static::<34>(),
    },
    name: Cow::Borrowed(&["Nimzo-Indian Defense", "Classical Variation", "Noa Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
