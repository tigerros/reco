...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Nimzo-Indian Defense: St. Petersburg Variation.
pub static ST_PETERSBURG_VARIATION: [Opening<&str>; 12] = [Opening {
    code: Code {
        volume: Volume::E,
        category: RangedU8::new_static::<43>(),
    },
    name: Cow::Borrowed(&["Nimzo-Indian Defense", "St. Petersburg Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
