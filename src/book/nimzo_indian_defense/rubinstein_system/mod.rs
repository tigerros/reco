...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Nimzo-Indian Defense: Rubinstein System.
pub static RUBINSTEIN_SYSTEM: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::E,
        category: RangedU8::new_static::<40>(),
    },
    name: Cow::Borrowed(&["Nimzo-Indian Defense", "Rubinstein System"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
