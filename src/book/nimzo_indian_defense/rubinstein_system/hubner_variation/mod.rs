...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Nimzo-Indian Defense: Rubinstein System, Hübner Variation.
pub static HUBNER_VARIATION: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::E,
        category: RangedU8::new_static::<41>(),
    },
    name: Cow::Borrowed(&["Nimzo-Indian Defense", "Rubinstein System", "Hübner Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
