...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Nimzo-Indian Defense: Normal Variation, Gligoric System.
pub static GLIGORIC_SYSTEM: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::E,
        category: RangedU8::new_static::<53>(),
    },
    name: Cow::Borrowed(&["Nimzo-Indian Defense", "Normal Variation", "Gligoric System"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
