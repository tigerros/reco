...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Nimzo-Indian Defense: Normal Variation, Gligoric System, Bronstein Variation.
pub static BRONSTEIN_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::E,
        category: RangedU8::new_static::<55>(),
    },
    name: Cow::Borrowed(&["Nimzo-Indian Defense", "Normal Variation", "Gligoric System", "Bronstein Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
