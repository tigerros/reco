...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Nimzo-Indian Defense: Normal Variation, Botvinnik System.
pub static BOTVINNIK_SYSTEM: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::E,
        category: RangedU8::new_static::<49>(),
    },
    name: Cow::Borrowed(&["Nimzo-Indian Defense", "Normal Variation", "Botvinnik System"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
