...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Nimzo-Indian Defense: Normal Variation, Schlechter Defense.
pub static SCHLECHTER_DEFENSE: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::E,
        category: RangedU8::new_static::<52>(),
    },
    name: Cow::Borrowed(&["Nimzo-Indian Defense", "Normal Variation", "Schlechter Defense"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: D2,
