...
# use reco::book::nimzo_indian_defense::NORMAL_VARIATION;
assert_eq!(NORMAL_VARIATION.original_name(), "Nimzo-Indian Defense: Normal Variation");
```"#)]
pub static NORMAL_VARIATION: Variation = Variation {
    name: "Normal Variation",
    variations: &[&GLIGORIC_SYSTEM,
&BERNSTEIN_DEFENSE,
&SAMISCH_DEFERRED,
&RAGOZIN_VARIATION,
&SCHLECHTER_DEFENSE,
