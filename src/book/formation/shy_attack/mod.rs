...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Formation: Shy Attack.
pub static SHY_ATTACK: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<0>(),
    },
    name: Cow::Borrowed(&["Formation", "Shy Attack"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: A2,
