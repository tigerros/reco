...
# use reco::book::kings_gambit_accepted::FISCHER_DEFENSE;
assert_eq!(FISCHER_DEFENSE.original_name(), "King's Gambit Accepted: Fischer Defense");
```"#)]
pub static FISCHER_DEFENSE: Variation = Variation {
    name: "Fischer Defense",
    variations: &[&SCHULDER_GAMBIT,
&SPANISH_VARIATION],
