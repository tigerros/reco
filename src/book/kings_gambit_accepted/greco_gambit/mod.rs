...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// King's Gambit Accepted: Greco Gambit.
pub static GRECO_GAMBIT: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<34>(),
    },
    name: Cow::Borrowed(&["King's Gambit Accepted", "Greco Gambit"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
