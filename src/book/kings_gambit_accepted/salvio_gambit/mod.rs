...
# use reco::book::kings_gambit_accepted::SALVIO_GAMBIT;
assert_eq!(SALVIO_GAMBIT.original_name(), "King's Gambit Accepted: Salvio Gambit");
```"#)]
pub static SALVIO_GAMBIT: Variation = Variation {
    name: "Salvio Gambit",
    variations: &[&SILBERSCHMIDT_DEFENSE,
