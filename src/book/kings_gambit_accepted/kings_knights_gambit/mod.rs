...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// King's Gambit Accepted: King's Knight's Gambit.
pub static KINGS_KNIGHTS_GAMBIT: [Opening<&str>; 4] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<34>(),
    },
    name: Cow::Borrowed(&["King's Gambit Accepted", "King's Knight's Gambit"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
