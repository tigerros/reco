...
# use reco::book::kings_gambit_accepted::ROSENTRETER_GAMBIT;
assert_eq!(ROSENTRETER_GAMBIT.original_name(), "King's Gambit Accepted: Rosentreter Gambit");
```"#)]
pub static ROSENTRETER_GAMBIT: Variation = Variation {
    name: "Rosentreter Gambit",
    variations: &[&TESTA_VARIATION,
&BIRD_GAMBIT,
&SORENSEN_GAMBIT],
