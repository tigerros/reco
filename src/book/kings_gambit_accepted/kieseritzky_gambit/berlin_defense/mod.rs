...
# use reco::book::kings_gambit_accepted::kieseritzky_gambit::BERLIN_DEFENSE;
assert_eq!(BERLIN_DEFENSE.original_name(), "King's Gambit Accepted: Kieseritzky Gambit, Berlin Defense");
```"#)]
pub static BERLIN_DEFENSE: Variation = Variation {
    name: "Berlin Defense",
    variations: &[&RUBINSTEIN_VARIATION,
&DE_RIVIERE_VARIATION],
