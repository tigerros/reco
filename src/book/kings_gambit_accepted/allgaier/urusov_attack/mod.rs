...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// King's Gambit Accepted: Allgaier, Urusov Attack.
pub static URUSOV_ATTACK: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<39>(),
    },
    name: Cow::Borrowed(&["King's Gambit Accepted", "Allgaier", "Urusov Attack"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
