...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// King's Gambit Accepted: MacLeod Defense.
pub static MAC_LEOD_DEFENSE: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<34>(),
    },
    name: Cow::Borrowed(&["King's Gambit Accepted", "MacLeod Defense"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
