...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// King's Gambit Accepted: Double Muzio Gambit, Baldwin Gambit.
pub static BALDWIN_GAMBIT: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::C,
        category: RangedU8::new_static::<37>(),
    },
    name: Cow::Borrowed(&["King's Gambit Accepted", "Double Muzio Gambit", "Baldwin Gambit"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
