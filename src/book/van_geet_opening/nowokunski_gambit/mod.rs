...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Van Geet Opening: Nowokunski Gambit.
pub static NOWOKUNSKI_GAMBIT: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<0>(),
    },
    name: Cow::Borrowed(&["Van Geet Opening", "Nowokunski Gambit"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Knight,
        from: B1,
