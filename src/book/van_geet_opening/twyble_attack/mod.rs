...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Van Geet Opening: Twyble Attack.
pub static TWYBLE_ATTACK: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<0>(),
    },
    name: Cow::Borrowed(&["Van Geet Opening", "Twyble Attack"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Knight,
        from: B1,
