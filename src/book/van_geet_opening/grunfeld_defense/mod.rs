...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Van Geet Opening: Grünfeld Defense.
pub static GRUNFELD_DEFENSE: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<1>(),
    },
    name: Cow::Borrowed(&["Van Geet Opening", "Grünfeld Defense"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
    ...
    setup: Cow::Owned(Setup {
        board: Board::from_bitboards(
            ByRole {
                pawn: Bitboard(65020788339699456),
