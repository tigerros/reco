...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Polish Opening: Myers Variation.
pub static MYERS_VARIATION: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<0>(),
    },
    name: Cow::Borrowed(&["Polish Opening", "Myers Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: B2,
