...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Polish Opening: German Defense.
pub static GERMAN_DEFENSE: [Opening<&str>; 1] = [Opening {
    code: Code {
        volume: Volume::A,
        category: RangedU8::new_static::<0>(),
    },
    name: Cow::Borrowed(&["Polish Opening", "German Defense"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: B2,
