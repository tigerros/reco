...
# use reco::book::nimzowitsch_defense::scandinavian_variation::BOGOLJUBOW_VARIATION;
assert_eq!(BOGOLJUBOW_VARIATION.original_name(), "Nimzowitsch Defense: Scandinavian Variation, Bogoljubow Variation");
```"#)]
pub static BOGOLJUBOW_VARIATION: Variation = Variation {
    name: "Bogoljubow Variation",
    variations: &[&VEHRE_VARIATION,
&NIMZOWITSCH_GAMBIT,
&ERBEN_GAMBIT,
&BRANDICS_GAMBIT,
