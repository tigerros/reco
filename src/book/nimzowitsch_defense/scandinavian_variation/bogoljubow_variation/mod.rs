...
#[allow(clippy::doc_markdown, reason = "clippy confuses opening names for items")]/// Nimzowitsch Defense: Scandinavian Variation, Bogoljubow Variation.
pub static BOGOLJUBOW_VARIATION: [Opening<&str>; 2] = [Opening {
    code: Code {
        volume: Volume::B,
        category: RangedU8::new_static::<0>(),
    },
    name: Cow::Borrowed(&["Nimzowitsch Defense", "Scandinavian Variation", "Bogoljubow Variation"]),
    moves: Cow::Borrowed(&[
    Normal {
        role: Pawn,
        from: E2,
