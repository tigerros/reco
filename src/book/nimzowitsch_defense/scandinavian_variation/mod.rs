...
# use reco::book::nimzowitsch_defense::SCANDINAVIAN_VARIATION;
assert_eq!(SCANDINAVIAN_VARIATION.original_name(), "Nimzowitsch Defense: Scandinavian Variation");
```"#)]
pub static SCANDINAVIAN_VARIATION: Variation = Variation {
    name: "Scandinavian Variation",
    variations: &[&BOGOLJUBOW_VARIATION,
&AACHEN_GAMBIT,
&ADVANCE_VARIATION,
&EXCHANGE_VARIATION],
