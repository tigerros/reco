...
# use reco::book::nimzowitsch_defense::KENNEDY_VARIATION;
assert_eq!(KENNEDY_VARIATION.original_name(), "Nimzowitsch Defense: Kennedy Variation");
```"#)]
pub static KENNEDY_VARIATION: Variation = Variation {
    name: "Kennedy Variation",
    variations: &[&LINKSSPRINGER_VARIATION,
&PAULSEN_ATTACK,
&HAMMER_GAMBIT,
&KERES_ATTACK,
&RIEMANN_DEFENSE,
