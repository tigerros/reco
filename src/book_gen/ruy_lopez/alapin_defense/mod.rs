...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::ruy_lopez::ALAPIN_DEFENSE;
assert_eq!(ALAPIN_DEFENSE.original_name(), "Ruy Lopez: Alapin Defense");
```"#
)]
pub static ALAPIN_DEFENSE: Variation = Variation {
    name: "Alapin Defense",
    parent: Some(&super::RUY_LOPEZ),
    variations: &[&ALAPIN_GAMBIT],
    lines: &[Line {
        parent: &ALAPIN_DEFENSE,
        code: Code {
            volume: Volume::C,
