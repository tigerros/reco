...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::ruy_lopez::closed::BALLA_VARIATION;
assert_eq!(BALLA_VARIATION.original_name(), "Ruy Lopez: Closed, Balla Variation");
```"#
)]
pub static BALLA_VARIATION: Variation = Variation {
    name: "Balla Variation",
    parent: Some(&super::CLOSED),
    variations: &[],
    lines: &[Line {
        parent: &BALLA_VARIATION,
        code: Code {
            volume: Volume::C,
