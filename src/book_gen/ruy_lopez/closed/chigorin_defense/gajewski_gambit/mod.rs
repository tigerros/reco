...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::ruy_lopez::closed::chigorin_defense::GAJEWSKI_GAMBIT;
assert_eq!(GAJEWSKI_GAMBIT.original_name(), "Ruy Lopez: Closed, Chigorin Defense, Gajewski Gambit");
```"#
)]
pub static GAJEWSKI_GAMBIT: Variation = Variation {
    name: "Gajewski Gambit",
    parent: Some(&super::CHIGORIN_DEFENSE),
    variations: &[],
    lines: &[Line {
        parent: &GAJEWSKI_GAMBIT,
        code: Code {
            volume: Volume::C,
