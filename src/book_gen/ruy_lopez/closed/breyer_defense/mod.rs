...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::ruy_lopez::closed::BREYER_DEFENSE;
assert_eq!(BREYER_DEFENSE.original_name(), "Ruy Lopez: Closed, Breyer Defense");
```"#
)]
pub static BREYER_DEFENSE: Variation = Variation {
    name: "Breyer Defense",
    parent: Some(&super::CLOSED),
    variations: &[&QUIET_VARIATION, &ZAITSEV_HYBRID],
    lines: &[
        Line {
            parent: &BREYER_DEFENSE,
            code: Code {
                volume: Volume::C,
