...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::ruy_lopez::closed::ANTI_MARSHALL;
assert_eq!(ANTI_MARSHALL.original_name(), "Ruy Lopez: Closed, Anti-Marshall");
```"#
)]
pub static ANTI_MARSHALL: Variation = Variation {
    name: "Anti-Marshall",
    parent: Some(&super::CLOSED),
    variations: &[],
    lines: &[Line {
        parent: &ANTI_MARSHALL,
        code: Code {
            volume: Volume::C,
