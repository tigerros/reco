...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::ruy_lopez::closed::ROSSOLIMO_DEFENSE;
assert_eq!(ROSSOLIMO_DEFENSE.original_name(), "Ruy Lopez: Closed, Rossolimo Defense");
```"#
)]
pub static ROSSOLIMO_DEFENSE: Variation = Variation {
    name: "Rossolimo Defense",
    parent: Some(&super::CLOSED),
    variations: &[],
    lines: &[Line {
        parent: &ROSSOLIMO_DEFENSE,
        code: Code {
            volume: Volume::C,
