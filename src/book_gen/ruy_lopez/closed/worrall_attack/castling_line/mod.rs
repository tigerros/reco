...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::ruy_lopez::closed::worrall_attack::CASTLING_LINE;
assert_eq!(CASTLING_LINE.original_name(), "Ruy Lopez: Closed, Worrall Attack, Castling Line");
```"#
)]
pub static CASTLING_LINE: Variation = Variation {
    name: "Castling Line",
    parent: Some(&super::WORRALL_ATTACK),
    variations: &[],
    lines: &[
        Line {
            parent: &CASTLING_LINE,
            code: Code {
                volume: Volume::C,
