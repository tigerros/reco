...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::ruy_lopez::closed::WORRALL_ATTACK;
assert_eq!(WORRALL_ATTACK.original_name(), "Ruy Lopez: Closed, Worrall Attack");
```"#
)]
pub static WORRALL_ATTACK: Variation = Variation {
    name: "Worrall Attack",
    parent: Some(&super::CLOSED),
    variations: &[&CASTLING_LINE, &DELAYED_CASTLING_LINE],
    lines: &[Line {
        parent: &WORRALL_ATTACK,
        code: Code {
            volume: Volume::C,
