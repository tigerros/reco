...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::ruy_lopez::open::FRIESS_ATTACK;
assert_eq!(FRIESS_ATTACK.original_name(), "Ruy Lopez: Open, Friess Attack");
```"#
)]
pub static FRIESS_ATTACK: Variation = Variation {
    name: "Friess Attack",
    parent: Some(&super::OPEN),
    variations: &[],
    lines: &[Line {
        parent: &FRIESS_ATTACK,
        code: Code {
            volume: Volume::C,
