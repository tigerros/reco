...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::ruy_lopez::open::howell_attack::EKSTROM_VARIATION;
assert_eq!(EKSTROM_VARIATION.original_name(), "Ruy Lopez: Open, Howell Attack, Ekstrom Variation");
```"#
)]
pub static EKSTROM_VARIATION: Variation = Variation {
    name: "Ekstrom Variation",
    parent: Some(&super::HOWELL_ATTACK),
    variations: &[],
    lines: &[Line {
