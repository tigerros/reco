...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::ruy_lopez::classical_variation::CHAROUSEK_VARIATION;
assert_eq!(CHAROUSEK_VARIATION.original_name(), "Ruy Lopez: Classical Variation, Charousek Variation");
```"#
)]
