...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::ruy_lopez::classical_variation::CENTRAL_VARIATION;
assert_eq!(CENTRAL_VARIATION.original_name(), "Ruy Lopez: Classical Variation, Central Variation");
```"#
)]
