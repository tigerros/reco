...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::ruy_lopez::HALLOWEEN_ATTACK;
assert_eq!(HALLOWEEN_ATTACK.original_name(), "Ruy Lopez: Halloween Attack");
```"#
)]
pub static HALLOWEEN_ATTACK: Variation = Variation {
    name: "Halloween Attack",
    parent: Some(&super::RUY_LOPEZ),
    variations: &[],
    lines: &[Line {
        parent: &HALLOWEEN_ATTACK,
        code: Code {
            volume: Volume::C,
