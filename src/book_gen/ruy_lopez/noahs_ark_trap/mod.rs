...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::ruy_lopez::NOAHS_ARK_TRAP;
assert_eq!(NOAHS_ARK_TRAP.original_name(), "Ruy Lopez: Noah's Ark Trap");
```"#
)]
pub static NOAHS_ARK_TRAP: Variation = Variation {
    name: "Noah's Ark Trap",
    parent: Some(&super::RUY_LOPEZ),
    variations: &[],
    lines: &[
        Line {
            parent: &NOAHS_ARK_TRAP,
            code: Code {
                volume: Volume::C,
