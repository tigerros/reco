...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::ruy_lopez::morphy_defense::STEINITZ_DEFERRED;
assert_eq!(STEINITZ_DEFERRED.original_name(), "Ruy Lopez: Morphy Defense, Steinitz Deferred");
```"#
)]
pub static STEINITZ_DEFERRED: Variation = Variation {
    name: "Steinitz Deferred",
    parent: Some(&super::MORPHY_DEFENSE),
    variations: &[],
    lines: &[
        Line {
            parent: &STEINITZ_DEFERRED,
            code: Code {
                volume: Volume::C,
