...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::ruy_lopez::morphy_defense::WORMALD_ATTACK;
assert_eq!(WORMALD_ATTACK.original_name(), "Ruy Lopez: Morphy Defense, Wormald Attack");
```"#
)]
pub static WORMALD_ATTACK: Variation = Variation {
    name: "Wormald Attack",
    parent: Some(&super::MORPHY_DEFENSE),
    variations: &[],
    lines: &[Line {
        parent: &WORMALD_ATTACK,
        code: Code {
            volume: Volume::C,
