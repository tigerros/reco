...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::ruy_lopez::morphy_defense::ARKHANGELSK_VARIATION;
assert_eq!(ARKHANGELSK_VARIATION.original_name(), "Ruy Lopez: Morphy Defense, Arkhangelsk Variation");
```"#
)]
