...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::ruy_lopez::exchange_variation::BRONSTEIN_VARIATION;
assert_eq!(BRONSTEIN_VARIATION.original_name(), "Ruy Lopez: Exchange Variation, Bronstein Variation");
```"#
)]
