...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::ruy_lopez::exchange_variation::ALEKHINE_VARIATION;
assert_eq!(ALEKHINE_VARIATION.original_name(), "Ruy Lopez: Exchange Variation, Alekhine Variation");
```"#
)]
