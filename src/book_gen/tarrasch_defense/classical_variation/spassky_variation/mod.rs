...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::tarrasch_defense::classical_variation::SPASSKY_VARIATION;
assert_eq!(SPASSKY_VARIATION.original_name(), "Tarrasch Defense: Classical Variation, Spassky Variation");
```"#
)]
