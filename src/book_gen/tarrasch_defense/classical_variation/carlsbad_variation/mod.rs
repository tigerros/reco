...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::tarrasch_defense::classical_variation::CARLSBAD_VARIATION;
assert_eq!(CARLSBAD_VARIATION.original_name(), "Tarrasch Defense: Classical Variation, Carlsbad Variation");
```"#
)]
