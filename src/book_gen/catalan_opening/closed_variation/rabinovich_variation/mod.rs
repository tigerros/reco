...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::catalan_opening::closed_variation::RABINOVICH_VARIATION;
assert_eq!(RABINOVICH_VARIATION.original_name(), "Catalan Opening: Closed Variation, Rabinovich Variation");
```"#
)]
    ...
    lines: &[Line {
        ...
        setup: Setup {
            board: if let Ok(board) = Board::try_from_bitboards(
                ByRole {
                    pawn: Bitboard(63353903147692800),
                ...
                ByColor {
                    black: Bitboard(7924422236889415680),
