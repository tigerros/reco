...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::grob_opening::ZILBERMINTS_GAMBIT;
assert_eq!(ZILBERMINTS_GAMBIT.original_name(), "Grob Opening: Zilbermints Gambit");
```"#
)]
pub static ZILBERMINTS_GAMBIT: Variation = Variation {
    name: "Zilbermints Gambit",
    parent: Some(&super::GROB_OPENING),
    variations: &[&SCHILLER_DEFENSE, &ZILBERMINTS_HARTLAUB_GAMBIT],
    lines: &[Line {
        ...
        setup: Setup {
            board: if let Ok(board) = Board::try_from_bitboards(
                ByRole {
                    pawn: Bitboard(69524320589754112),
