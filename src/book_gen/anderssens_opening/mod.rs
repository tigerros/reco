...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::ANDERSSENS_OPENING;
assert_eq!(ANDERSSENS_OPENING.original_name(), "Anderssen's Opening");
```"#
)]
pub static ANDERSSENS_OPENING: Variation = Variation {
    name: "Anderssen's Opening",
    parent: None,
    variations: &[&POLISH_GAMBIT],
    lines: &[Line {
        parent: &ANDERSSENS_OPENING,
        code: Code {
            volume: Volume::A,
