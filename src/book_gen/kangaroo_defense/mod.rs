...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::KANGAROO_DEFENSE;
assert_eq!(KANGAROO_DEFENSE.original_name(), "Kangaroo Defense");
```"#
)]
pub static KANGAROO_DEFENSE: Variation = Variation {
    name: "Kangaroo Defense",
    parent: None,
    variations: &[&KERES_DEFENSE],
    lines: &[Line {
        parent: &KANGAROO_DEFENSE,
        code: Code {
            volume: Volume::A,
