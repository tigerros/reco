...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::modern_defense::STANDARD_DEFENSE;
assert_eq!(STANDARD_DEFENSE.original_name(), "Modern Defense: Standard Defense");
```"#
)]
pub static STANDARD_DEFENSE: Variation = Variation {
    name: "Standard Defense",
    parent: Some(&super::MODERN_DEFENSE),
    variations: &[],
    lines: &[Line {
        parent: &STANDARD_DEFENSE,
        code: Code {
            volume: Volume::B,
