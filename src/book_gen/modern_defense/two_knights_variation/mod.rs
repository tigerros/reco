...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::modern_defense::TWO_KNIGHTS_VARIATION;
assert_eq!(TWO_KNIGHTS_VARIATION.original_name(), "Modern Defense: Two Knights Variation");
```"#
)]
pub static TWO_KNIGHTS_VARIATION: Variation = Variation {
    name: "Two Knights Variation",
    parent: Some(&super::MODERN_DEFENSE),
    variations: &[&SUTTLES_VARIATION],
    lines: &[Line {
