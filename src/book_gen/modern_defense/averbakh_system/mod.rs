...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::modern_defense::AVERBAKH_SYSTEM;
assert_eq!(AVERBAKH_SYSTEM.original_name(), "Modern Defense: Averbakh System");
```"#
)]
pub static AVERBAKH_SYSTEM: Variation = Variation {
    name: "Averbakh System",
    parent: Some(&super::MODERN_DEFENSE),
    variations: &[],
    lines: &[Line {
        parent: &AVERBAKH_SYSTEM,
        code: Code {
            volume: Volume::A,
