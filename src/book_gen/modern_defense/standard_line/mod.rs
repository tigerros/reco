...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::modern_defense::STANDARD_LINE;
assert_eq!(STANDARD_LINE.original_name(), "Modern Defense: Standard Line");
```"#
)]
pub static STANDARD_LINE: Variation = Variation {
    name: "Standard Line",
    parent: Some(&super::MODERN_DEFENSE),
    variations: &[],
    lines: &[Line {
        parent: &STANDARD_LINE,
        code: Code {
            volume: Volume::B,
