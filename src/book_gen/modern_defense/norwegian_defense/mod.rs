...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::modern_defense::NORWEGIAN_DEFENSE;
assert_eq!(NORWEGIAN_DEFENSE.original_name(), "Modern Defense: Norwegian Defense");
```"#
)]
pub static NORWEGIAN_DEFENSE: Variation = Variation {
    name: "Norwegian Defense",
    parent: Some(&super::MODERN_DEFENSE),
    variations: &[&NORWEGIAN_GAMBIT],
    lines: &[Line {
        parent: &NORWEGIAN_DEFENSE,
        code: Code {
            volume: Volume::B,
