...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::torre_attack::classical_defense::NIMZOWITSCH_VARIATION;
assert_eq!(NIMZOWITSCH_VARIATION.original_name(), "Torre Attack: Classical Defense, Nimzowitsch Variation");
```"#
)]
