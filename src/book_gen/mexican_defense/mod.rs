...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::MEXICAN_DEFENSE;
assert_eq!(MEXICAN_DEFENSE.original_name(), "Mexican Defense");
```"#
)]
pub static MEXICAN_DEFENSE: Variation = Variation {
    name: "Mexican Defense",
    parent: None,
    variations: &[&HORSEFLY_GAMBIT],
    lines: &[Line {
        parent: &MEXICAN_DEFENSE,
        code: Code {
            volume: Volume::A,
