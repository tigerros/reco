...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::sicilian_defense::MODERN_VARIATIONS;
assert_eq!(MODERN_VARIATIONS.original_name(), "Sicilian Defense: Modern Variations");
```"#
)]
pub static MODERN_VARIATIONS: Variation = Variation {
