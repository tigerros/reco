...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::sicilian_defense::CHEKHOVER_VARIATION;
assert_eq!(CHEKHOVER_VARIATION.original_name(), "Sicilian Defense: Chekhover Variation");
```"#
)]
pub static CHEKHOVER_VARIATION: Variation = Variation {
    name: "Chekhover Variation",
    parent: Some(&super::SICILIAN_DEFENSE),
    variations: &[&ZAITSEV_DEFENSE],
    lines: &[Line {
