...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::sicilian_defense::nimzowitsch_variation::CLOSED_VARIATION;
assert_eq!(CLOSED_VARIATION.original_name(), "Sicilian Defense: Nimzowitsch Variation, Closed Variation");
```"#
)]
