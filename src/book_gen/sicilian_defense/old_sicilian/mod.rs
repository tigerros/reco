...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::sicilian_defense::OLD_SICILIAN;
assert_eq!(OLD_SICILIAN.original_name(), "Sicilian Defense: Old Sicilian");
```"#
)]
pub static OLD_SICILIAN: Variation = Variation {
    name: "Old Sicilian",
