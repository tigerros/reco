...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::sicilian_defense::najdorf_variation::SCHEVENINGEN_VARIATION;
assert_eq!(SCHEVENINGEN_VARIATION.original_name(), "Sicilian Defense: Najdorf Variation, Scheveningen Variation");
```"#
)]
