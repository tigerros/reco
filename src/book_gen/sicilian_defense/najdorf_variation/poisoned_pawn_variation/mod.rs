...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::sicilian_defense::najdorf_variation::POISONED_PAWN_VARIATION;
assert_eq!(POISONED_PAWN_VARIATION.original_name(), "Sicilian Defense: Najdorf Variation, Poisoned Pawn Variation");
```"#
)]
