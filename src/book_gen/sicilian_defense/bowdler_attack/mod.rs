...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::sicilian_defense::BOWDLER_ATTACK;
assert_eq!(BOWDLER_ATTACK.original_name(), "Sicilian Defense: Bowdler Attack");
```"#
)]
pub static BOWDLER_ATTACK: Variation = Variation {
    name: "Bowdler Attack",
    parent: Some(&super::SICILIAN_DEFENSE),
    variations: &[],
    lines: &[Line {
        parent: &BOWDLER_ATTACK,
        code: Code {
            volume: Volume::B,
