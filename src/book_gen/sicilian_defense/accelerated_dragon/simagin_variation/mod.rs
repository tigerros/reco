...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::sicilian_defense::accelerated_dragon::SIMAGIN_VARIATION;
assert_eq!(SIMAGIN_VARIATION.original_name(), "Sicilian Defense: Accelerated Dragon, Simagin Variation");
```"#
)]
