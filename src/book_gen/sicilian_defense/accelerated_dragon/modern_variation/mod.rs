...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::sicilian_defense::accelerated_dragon::MODERN_VARIATION;
assert_eq!(MODERN_VARIATION.original_name(), "Sicilian Defense: Accelerated Dragon, Modern Variation");
```"#
)]
