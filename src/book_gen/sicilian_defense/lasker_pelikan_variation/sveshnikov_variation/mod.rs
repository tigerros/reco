...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::sicilian_defense::lasker_pelikan_variation::SVESHNIKOV_VARIATION;
assert_eq!(SVESHNIKOV_VARIATION.original_name(), "Sicilian Defense: Lasker-Pelikan Variation, Sveshnikov Variation");
```"#
)]
pub static SVESHNIKOV_VARIATION: Variation = Variation {
    name: "Sveshnikov Variation",
    parent: Some(&super::LASKER_PELIKAN_VARIATION),
    variations: &[
        &CHELYABINSK_VARIATION,
        &NOVOSIBIRSK_VARIATION,
        &PERESYPKINS_SACRIFICE,
    ],
    lines: &[
        Line {
            parent: &SVESHNIKOV_VARIATION,
            code: Code {
                volume: Volume::B,
