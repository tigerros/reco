...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::sicilian_defense::richter_rauzer_variation::EXCHANGE_VARIATION;
assert_eq!(EXCHANGE_VARIATION.original_name(), "Sicilian Defense: Richter-Rauzer Variation, Exchange Variation");
```"#
)]
