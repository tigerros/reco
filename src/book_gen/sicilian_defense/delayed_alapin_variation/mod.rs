...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::sicilian_defense::DELAYED_ALAPIN_VARIATION;
assert_eq!(DELAYED_ALAPIN_VARIATION.original_name(), "Sicilian Defense: Delayed Alapin Variation");
```"#
)]
pub static DELAYED_ALAPIN_VARIATION: Variation = Variation {
    name: "Delayed Alapin Variation",
    ...
    lines: &[Line {
        parent: &DELAYED_ALAPIN_VARIATION,
        code: Code {
            volume: Volume::B,
