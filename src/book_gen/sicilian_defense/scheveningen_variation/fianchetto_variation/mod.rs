...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::sicilian_defense::scheveningen_variation::FIANCHETTO_VARIATION;
assert_eq!(FIANCHETTO_VARIATION.original_name(), "Sicilian Defense: Scheveningen Variation, Fianchetto Variation");
```"#
)]
