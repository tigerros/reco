...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::sicilian_defense::scheveningen_variation::TAL_VARIATION;
assert_eq!(TAL_VARIATION.original_name(), "Sicilian Defense: Scheveningen Variation, Tal Variation");
```"#
)]
