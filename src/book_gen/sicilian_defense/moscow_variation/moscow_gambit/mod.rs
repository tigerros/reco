...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::sicilian_defense::moscow_variation::MOSCOW_GAMBIT;
assert_eq!(MOSCOW_GAMBIT.original_name(), "Sicilian Defense: Moscow Variation, Moscow Gambit");
```"#
)]
pub static MOSCOW_GAMBIT: Variation = Variation {
    name: "Moscow Gambit",
