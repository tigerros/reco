...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::sicilian_defense::alapin_variation::STOLTZ_ATTACK;
assert_eq!(STOLTZ_ATTACK.original_name(), "Sicilian Defense: Alapin Variation, Stoltz Attack");
```"#
)]
pub static STOLTZ_ATTACK: Variation = Variation {
    name: "Stoltz Attack",
    parent: Some(&super::ALAPIN_VARIATION),
    variations: &[&IVANCHUK_LINE],
    lines: &[Line {
        parent: &STOLTZ_ATTACK,
        code: Code {
            volume: Volume::B,
