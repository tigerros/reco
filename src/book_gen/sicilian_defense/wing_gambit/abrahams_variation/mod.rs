...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::sicilian_defense::wing_gambit::ABRAHAMS_VARIATION;
assert_eq!(ABRAHAMS_VARIATION.original_name(), "Sicilian Defense: Wing Gambit, Abrahams Variation");
```"#
)]
