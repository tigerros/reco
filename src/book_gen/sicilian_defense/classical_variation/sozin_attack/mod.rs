...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::sicilian_defense::classical_variation::SOZIN_ATTACK;
assert_eq!(SOZIN_ATTACK.original_name(), "Sicilian Defense: Classical Variation, Sozin Attack");
```"#
)]
pub static SOZIN_ATTACK: Variation = Variation {
    name: "Sozin Attack",
