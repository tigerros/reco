...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::sicilian_defense::kan_variation::maroczy_bind::BRONSTEIN_VARIATION;
assert_eq!(BRONSTEIN_VARIATION.original_name(), "Sicilian Defense: Kan Variation, Maróczy Bind, Bronstein Variation");
```"#
)]
