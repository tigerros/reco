...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::sicilian_defense::closed::TRADITIONAL;
assert_eq!(TRADITIONAL.original_name(), "Sicilian Defense: Closed, Traditional");
```"#
)]
pub static TRADITIONAL: Variation = Variation {
    name: "Traditional",
