...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::sicilian_defense::dragon_variation::yugoslav_attack::BELEZKY_LINE;
assert_eq!(BELEZKY_LINE.original_name(), "Sicilian Defense: Dragon Variation, Yugoslav Attack, Belezky Line");
```"#
)]
pub static BELEZKY_LINE: Variation = Variation {
    name: "Belezky Line",
