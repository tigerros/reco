...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::sicilian_defense::dragon_variation::yugoslav_attack::BYRNE_VARIATION;
assert_eq!(BYRNE_VARIATION.original_name(), "Sicilian Defense: Dragon Variation, Yugoslav Attack, Byrne Variation");
```"#
)]
