...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::sicilian_defense::dragon_variation::yugoslav_attack::MODERN_LINE;
assert_eq!(MODERN_LINE.original_name(), "Sicilian Defense: Dragon Variation, Yugoslav Attack, Modern Line");
```"#
)]
