...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::sicilian_defense::dragon_variation::yugoslav_attack::MAIN_LINE;
assert_eq!(MAIN_LINE.original_name(), "Sicilian Defense: Dragon Variation, Yugoslav Attack, Main Line");
```"#
)]
