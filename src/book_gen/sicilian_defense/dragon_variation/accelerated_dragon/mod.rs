...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::sicilian_defense::dragon_variation::ACCELERATED_DRAGON;
assert_eq!(ACCELERATED_DRAGON.original_name(), "Sicilian Defense: Dragon Variation, Accelerated Dragon");
```"#
)]
pub static ACCELERATED_DRAGON: Variation = Variation {
