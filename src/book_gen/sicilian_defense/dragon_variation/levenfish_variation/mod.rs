...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::sicilian_defense::dragon_variation::LEVENFISH_VARIATION;
assert_eq!(LEVENFISH_VARIATION.original_name(), "Sicilian Defense: Dragon Variation, Levenfish Variation");
```"#
)]
