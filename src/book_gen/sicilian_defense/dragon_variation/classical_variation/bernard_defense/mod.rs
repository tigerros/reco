...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::sicilian_defense::dragon_variation::classical_variation::BERNARD_DEFENSE;
assert_eq!(BERNARD_DEFENSE.original_name(), "Sicilian Defense: Dragon Variation, Classical Variation, Bernard Defense");
```"#
)]
pub static BERNARD_DEFENSE: Variation = Variation {
    name: "Bernard Defense",
    parent: Some(&super::CLASSICAL_VARIATION),
    variations: &[],
    lines: &[Line {
        parent: &BERNARD_DEFENSE,
        code: Code {
            volume: Volume::B,
