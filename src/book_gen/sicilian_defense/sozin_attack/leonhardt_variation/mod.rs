...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::sicilian_defense::sozin_attack::LEONHARDT_VARIATION;
assert_eq!(LEONHARDT_VARIATION.original_name(), "Sicilian Defense: Sozin Attack, Leonhardt Variation");
```"#
)]
