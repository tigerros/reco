...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::sicilian_defense::SMITH_MORRA_GAMBIT;
assert_eq!(SMITH_MORRA_GAMBIT.original_name(), "Sicilian Defense: Smith-Morra Gambit");
```"#
)]
pub static SMITH_MORRA_GAMBIT: Variation = Variation {
    name: "Smith-Morra Gambit",
    parent: Some(&super::SICILIAN_DEFENSE),
    variations: &[],
    lines: &[
        Line {
            parent: &SMITH_MORRA_GAMBIT,
            code: Code {
                volume: Volume::B,
