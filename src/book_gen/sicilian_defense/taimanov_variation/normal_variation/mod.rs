...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::sicilian_defense::taimanov_variation::NORMAL_VARIATION;
assert_eq!(NORMAL_VARIATION.original_name(), "Sicilian Defense: Taimanov Variation, Normal Variation");
```"#
)]
