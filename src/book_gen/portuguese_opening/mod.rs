...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::PORTUGUESE_OPENING;
assert_eq!(PORTUGUESE_OPENING.original_name(), "Portuguese Opening");
```"#
)]
pub static PORTUGUESE_OPENING: Variation = Variation {
    name: "Portuguese Opening",
    parent: None,
    variations: &[&MIGUEL_GAMBIT, &PORTUGUESE_GAMBIT],
    lines: &[Line {
        parent: &PORTUGUESE_OPENING,
        code: Code {
            volume: Volume::C,
