...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::alekhine_defense::SCANDINAVIAN_VARIATION;
assert_eq!(SCANDINAVIAN_VARIATION.original_name(), "Alekhine Defense: Scandinavian Variation");
```"#
)]
pub static SCANDINAVIAN_VARIATION: Variation = Variation {
    name: "Scandinavian Variation",
    parent: Some(&super::ALEKHINE_DEFENSE),
    variations: &[&GESCHEV_GAMBIT, &MYERS_GAMBIT],
    lines: &[Line {
