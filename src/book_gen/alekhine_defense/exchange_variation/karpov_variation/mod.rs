...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::alekhine_defense::exchange_variation::KARPOV_VARIATION;
assert_eq!(KARPOV_VARIATION.original_name(), "Alekhine Defense: Exchange Variation, Karpov Variation");
```"#
)]
