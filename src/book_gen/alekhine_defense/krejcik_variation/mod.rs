...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::alekhine_defense::KREJCIK_VARIATION;
assert_eq!(KREJCIK_VARIATION.original_name(), "Alekhine Defense: Krejcik Variation");
```"#
)]
pub static KREJCIK_VARIATION: Variation = Variation {
    name: "Krejcik Variation",
    parent: Some(&super::ALEKHINE_DEFENSE),
    variations: &[&KREJCIK_GAMBIT],
    lines: &[Line {
        parent: &KREJCIK_VARIATION,
        code: Code {
            volume: Volume::B,
