...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::alekhine_defense::modern_variation::ALEKHINE_VARIATION;
assert_eq!(ALEKHINE_VARIATION.original_name(), "Alekhine Defense: Modern Variation, Alekhine Variation");
```"#
)]
