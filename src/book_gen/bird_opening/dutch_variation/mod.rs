...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::bird_opening::DUTCH_VARIATION;
assert_eq!(DUTCH_VARIATION.original_name(), "Bird Opening: Dutch Variation");
```"#
)]
pub static DUTCH_VARIATION: Variation = Variation {
    name: "Dutch Variation",
    parent: Some(&super::BIRD_OPENING),
    variations: &[&BATAVO_GAMBIT, &DUDWEILER_GAMBIT],
    lines: &[Line {
