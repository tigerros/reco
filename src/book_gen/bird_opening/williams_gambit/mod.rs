...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::bird_opening::WILLIAMS_GAMBIT;
assert_eq!(WILLIAMS_GAMBIT.original_name(), "Bird Opening: Williams Gambit");
```"#
)]
pub static WILLIAMS_GAMBIT: Variation = Variation {
    name: "Williams Gambit",
    parent: Some(&super::BIRD_OPENING),
    variations: &[],
    lines: &[
        Line {
            parent: &WILLIAMS_GAMBIT,
            code: Code {
                volume: Volume::A,
