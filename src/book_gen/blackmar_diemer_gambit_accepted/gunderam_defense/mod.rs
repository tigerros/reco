...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::blackmar_diemer_gambit_accepted::GUNDERAM_DEFENSE;
assert_eq!(GUNDERAM_DEFENSE.original_name(), "Blackmar-Diemer Gambit Accepted: Gunderam Defense");
```"#
)]
