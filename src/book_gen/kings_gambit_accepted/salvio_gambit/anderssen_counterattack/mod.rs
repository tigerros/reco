...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::kings_gambit_accepted::salvio_gambit::ANDERSSEN_COUNTERATTACK;
assert_eq!(ANDERSSEN_COUNTERATTACK.original_name(), "King's Gambit Accepted: Salvio Gambit, Anderssen Counterattack");
```"#
)]
