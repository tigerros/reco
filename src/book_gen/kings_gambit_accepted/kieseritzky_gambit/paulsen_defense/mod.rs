...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::kings_gambit_accepted::kieseritzky_gambit::PAULSEN_DEFENSE;
assert_eq!(PAULSEN_DEFENSE.original_name(), "King's Gambit Accepted: Kieseritzky Gambit, Paulsen Defense");
```"#
)]
