...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::kings_gambit_accepted::kieseritzky_gambit::berlin_defense::RUBINSTEIN_VARIATION;
assert_eq!(RUBINSTEIN_VARIATION.original_name(), "King's Gambit Accepted: Kieseritzky Gambit, Berlin Defense, Rubinstein Variation");
```"#
)]
