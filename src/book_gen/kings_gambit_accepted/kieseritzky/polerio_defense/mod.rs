...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::kings_gambit_accepted::kieseritzky::POLERIO_DEFENSE;
assert_eq!(POLERIO_DEFENSE.original_name(), "King's Gambit Accepted: Kieseritzky, Polerio Defense");
```"#
)]
