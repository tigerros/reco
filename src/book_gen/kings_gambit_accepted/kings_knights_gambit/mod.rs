...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::kings_gambit_accepted::KINGS_KNIGHTS_GAMBIT;
assert_eq!(KINGS_KNIGHTS_GAMBIT.original_name(), "King's Gambit Accepted: King's Knight's Gambit");
```"#
)]
pub static KINGS_KNIGHTS_GAMBIT: Variation = Variation {
