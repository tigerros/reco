...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::kings_gambit_accepted::GHULAM_KASSIM_GAMBIT;
assert_eq!(GHULAM_KASSIM_GAMBIT.original_name(), "King's Gambit Accepted: Ghulam-Kassim Gambit");
```"#
)]
pub static GHULAM_KASSIM_GAMBIT: Variation = Variation {
    name: "Ghulam-Kassim Gambit",
    parent: Some(&super::KINGS_GAMBIT_ACCEPTED),
    variations: &[],
    lines: &[
        Line {
            parent: &GHULAM_KASSIM_GAMBIT,
            code: Code {
                volume: Volume::C,
