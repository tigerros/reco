...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::kings_gambit_accepted::bishops_gambit::FRASER_VARIATION;
assert_eq!(FRASER_VARIATION.original_name(), "King's Gambit Accepted: Bishop's Gambit, Fraser Variation");
```"#
)]
pub static FRASER_VARIATION: Variation = Variation {
    name: "Fraser Variation",
    parent: Some(&super::BISHOPS_GAMBIT),
    variations: &[],
    lines: &[Line {
        parent: &FRASER_VARIATION,
        code: Code {
            volume: Volume::C,
