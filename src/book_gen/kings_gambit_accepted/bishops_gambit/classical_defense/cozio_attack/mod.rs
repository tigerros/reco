...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::kings_gambit_accepted::bishops_gambit::classical_defense::COZIO_ATTACK;
assert_eq!(COZIO_ATTACK.original_name(), "King's Gambit Accepted: Bishop's Gambit, Classical Defense, Cozio Attack");
```"#
)]
