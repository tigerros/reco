...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::kings_gambit_accepted::bishops_gambit::CLASSICAL_DEFENSE;
assert_eq!(CLASSICAL_DEFENSE.original_name(), "King's Gambit Accepted: Bishop's Gambit, Classical Defense");
```"#
)]
