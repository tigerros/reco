...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::kings_gambit_accepted::SILBERSCHMIDT_GAMBIT;
assert_eq!(SILBERSCHMIDT_GAMBIT.original_name(), "King's Gambit Accepted: Silberschmidt Gambit");
```"#
)]
pub static SILBERSCHMIDT_GAMBIT: Variation = Variation {
    name: "Silberschmidt Gambit",
    parent: Some(&super::KINGS_GAMBIT_ACCEPTED),
    variations: &[],
    lines: &[Line {
        parent: &SILBERSCHMIDT_GAMBIT,
        code: Code {
            volume: Volume::C,
