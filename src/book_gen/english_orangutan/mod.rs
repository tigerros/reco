...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::ENGLISH_ORANGUTAN;
assert_eq!(ENGLISH_ORANGUTAN.original_name(), "English Orangutan");
```"#
)]
pub static ENGLISH_ORANGUTAN: Variation = Variation {
    name: "English Orangutan",
    parent: None,
    variations: &[],
    lines: &[Line {
        parent: &ENGLISH_ORANGUTAN,
        code: Code {
            volume: Volume::A,
