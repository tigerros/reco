...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::slav_defense::exchange_variation::TRIFUNOVIC_VARIATION;
assert_eq!(TRIFUNOVIC_VARIATION.original_name(), "Slav Defense: Exchange Variation, Trifunovic Variation");
```"#
)]
