...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::slav_defense::GELLER_GAMBIT;
assert_eq!(GELLER_GAMBIT.original_name(), "Slav Defense: Geller Gambit");
```"#
)]
pub static GELLER_GAMBIT: Variation = Variation {
    name: "Geller Gambit",
    parent: Some(&super::SLAV_DEFENSE),
    variations: &[],
    lines: &[
        Line {
            parent: &GELLER_GAMBIT,
            code: Code {
                volume: Volume::D,
