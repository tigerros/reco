...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::center_game::HALL_VARIATION;
assert_eq!(HALL_VARIATION.original_name(), "Center Game: Hall Variation");
```"#
)]
pub static HALL_VARIATION: Variation = Variation {
    name: "Hall Variation",
    parent: Some(&super::CENTER_GAME),
    variations: &[],
    lines: &[Line {
        parent: &HALL_VARIATION,
        code: Code {
            volume: Volume::C,
