...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::scotch_game::scotch_gambit::DUBOIS_RETI_DEFENSE;
assert_eq!(DUBOIS_RETI_DEFENSE.original_name(), "Scotch Game: Scotch Gambit, Dubois Réti Defense");
```"#
)]
pub static DUBOIS_RETI_DEFENSE: Variation = Variation {
    name: "Dubois Réti Defense",
    parent: Some(&super::SCOTCH_GAMBIT),
    variations: &[],
    lines: &[Line {
        parent: &DUBOIS_RETI_DEFENSE,
        code: Code {
            volume: Volume::C,
