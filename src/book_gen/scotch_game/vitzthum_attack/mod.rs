...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::scotch_game::VITZTHUM_ATTACK;
assert_eq!(VITZTHUM_ATTACK.original_name(), "Scotch Game: Vitzthum Attack");
```"#
)]
pub static VITZTHUM_ATTACK: Variation = Variation {
    name: "Vitzthum Attack",
    parent: Some(&super::SCOTCH_GAME),
    variations: &[],
    lines: &[Line {
        parent: &VITZTHUM_ATTACK,
        code: Code {
            volume: Volume::C,
