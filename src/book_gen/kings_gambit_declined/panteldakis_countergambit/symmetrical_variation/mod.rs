...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::kings_gambit_declined::panteldakis_countergambit::SYMMETRICAL_VARIATION;
assert_eq!(SYMMETRICAL_VARIATION.original_name(), "King's Gambit Declined: Panteldakis Countergambit, Symmetrical Variation");
```"#
)]
