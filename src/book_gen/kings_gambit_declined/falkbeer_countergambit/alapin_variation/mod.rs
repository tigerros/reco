...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::kings_gambit_declined::falkbeer_countergambit::ALAPIN_VARIATION;
assert_eq!(ALAPIN_VARIATION.original_name(), "King's Gambit Declined: Falkbeer Countergambit, Alapin Variation");
```"#
)]
