...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::kings_gambit_declined::falkbeer_countergambit::BLACKBURNE_ATTACK;
assert_eq!(BLACKBURNE_ATTACK.original_name(), "King's Gambit Declined: Falkbeer Countergambit, Blackburne Attack");
```"#
)]
