...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::kings_gambit_declined::classical_variation::EUWE_ATTACK;
assert_eq!(EUWE_ATTACK.original_name(), "King's Gambit Declined: Classical Variation, Euwe Attack");
```"#
)]
pub static EUWE_ATTACK: Variation = Variation {
    name: "Euwe Attack",
