...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::scandinavian_defense::schiller_pytel_variation::MODERN_VARIATION;
assert_eq!(MODERN_VARIATION.original_name(), "Scandinavian Defense: Schiller-Pytel Variation, Modern Variation");
```"#
)]
pub static MODERN_VARIATION: Variation = Variation {
    name: "Modern Variation",
    parent: Some(&super::SCHILLER_PYTEL_VARIATION),
    variations: &[],
    lines: &[Line {
