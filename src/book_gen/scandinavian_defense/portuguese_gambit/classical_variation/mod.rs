...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::scandinavian_defense::portuguese_gambit::CLASSICAL_VARIATION;
assert_eq!(CLASSICAL_VARIATION.original_name(), "Scandinavian Defense: Portuguese Gambit, Classical Variation");
```"#
)]
