...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::BLACKMAR_DIEMER_GAMBIT;
assert_eq!(BLACKMAR_DIEMER_GAMBIT.original_name(), "Blackmar-Diemer Gambit");
```"#
)]
pub static BLACKMAR_DIEMER_GAMBIT: Variation = Variation {
