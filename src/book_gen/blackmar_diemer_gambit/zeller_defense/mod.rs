...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::blackmar_diemer_gambit::ZELLER_DEFENSE;
assert_eq!(ZELLER_DEFENSE.original_name(), "Blackmar-Diemer Gambit: Zeller Defense");
```"#
)]
pub static ZELLER_DEFENSE: Variation = Variation {
    name: "Zeller Defense",
    parent: Some(&super::BLACKMAR_DIEMER_GAMBIT),
    variations: &[&SOLLER_ATTACK],
    lines: &[Line {
        parent: &ZELLER_DEFENSE,
        code: Code {
            volume: Volume::D,
        ...
        setup: Setup {
            board: if let Ok(board) = Board::try_from_bitboards(
                ...
                ByColor {
                    black: Bitboard(18155980560474832896),
