...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::RAPPORT_JOBAVA_SYSTEM;
assert_eq!(RAPPORT_JOBAVA_SYSTEM.original_name(), "Rapport-Jobava System");
```"#
)]
pub static RAPPORT_JOBAVA_SYSTEM: Variation = Variation {
    name: "Rapport-Jobava System",
    parent: None,
    variations: &[&WITH_E6],
    lines: &[
        Line {
            parent: &RAPPORT_JOBAVA_SYSTEM,
            code: Code {
                volume: Volume::D,
