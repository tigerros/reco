...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::benoni_defense::ZILBERMINTS_BENONI_GAMBIT;
assert_eq!(ZILBERMINTS_BENONI_GAMBIT.original_name(), "Benoni Defense: Zilbermints-Benoni Gambit");
```"#
)]
pub static ZILBERMINTS_BENONI_GAMBIT: Variation = Variation {
    name: "Zilbermints-Benoni Gambit",
    parent: Some(&super::BENONI_DEFENSE),
    variations: &[&TAMARKIN_COUNTERGAMBIT],
    lines: &[
        Line {
            parent: &ZILBERMINTS_BENONI_GAMBIT,
            code: Code {
                volume: Volume::A,
