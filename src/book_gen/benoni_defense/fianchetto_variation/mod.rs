...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::benoni_defense::FIANCHETTO_VARIATION;
assert_eq!(FIANCHETTO_VARIATION.original_name(), "Benoni Defense: Fianchetto Variation");
```"#
)]
pub static FIANCHETTO_VARIATION: Variation = Variation {
    name: "Fianchetto Variation",
    parent: Some(&super::BENONI_DEFENSE),
    variations: &[&HASTINGS_DEFENSE],
    lines: &[
        Line {
