...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::nimzowitsch_defense::WHEELER_GAMBIT;
assert_eq!(WHEELER_GAMBIT.original_name(), "Nimzowitsch Defense: Wheeler Gambit");
```"#
)]
pub static WHEELER_GAMBIT: Variation = Variation {
    name: "Wheeler Gambit",
    parent: Some(&super::NIMZOWITSCH_DEFENSE),
    variations: &[],
    lines: &[Line {
        parent: &WHEELER_GAMBIT,
        code: Code {
            volume: Volume::B,
