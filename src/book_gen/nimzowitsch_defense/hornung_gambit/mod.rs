...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::nimzowitsch_defense::HORNUNG_GAMBIT;
assert_eq!(HORNUNG_GAMBIT.original_name(), "Nimzowitsch Defense: Hornung Gambit");
```"#
)]
pub static HORNUNG_GAMBIT: Variation = Variation {
    name: "Hornung Gambit",
    parent: Some(&super::NIMZOWITSCH_DEFENSE),
    variations: &[],
    lines: &[Line {
        parent: &HORNUNG_GAMBIT,
        code: Code {
            volume: Volume::B,
