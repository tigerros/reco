...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::pirc_defense::N150_ATTACK;
assert_eq!(N150_ATTACK.original_name(), "Pirc Defense: 150 Attack");
```"#
)]
pub static N150_ATTACK: Variation = Variation {
    name: "150 Attack",
    parent: Some(&super::PIRC_DEFENSE),
    variations: &[&INNER_DOLL_DEFENSE, &SVESHNIKOV_JANSA_ATTACK],
    lines: &[Line {
        parent: &N150_ATTACK,
        code: Code {
            volume: Volume::B,
