...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::pirc_defense::CLASSICAL_VARIATION;
assert_eq!(CLASSICAL_VARIATION.original_name(), "Pirc Defense: Classical Variation");
```"#
)]
pub static CLASSICAL_VARIATION: Variation = Variation {
    name: "Classical Variation",
    parent: Some(&super::PIRC_DEFENSE),
    variations: &[&QUIET_SYSTEM, &SCHLECHTER_VARIATION],
    lines: &[
        Line {
