...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::pirc_defense::austrian_attack::unzicker_attack::BRONSTEIN_VARIATION;
assert_eq!(BRONSTEIN_VARIATION.original_name(), "Pirc Defense: Austrian Attack, Unzicker Attack, Bronstein Variation");
```"#
)]
pub static BRONSTEIN_VARIATION: Variation = Variation {
    name: "Bronstein Variation",
    parent: Some(&super::UNZICKER_ATTACK),
    variations: &[],
    lines: &[Line {
