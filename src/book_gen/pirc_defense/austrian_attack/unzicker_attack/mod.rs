...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::pirc_defense::austrian_attack::UNZICKER_ATTACK;
assert_eq!(UNZICKER_ATTACK.original_name(), "Pirc Defense: Austrian Attack, Unzicker Attack");
```"#
)]
pub static UNZICKER_ATTACK: Variation = Variation {
    name: "Unzicker Attack",
    parent: Some(&super::AUSTRIAN_ATTACK),
    variations: &[&BRONSTEIN_VARIATION],
    lines: &[Line {
        parent: &UNZICKER_ATTACK,
        code: Code {
            volume: Volume::B,
        ...
        setup: Setup {
            board: if let Ok(board) = Board::try_from_bitboards(
                ByRole {
                    pawn: Bitboard(51589154965866240),
