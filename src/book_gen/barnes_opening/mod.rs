...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::BARNES_OPENING;
assert_eq!(BARNES_OPENING.original_name(), "Barnes Opening");
```"#
)]
pub static BARNES_OPENING: Variation = Variation {
    name: "Barnes Opening",
    parent: None,
    variations: &[&FOOLS_MATE, &GEDULT_GAMBIT, &HAMMERSCHLAG, &WALKERLING],
    lines: &[Line {
        parent: &BARNES_OPENING,
        code: Code {
            volume: Volume::A,
