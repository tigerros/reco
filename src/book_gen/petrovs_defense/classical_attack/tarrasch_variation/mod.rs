...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::petrovs_defense::classical_attack::TARRASCH_VARIATION;
assert_eq!(TARRASCH_VARIATION.original_name(), "Petrov's Defense: Classical Attack, Tarrasch Variation");
```"#
)]
