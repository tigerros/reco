...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::petrovs_defense::classical_attack::CLOSED_VARIATION;
assert_eq!(CLOSED_VARIATION.original_name(), "Petrov's Defense: Classical Attack, Closed Variation");
```"#
)]
