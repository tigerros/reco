...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::petrovs_defense::classical_attack::MAROCZY_VARIATION;
assert_eq!(MAROCZY_VARIATION.original_name(), "Petrov's Defense: Classical Attack, Maróczy Variation");
```"#
)]
