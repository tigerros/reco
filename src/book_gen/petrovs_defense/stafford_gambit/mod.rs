...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::petrovs_defense::STAFFORD_GAMBIT;
assert_eq!(STAFFORD_GAMBIT.original_name(), "Petrov's Defense: Stafford Gambit");
```"#
)]
pub static STAFFORD_GAMBIT: Variation = Variation {
    name: "Stafford Gambit",
    parent: Some(&super::PETROVS_DEFENSE),
    variations: &[],
    lines: &[
        Line {
            parent: &STAFFORD_GAMBIT,
            code: Code {
                volume: Volume::C,
