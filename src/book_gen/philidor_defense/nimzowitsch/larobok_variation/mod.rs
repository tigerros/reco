...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::philidor_defense::nimzowitsch::LAROBOK_VARIATION;
assert_eq!(LAROBOK_VARIATION.original_name(), "Philidor Defense: Nimzowitsch, Larobok Variation");
```"#
)]
