...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::queens_indian_defense::PETROSIAN_VARIATION;
assert_eq!(PETROSIAN_VARIATION.original_name(), "Queen's Indian Defense: Petrosian Variation");
```"#
)]
pub static PETROSIAN_VARIATION: Variation = Variation {
    name: "Petrosian Variation",
    parent: Some(&super::QUEENS_INDIAN_DEFENSE),
    variations: &[&FARAGO_DEFENSE],
    lines: &[Line {
