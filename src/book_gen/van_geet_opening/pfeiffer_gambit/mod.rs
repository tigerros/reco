...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::van_geet_opening::PFEIFFER_GAMBIT;
assert_eq!(PFEIFFER_GAMBIT.original_name(), "Van Geet Opening: Pfeiffer Gambit");
```"#
)]
pub static PFEIFFER_GAMBIT: Variation = Variation {
    name: "Pfeiffer Gambit",
    parent: Some(&super::VAN_GEET_OPENING),
    variations: &[&SLEIPNIR_COUNTERGAMBIT],
    lines: &[Line {
        parent: &PFEIFFER_GAMBIT,
        code: Code {
            volume: Volume::A,
