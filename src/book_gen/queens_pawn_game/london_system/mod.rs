...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::queens_pawn_game::LONDON_SYSTEM;
assert_eq!(LONDON_SYSTEM.original_name(), "Queen's Pawn Game: London System");
```"#
)]
pub static LONDON_SYSTEM: Variation = Variation {
    name: "London System",
    parent: Some(&super::QUEENS_PAWN_GAME),
    variations: &[&PTERODACTYL_VARIATION, &WITH_E6],
    lines: &[Line {
        parent: &LONDON_SYSTEM,
        code: Code {
            volume: Volume::D,
