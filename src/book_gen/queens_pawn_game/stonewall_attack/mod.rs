...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::queens_pawn_game::STONEWALL_ATTACK;
assert_eq!(STONEWALL_ATTACK.original_name(), "Queen's Pawn Game: Stonewall Attack");
```"#
)]
pub static STONEWALL_ATTACK: Variation = Variation {
    name: "Stonewall Attack",
    parent: Some(&super::QUEENS_PAWN_GAME),
    variations: &[],
    lines: &[Line {
        parent: &STONEWALL_ATTACK,
        code: Code {
            volume: Volume::D,
