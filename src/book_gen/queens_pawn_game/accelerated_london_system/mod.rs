...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::queens_pawn_game::ACCELERATED_LONDON_SYSTEM;
assert_eq!(ACCELERATED_LONDON_SYSTEM.original_name(), "Queen's Pawn Game: Accelerated London System");
```"#
)]
pub static ACCELERATED_LONDON_SYSTEM: Variation = Variation {
    name: "Accelerated London System",
    parent: Some(&super::QUEENS_PAWN_GAME),
    variations: &[&STEINITZ_COUNTERGAMBIT, &STEINITZ_COUNTERGAMBIT_ACCEPTED],
    lines: &[Line {
        parent: &ACCELERATED_LONDON_SYSTEM,
        code: Code {
            volume: Volume::D,
