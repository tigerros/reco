...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::queens_pawn_game::torre_attack::GRUNFELD_VARIATION;
assert_eq!(GRUNFELD_VARIATION.original_name(), "Queen's Pawn Game: Torre Attack, Grünfeld Variation");
```"#
)]
