...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::queens_pawn_game::CHANDLER_GAMBIT;
assert_eq!(CHANDLER_GAMBIT.original_name(), "Queen's Pawn Game: Chandler Gambit");
```"#
)]
pub static CHANDLER_GAMBIT: Variation = Variation {
    name: "Chandler Gambit",
