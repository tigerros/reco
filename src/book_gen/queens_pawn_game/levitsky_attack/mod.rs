...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::queens_pawn_game::LEVITSKY_ATTACK;
assert_eq!(LEVITSKY_ATTACK.original_name(), "Queen's Pawn Game: Levitsky Attack");
```"#
)]
pub static LEVITSKY_ATTACK: Variation = Variation {
    name: "Levitsky Attack",
    parent: Some(&super::QUEENS_PAWN_GAME),
    variations: &[&EUWE_VARIATION, &WELLING_VARIATION],
    lines: &[Line {
        parent: &LEVITSKY_ATTACK,
        code: Code {
            volume: Volume::D,
