...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::vienna_gambit::with_max_lange_defense::steinitz_gambit::ZUKERTORT_DEFENSE;
assert_eq!(ZUKERTORT_DEFENSE.original_name(), "Vienna Gambit: with Max Lange Defense, Steinitz Gambit, Zukertort Defense");
```"#
)]
