...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::vienna_gambit::with_max_lange_defense::CUNNINGHAM_DEFENSE;
assert_eq!(CUNNINGHAM_DEFENSE.original_name(), "Vienna Gambit: with Max Lange Defense, Cunningham Defense");
```"#
)]
