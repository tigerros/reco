...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::vienna_gambit::with_max_lange_defense::hamppe_allgaier_gambit::ALAPIN_VARIATION;
assert_eq!(ALAPIN_VARIATION.original_name(), "Vienna Gambit: with Max Lange Defense, Hamppe-Allgaier Gambit, Alapin Variation");
```"#
)]
