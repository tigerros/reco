...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::nimzo_indian_defense::classical_variation::noa_variation::BOTVINNIK_VARIATION;
assert_eq!(BOTVINNIK_VARIATION.original_name(), "Nimzo-Indian Defense: Classical Variation, Noa Variation, Botvinnik Variation");
```"#
)]
