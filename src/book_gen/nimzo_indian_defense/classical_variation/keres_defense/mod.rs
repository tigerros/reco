...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::nimzo_indian_defense::classical_variation::KERES_DEFENSE;
assert_eq!(KERES_DEFENSE.original_name(), "Nimzo-Indian Defense: Classical Variation, Keres Defense");
```"#
)]
