...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::nimzo_indian_defense::rubinstein_system::rubinstein_variation::MAIN_LINE;
assert_eq!(MAIN_LINE.original_name(), "Nimzo-Indian Defense: Rubinstein System, Rubinstein Variation, Main Line");
```"#
)]
