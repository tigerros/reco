...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::nimzo_indian_defense::normal_variation::BOTVINNIK_SYSTEM;
assert_eq!(BOTVINNIK_SYSTEM.original_name(), "Nimzo-Indian Defense: Normal Variation, Botvinnik System");
```"#
)]
