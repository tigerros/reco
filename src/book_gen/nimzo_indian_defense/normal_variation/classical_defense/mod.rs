...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::nimzo_indian_defense::normal_variation::CLASSICAL_DEFENSE;
assert_eq!(CLASSICAL_DEFENSE.original_name(), "Nimzo-Indian Defense: Normal Variation, Classical Defense");
```"#
)]
