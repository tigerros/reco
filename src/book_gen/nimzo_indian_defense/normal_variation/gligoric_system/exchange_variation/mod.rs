...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::nimzo_indian_defense::normal_variation::gligoric_system::EXCHANGE_VARIATION;
assert_eq!(EXCHANGE_VARIATION.original_name(), "Nimzo-Indian Defense: Normal Variation, Gligoric System, Exchange Variation");
```"#
)]
