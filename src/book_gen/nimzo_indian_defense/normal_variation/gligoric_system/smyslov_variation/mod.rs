...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::nimzo_indian_defense::normal_variation::gligoric_system::SMYSLOV_VARIATION;
assert_eq!(SMYSLOV_VARIATION.original_name(), "Nimzo-Indian Defense: Normal Variation, Gligoric System, Smyslov Variation");
```"#
)]
