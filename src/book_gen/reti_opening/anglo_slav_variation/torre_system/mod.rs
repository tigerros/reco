...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::reti_opening::anglo_slav_variation::TORRE_SYSTEM;
assert_eq!(TORRE_SYSTEM.original_name(), "Réti Opening: Anglo-Slav Variation, Torre System");
```"#
)]
pub static TORRE_SYSTEM: Variation = Variation {
    name: "Torre System",
