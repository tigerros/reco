...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::vienna_game::MAX_LANGE_DEFENSE;
assert_eq!(MAX_LANGE_DEFENSE.original_name(), "Vienna Game: Max Lange Defense");
```"#
)]
pub static MAX_LANGE_DEFENSE: Variation = Variation {
    name: "Max Lange Defense",
    parent: Some(&super::VIENNA_GAME),
    variations: &[],
    lines: &[Line {
        parent: &MAX_LANGE_DEFENSE,
        code: Code {
            volume: Volume::C,
