...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::vienna_game::PAULSEN_VARIATION;
assert_eq!(PAULSEN_VARIATION.original_name(), "Vienna Game: Paulsen Variation");
```"#
)]
pub static PAULSEN_VARIATION: Variation = Variation {
    name: "Paulsen Variation",
    parent: Some(&super::VIENNA_GAME),
    variations: &[&MARIOTTI_GAMBIT, &POLLOCK_GAMBIT],
    lines: &[
        Line {
        ...
        Line {
            ...
            setup: Setup {
                board: if let Ok(board) = Board::try_from_bitboards(
                    ByRole {
                        pawn: Bitboard(65020822972051200),
                    ...
                    ByColor {
                        black: Bitboard(11378102686252531712),
                        white: Bitboard(272957341),
                    },
                ) {
                    board
                } else {
