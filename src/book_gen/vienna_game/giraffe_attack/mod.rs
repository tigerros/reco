...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::vienna_game::GIRAFFE_ATTACK;
assert_eq!(GIRAFFE_ATTACK.original_name(), "Vienna Game: Giraffe Attack");
```"#
)]
pub static GIRAFFE_ATTACK: Variation = Variation {
    name: "Giraffe Attack",
    parent: Some(&super::VIENNA_GAME),
    variations: &[],
    lines: &[Line {
        parent: &GIRAFFE_ATTACK,
        code: Code {
            volume: Volume::C,
