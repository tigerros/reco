...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::vienna_game::FRANKENSTEIN_DRACULA_VARIATION;
assert_eq!(FRANKENSTEIN_DRACULA_VARIATION.original_name(), "Vienna Game: Frankenstein-Dracula Variation");
```"#
)]
