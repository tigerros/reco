...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::vienna_game::stanley_variation::BRONSTEIN_GAMBIT;
assert_eq!(BRONSTEIN_GAMBIT.original_name(), "Vienna Game: Stanley Variation, Bronstein Gambit");
```"#
)]
