...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::vienna_game::stanley_variation::ALEKHINE_VARIATION;
assert_eq!(ALEKHINE_VARIATION.original_name(), "Vienna Game: Stanley Variation, Alekhine Variation");
```"#
)]
