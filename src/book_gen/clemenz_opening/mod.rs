...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::CLEMENZ_OPENING;
assert_eq!(CLEMENZ_OPENING.original_name(), "Clemenz Opening");
```"#
)]
pub static CLEMENZ_OPENING: Variation = Variation {
    name: "Clemenz Opening",
    parent: None,
    variations: &[&SPIKE_LEE_GAMBIT],
    lines: &[Line {
        parent: &CLEMENZ_OPENING,
        code: Code {
            volume: Volume::A,
