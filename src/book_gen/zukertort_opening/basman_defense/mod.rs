...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::zukertort_opening::BASMAN_DEFENSE;
assert_eq!(BASMAN_DEFENSE.original_name(), "Zukertort Opening: Basman Defense");
```"#
)]
pub static BASMAN_DEFENSE: Variation = Variation {
    name: "Basman Defense",
