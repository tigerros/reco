...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::zukertort_opening::TENNISON_GAMBIT;
assert_eq!(TENNISON_GAMBIT.original_name(), "Zukertort Opening: Tennison Gambit");
```"#
)]
pub static TENNISON_GAMBIT: Variation = Variation {
    name: "Tennison Gambit",
    parent: Some(&super::ZUKERTORT_OPENING),
    variations: &[&BRIGGS_TRAP],
    lines: &[Line {
        parent: &TENNISON_GAMBIT,
        code: Code {
            volume: Volume::A,
