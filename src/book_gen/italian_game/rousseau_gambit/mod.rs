...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::italian_game::ROUSSEAU_GAMBIT;
assert_eq!(ROUSSEAU_GAMBIT.original_name(), "Italian Game: Rousseau Gambit");
```"#
)]
pub static ROUSSEAU_GAMBIT: Variation = Variation {
    name: "Rousseau Gambit",
    parent: Some(&super::ITALIAN_GAME),
    variations: &[],
    lines: &[Line {
        parent: &ROUSSEAU_GAMBIT,
        code: Code {
            volume: Volume::C,
