...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::italian_game::classical_variation::TARRASCH_VARIATION;
assert_eq!(TARRASCH_VARIATION.original_name(), "Italian Game: Classical Variation, Tarrasch Variation");
```"#
)]
