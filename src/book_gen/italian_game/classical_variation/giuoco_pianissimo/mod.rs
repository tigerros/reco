...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::italian_game::classical_variation::GIUOCO_PIANISSIMO;
assert_eq!(GIUOCO_PIANISSIMO.original_name(), "Italian Game: Classical Variation, Giuoco Pianissimo");
```"#
)]
