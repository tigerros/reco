...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::italian_game::classical_variation::giuoco_pianissimo::WITH_A6;
assert_eq!(WITH_A6.original_name(), "Italian Game: Classical Variation, Giuoco Pianissimo, with a6");
```"#
)]
pub static WITH_A6: Variation = Variation {
    name: "with a6",
