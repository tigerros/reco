...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::italian_game::classical_variation::giuoco_pianissimo::WITH_H6;
assert_eq!(WITH_H6.original_name(), "Italian Game: Classical Variation, Giuoco Pianissimo, with h6");
```"#
)]
pub static WITH_H6: Variation = Variation {
    name: "with h6",
