...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::italian_game::classical_variation::CLOSED_VARIATION;
assert_eq!(CLOSED_VARIATION.original_name(), "Italian Game: Classical Variation, Closed Variation");
```"#
)]
