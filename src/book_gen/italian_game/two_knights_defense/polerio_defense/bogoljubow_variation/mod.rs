...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::italian_game::two_knights_defense::polerio_defense::BOGOLJUBOW_VARIATION;
assert_eq!(BOGOLJUBOW_VARIATION.original_name(), "Italian Game: Two Knights Defense, Polerio Defense, Bogoljubow Variation");
```"#
)]
