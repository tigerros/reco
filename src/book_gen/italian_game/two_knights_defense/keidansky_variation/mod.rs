...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::italian_game::two_knights_defense::KEIDANSKY_VARIATION;
assert_eq!(KEIDANSKY_VARIATION.original_name(), "Italian Game: Two Knights Defense, Keidansky Variation");
```"#
)]
pub static KEIDANSKY_VARIATION: Variation = Variation {
    name: "Keidansky Variation",
    parent: Some(&super::TWO_KNIGHTS_DEFENSE),
    variations: &[],
    lines: &[Line {
        parent: &KEIDANSKY_VARIATION,
        code: Code {
            volume: Volume::C,
