...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::italian_game::two_knights_defense::KNIGHT_ATTACK;
assert_eq!(KNIGHT_ATTACK.original_name(), "Italian Game: Two Knights Defense, Knight Attack");
```"#
)]
pub static KNIGHT_ATTACK: Variation = Variation {
    name: "Knight Attack",
    parent: Some(&super::TWO_KNIGHTS_DEFENSE),
    variations: &[&NORMAL_VARIATION],
    lines: &[Line {
        parent: &KNIGHT_ATTACK,
        code: Code {
            volume: Volume::C,
