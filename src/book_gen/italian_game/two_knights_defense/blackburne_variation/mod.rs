...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::italian_game::two_knights_defense::BLACKBURNE_VARIATION;
assert_eq!(BLACKBURNE_VARIATION.original_name(), "Italian Game: Two Knights Defense, Blackburne Variation");
```"#
)]
