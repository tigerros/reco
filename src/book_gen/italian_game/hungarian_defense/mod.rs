...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::italian_game::HUNGARIAN_DEFENSE;
assert_eq!(HUNGARIAN_DEFENSE.original_name(), "Italian Game: Hungarian Defense");
```"#
)]
pub static HUNGARIAN_DEFENSE: Variation = Variation {
    name: "Hungarian Defense",
    parent: Some(&super::ITALIAN_GAME),
    variations: &[&TARTAKOWER_VARIATION],
    lines: &[Line {
        parent: &HUNGARIAN_DEFENSE,
        code: Code {
            volume: Volume::C,
