...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::italian_game::evans_gambit::MORTIMER_EVANS_GAMBIT;
assert_eq!(MORTIMER_EVANS_GAMBIT.original_name(), "Italian Game: Evans Gambit, Mortimer-Evans Gambit");
```"#
)]
