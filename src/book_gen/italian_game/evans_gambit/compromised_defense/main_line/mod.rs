...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::italian_game::evans_gambit::compromised_defense::MAIN_LINE;
assert_eq!(MAIN_LINE.original_name(), "Italian Game: Evans Gambit, Compromised Defense, Main Line");
```"#
)]
