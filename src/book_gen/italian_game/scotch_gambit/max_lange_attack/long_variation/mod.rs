...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::italian_game::scotch_gambit::max_lange_attack::LONG_VARIATION;
assert_eq!(LONG_VARIATION.original_name(), "Italian Game: Scotch Gambit, Max Lange Attack, Long Variation");
```"#
)]
pub static LONG_VARIATION: Variation = Variation {
    name: "Long Variation",
    parent: Some(&super::MAX_LANGE_ATTACK),
    variations: &[],
    lines: &[Line {
        parent: &LONG_VARIATION,
        code: Code {
            volume: Volume::C,
