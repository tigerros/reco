...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::french_defense::classical_variation::RUBINSTEIN_VARIATION;
assert_eq!(RUBINSTEIN_VARIATION.original_name(), "French Defense: Classical Variation, Rubinstein Variation");
```"#
)]
