...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::french_defense::classical_variation::TARRASCH_VARIATION;
assert_eq!(TARRASCH_VARIATION.original_name(), "French Defense: Classical Variation, Tarrasch Variation");
```"#
)]
