...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::french_defense::classical_variation::burn_variation::MAIN_LINE;
assert_eq!(MAIN_LINE.original_name(), "French Defense: Classical Variation, Burn Variation, Main Line");
```"#
)]
