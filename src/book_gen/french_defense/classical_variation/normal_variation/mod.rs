...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::french_defense::classical_variation::NORMAL_VARIATION;
assert_eq!(NORMAL_VARIATION.original_name(), "French Defense: Classical Variation, Normal Variation");
```"#
)]
