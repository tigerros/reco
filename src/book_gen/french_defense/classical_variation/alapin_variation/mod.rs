...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::french_defense::classical_variation::ALAPIN_VARIATION;
assert_eq!(ALAPIN_VARIATION.original_name(), "French Defense: Classical Variation, Alapin Variation");
```"#
)]
