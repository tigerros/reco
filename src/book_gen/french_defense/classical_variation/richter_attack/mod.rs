...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::french_defense::classical_variation::RICHTER_ATTACK;
assert_eq!(RICHTER_ATTACK.original_name(), "French Defense: Classical Variation, Richter Attack");
```"#
)]
