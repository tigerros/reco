...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::french_defense::MEDITERRANEAN_DEFENSE;
assert_eq!(MEDITERRANEAN_DEFENSE.original_name(), "French Defense: Mediterranean Defense");
```"#
)]
pub static MEDITERRANEAN_DEFENSE: Variation = Variation {
    name: "Mediterranean Defense",
    parent: Some(&super::FRENCH_DEFENSE),
    variations: &[],
    lines: &[Line {
        parent: &MEDITERRANEAN_DEFENSE,
        code: Code {
            volume: Volume::C,
