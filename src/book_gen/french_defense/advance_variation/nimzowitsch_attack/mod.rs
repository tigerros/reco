...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::french_defense::advance_variation::NIMZOWITSCH_ATTACK;
assert_eq!(NIMZOWITSCH_ATTACK.original_name(), "French Defense: Advance Variation, Nimzowitsch Attack");
```"#
)]
