...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::french_defense::advance_variation::milner_barry_gambit::MAIN_LINE;
assert_eq!(MAIN_LINE.original_name(), "French Defense: Advance Variation, Milner-Barry Gambit, Main Line");
```"#
)]
