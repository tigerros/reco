...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::french_defense::winawer_variation::CLASSICAL_VARIATION;
assert_eq!(CLASSICAL_VARIATION.original_name(), "French Defense: Winawer Variation, Classical Variation");
```"#
)]
