...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::french_defense::winawer_variation::DELAYED_EXCHANGE_VARIATION;
assert_eq!(DELAYED_EXCHANGE_VARIATION.original_name(), "French Defense: Winawer Variation, Delayed Exchange Variation");
```"#
)]
