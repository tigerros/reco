...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::french_defense::winawer_variation::ADVANCE_VARIATION;
assert_eq!(ADVANCE_VARIATION.original_name(), "French Defense: Winawer Variation, Advance Variation");
```"#
)]
pub static ADVANCE_VARIATION: Variation = Variation {
    name: "Advance Variation",
    parent: Some(&super::WINAWER_VARIATION),
    variations: &[&MOSCOW_VARIATION, &SMYSLOV_VARIATION],
    lines: &[
        Line {
        ...
        Line {
            ...
            setup: Setup {
                board: if let Ok(board) = Board::try_from_bitboards(
                    ...
                    ByColor {
                        black: Bitboard(16132755933896900608),
