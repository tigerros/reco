...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::french_defense::winawer_variation::EINGORN_VARIATION;
assert_eq!(EINGORN_VARIATION.original_name(), "French Defense: Winawer Variation, Eingorn Variation");
```"#
)]
