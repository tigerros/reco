...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::french_defense::winawer_variation::BOGOLJUBOW_VARIATION;
assert_eq!(BOGOLJUBOW_VARIATION.original_name(), "French Defense: Winawer Variation, Bogoljubow Variation");
```"#
)]
pub static BOGOLJUBOW_VARIATION: Variation = Variation {
    name: "Bogoljubow Variation",
    parent: Some(&super::WINAWER_VARIATION),
    variations: &[&ICELANDIC_DEFENSE],
    lines: &[Line {
