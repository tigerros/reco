...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::french_defense::winawer_variation::FINGERSLIP_VARIATION;
assert_eq!(FINGERSLIP_VARIATION.original_name(), "French Defense: Winawer Variation, Fingerslip Variation");
```"#
)]
