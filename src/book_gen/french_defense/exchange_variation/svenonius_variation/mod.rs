...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::french_defense::exchange_variation::SVENONIUS_VARIATION;
assert_eq!(SVENONIUS_VARIATION.original_name(), "French Defense: Exchange Variation, Svenonius Variation");
```"#
)]
