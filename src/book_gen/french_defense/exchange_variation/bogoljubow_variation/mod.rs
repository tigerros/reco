...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::french_defense::exchange_variation::BOGOLJUBOW_VARIATION;
assert_eq!(BOGOLJUBOW_VARIATION.original_name(), "French Defense: Exchange Variation, Bogoljubow Variation");
```"#
)]
