...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::french_defense::rubinstein_variation::ELLIS_GAMBIT;
assert_eq!(ELLIS_GAMBIT.original_name(), "French Defense: Rubinstein Variation, Ellis Gambit");
```"#
)]
pub static ELLIS_GAMBIT: Variation = Variation {
    name: "Ellis Gambit",
