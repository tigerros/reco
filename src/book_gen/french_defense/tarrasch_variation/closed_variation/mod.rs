...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::french_defense::tarrasch_variation::CLOSED_VARIATION;
assert_eq!(CLOSED_VARIATION.original_name(), "French Defense: Tarrasch Variation, Closed Variation");
```"#
)]
