...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::french_defense::tarrasch_variation::MOROZEVICH_VARIATION;
assert_eq!(MOROZEVICH_VARIATION.original_name(), "French Defense: Tarrasch Variation, Morozevich Variation");
```"#
)]
