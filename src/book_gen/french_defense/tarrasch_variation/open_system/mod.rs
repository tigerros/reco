...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::french_defense::tarrasch_variation::OPEN_SYSTEM;
assert_eq!(OPEN_SYSTEM.original_name(), "French Defense: Tarrasch Variation, Open System");
```"#
)]
pub static OPEN_SYSTEM: Variation = Variation {
    name: "Open System",
