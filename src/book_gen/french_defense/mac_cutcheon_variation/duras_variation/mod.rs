...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::french_defense::mac_cutcheon_variation::DURAS_VARIATION;
assert_eq!(DURAS_VARIATION.original_name(), "French Defense: MacCutcheon Variation, Duras Variation");
```"#
)]
