...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::french_defense::mc_cutcheon_variation::GRIGORIEV_VARIATION;
assert_eq!(GRIGORIEV_VARIATION.original_name(), "French Defense: McCutcheon Variation, Grigoriev Variation");
```"#
)]
