...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::french_defense::mc_cutcheon_variation::LASKER_VARIATION;
assert_eq!(LASKER_VARIATION.original_name(), "French Defense: McCutcheon Variation, Lasker Variation");
```"#
)]
