...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::french_defense::st_george_defense::ST_GEORGE_GAMBIT;
assert_eq!(ST_GEORGE_GAMBIT.original_name(), "French Defense: St. George Defense, St. George Gambit");
```"#
)]
