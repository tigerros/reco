        ...
        Line {
            ...
            setup: Setup {
                board: if let Ok(board) = Board::try_from_bitboards(
                    ...
                    ByColor {
                        black: Bitboard(13396860924531310592),
                        white: Bitboard(205448597),
                    },
                ) {
                    board
                } else {
        ...
        Line {
            ...
            setup: Setup {
                board: if let Ok(board) = Board::try_from_bitboards(
                    ...
                    ByColor {
                        black: Bitboard(6767568870111707136),
                        white: Bitboard(205449105),
                    },
                ) {
                    board
                } else {
        ...
        Line {
            ...
            setup: Setup {
                board: if let Ok(board) = Board::try_from_bitboards(
                    ...
                    ByColor {
                        black: Bitboard(7348533222042501120),
                        white: Bitboard(205449105),
                    },
                ) {
                    board
