...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::semi_slav_defense::meran_variation::WADE_VARIATION;
assert_eq!(WADE_VARIATION.original_name(), "Semi-Slav Defense: Meran Variation, Wade Variation");
```"#
)]
pub static WADE_VARIATION: Variation = Variation {
    name: "Wade Variation",
    parent: Some(&super::MERAN_VARIATION),
    variations: &[&KAIDANOV_GAMBIT, &LARSEN_VARIATION],
    lines: &[Line {
