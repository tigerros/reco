...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::semi_slav_defense::NORMAL_VARIATION;
assert_eq!(NORMAL_VARIATION.original_name(), "Semi-Slav Defense: Normal Variation");
```"#
)]
            ...
            setup: Setup {
                board: if let Ok(board) = Board::try_from_bitboards(
                    ByRole {
                        pawn: Bitboard(63916844508176640),
                        knight: Bitboard(2286984188133376),
                        bishop: Bitboard(288239172244738560),
                        rook: Bitboard(2377900603251622017),
                        queen: Bitboard(576460752303423496),
                        king: Bitboard(4611686018427387920),
                    },
