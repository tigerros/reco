...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::semi_slav_defense::stoltz_variation::CENTER_VARIATION;
assert_eq!(CENTER_VARIATION.original_name(), "Semi-Slav Defense: Stoltz Variation, Center Variation");
```"#
)]
pub static CENTER_VARIATION: Variation = Variation {
    name: "Center Variation",
    parent: Some(&super::STOLTZ_VARIATION),
    variations: &[&MIKHALCHISHIN_LINE],
    lines: &[Line {
