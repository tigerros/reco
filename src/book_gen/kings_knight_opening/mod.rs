...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::KINGS_KNIGHT_OPENING;
assert_eq!(KINGS_KNIGHT_OPENING.original_name(), "King's Knight Opening");
```"#
)]
pub static KINGS_KNIGHT_OPENING: Variation = Variation {
    name: "King's Knight Opening",
    parent: None,
    variations: &[&KONSTANTINOPOLSKY, &NORMAL_VARIATION],
    lines: &[Line {
        parent: &KINGS_KNIGHT_OPENING,
        code: Code {
            volume: Volume::C,
