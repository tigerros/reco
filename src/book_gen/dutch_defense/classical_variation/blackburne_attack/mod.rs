...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::dutch_defense::classical_variation::BLACKBURNE_ATTACK;
assert_eq!(BLACKBURNE_ATTACK.original_name(), "Dutch Defense: Classical Variation, Blackburne Attack");
```"#
)]
