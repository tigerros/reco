...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::dutch_defense::HOPTON_ATTACK;
assert_eq!(HOPTON_ATTACK.original_name(), "Dutch Defense: Hopton Attack");
```"#
)]
pub static HOPTON_ATTACK: Variation = Variation {
    name: "Hopton Attack",
    parent: Some(&super::DUTCH_DEFENSE),
    variations: &[],
    lines: &[Line {
        parent: &HOPTON_ATTACK,
        code: Code {
            volume: Volume::A,
