...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::dutch_defense::staunton_gambit::ALEKHINE_VARIATION;
assert_eq!(ALEKHINE_VARIATION.original_name(), "Dutch Defense: Staunton Gambit, Alekhine Variation");
```"#
)]
