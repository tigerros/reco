...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::indian_defense::BUDAPEST_DEFENSE;
assert_eq!(BUDAPEST_DEFENSE.original_name(), "Indian Defense: Budapest Defense");
```"#
)]
pub static BUDAPEST_DEFENSE: Variation = Variation {
