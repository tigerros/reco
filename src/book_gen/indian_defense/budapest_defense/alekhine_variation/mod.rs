...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::indian_defense::budapest_defense::ALEKHINE_VARIATION;
assert_eq!(ALEKHINE_VARIATION.original_name(), "Indian Defense: Budapest Defense, Alekhine Variation");
```"#
)]
pub static ALEKHINE_VARIATION: Variation = Variation {
    name: "Alekhine Variation",
    parent: Some(&super::BUDAPEST_DEFENSE),
    variations: &[&ABONYI_VARIATION, &TARTAKOWER_DEFENSE],
    lines: &[Line {
        ...
        setup: Setup {
            board: if let Ok(board) = Board::try_from_bitboards(
                ByRole {
                    pawn: Bitboard(67272588488925952),
