...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::indian_defense::OMEGA_GAMBIT;
assert_eq!(OMEGA_GAMBIT.original_name(), "Indian Defense: Omega Gambit");
```"#
)]
pub static OMEGA_GAMBIT: Variation = Variation {
    name: "Omega Gambit",
    parent: Some(&super::INDIAN_DEFENSE),
    variations: &[&ARAFAT_GAMBIT],
    lines: &[Line {
        parent: &OMEGA_GAMBIT,
        code: Code {
            volume: Volume::A,
