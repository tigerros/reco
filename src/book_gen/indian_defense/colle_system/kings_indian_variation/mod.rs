...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::indian_defense::colle_system::KINGS_INDIAN_VARIATION;
assert_eq!(KINGS_INDIAN_VARIATION.original_name(), "Indian Defense: Colle System, King's Indian Variation");
```"#
)]
