...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::grunfeld_defense::exchange_variation::CLASSICAL_VARIATION;
assert_eq!(CLASSICAL_VARIATION.original_name(), "Grünfeld Defense: Exchange Variation, Classical Variation");
```"#
)]
