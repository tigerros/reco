...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::grunfeld_defense::exchange_variation::LARSEN_VARIATION;
assert_eq!(LARSEN_VARIATION.original_name(), "Grünfeld Defense: Exchange Variation, Larsen Variation");
```"#
)]
