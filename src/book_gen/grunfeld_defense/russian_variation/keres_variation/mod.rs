...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::grunfeld_defense::russian_variation::KERES_VARIATION;
assert_eq!(KERES_VARIATION.original_name(), "Grünfeld Defense: Russian Variation, Keres Variation");
```"#
)]
