...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::grunfeld_defense::russian_variation::LEVENFISH_VARIATION;
assert_eq!(LEVENFISH_VARIATION.original_name(), "Grünfeld Defense: Russian Variation, Levenfish Variation");
```"#
)]
