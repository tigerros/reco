...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::grunfeld_defense::brinckmann_attack::GRUNFELD_GAMBIT_ACCEPTED;
assert_eq!(GRUNFELD_GAMBIT_ACCEPTED.original_name(), "Grünfeld Defense: Brinckmann Attack, Grünfeld Gambit Accepted");
```"#
)]
pub static GRUNFELD_GAMBIT_ACCEPTED: Variation = Variation {
    ...
    variations: &[],
    lines: &[Line {
        parent: &GRUNFELD_GAMBIT_ACCEPTED,
        code: Code {
            volume: Volume::D,
