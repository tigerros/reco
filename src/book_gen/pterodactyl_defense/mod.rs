...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::PTERODACTYL_DEFENSE;
assert_eq!(PTERODACTYL_DEFENSE.original_name(), "Pterodactyl Defense");
```"#
)]
pub static PTERODACTYL_DEFENSE: Variation = Variation {
