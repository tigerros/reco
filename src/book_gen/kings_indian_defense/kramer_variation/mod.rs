...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::kings_indian_defense::KRAMER_VARIATION;
assert_eq!(KRAMER_VARIATION.original_name(), "King's Indian Defense: Kramer Variation");
```"#
)]
pub static KRAMER_VARIATION: Variation = Variation {
    name: "Kramer Variation",
    parent: Some(&super::KINGS_INDIAN_DEFENSE),
    variations: &[],
    lines: &[Line {
        parent: &KRAMER_VARIATION,
        code: Code {
            volume: Volume::E,
