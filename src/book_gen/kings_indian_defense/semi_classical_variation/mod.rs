...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::kings_indian_defense::SEMI_CLASSICAL_VARIATION;
assert_eq!(SEMI_CLASSICAL_VARIATION.original_name(), "King's Indian Defense: Semi-Classical Variation");
```"#
)]
pub static SEMI_CLASSICAL_VARIATION: Variation = Variation {
    ...
    lines: &[Line {
        parent: &SEMI_CLASSICAL_VARIATION,
        code: Code {
            volume: Volume::E,
