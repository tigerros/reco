...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::kings_indian_defense::fianchetto_variation::YUGOSLAV_VARIATION;
assert_eq!(YUGOSLAV_VARIATION.original_name(), "King's Indian Defense: Fianchetto Variation, Yugoslav Variation");
```"#
)]
pub static YUGOSLAV_VARIATION: Variation = Variation {
    name: "Yugoslav Variation",
    parent: Some(&super::FIANCHETTO_VARIATION),
    variations: &[&ADVANCE_LINE, &EXCHANGE_LINE, &RARE_LINE],
    lines: &[Line {
