...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::kings_indian_defense::fianchetto_variation::LONG_VARIATION;
assert_eq!(LONG_VARIATION.original_name(), "King's Indian Defense: Fianchetto Variation, Long Variation");
```"#
)]
