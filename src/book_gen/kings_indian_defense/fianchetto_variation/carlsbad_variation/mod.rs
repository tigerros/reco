...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::kings_indian_defense::fianchetto_variation::CARLSBAD_VARIATION;
assert_eq!(CARLSBAD_VARIATION.original_name(), "King's Indian Defense: Fianchetto Variation, Carlsbad Variation");
```"#
)]
