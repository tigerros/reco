...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::kings_indian_defense::fianchetto_variation::PTERODACTYL_VARIATION;
assert_eq!(PTERODACTYL_VARIATION.original_name(), "King's Indian Defense: Fianchetto Variation, Pterodactyl Variation");
```"#
)]
