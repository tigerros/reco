...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::kings_indian_defense::samisch_variation::PANNO_MAIN_LINE;
assert_eq!(PANNO_MAIN_LINE.original_name(), "King's Indian Defense: Sämisch Variation, Panno Main Line");
```"#
)]
pub static PANNO_MAIN_LINE: Variation = Variation {
    name: "Panno Main Line",
    parent: Some(&super::SAMISCH_VARIATION),
    variations: &[],
    lines: &[Line {
        parent: &PANNO_MAIN_LINE,
        code: Code {
            volume: Volume::E,
