...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::kings_indian_defense::samisch_variation::ORTHODOX_VARIATION;
assert_eq!(ORTHODOX_VARIATION.original_name(), "King's Indian Defense: Sämisch Variation, Orthodox Variation");
```"#
)]
    ...
    lines: &[Line {
        ...
        setup: Setup {
            board: if let Ok(board) = Board::try_from_bitboards(
                ByRole {
                    pawn: Bitboard(47085555139265280),
