...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::kings_indian_defense::averbakh_variation::MODERN_DEFENSE;
assert_eq!(MODERN_DEFENSE.original_name(), "King's Indian Defense: Averbakh Variation, Modern Defense");
```"#
)]
pub static MODERN_DEFENSE: Variation = Variation {
    name: "Modern Defense",
    parent: Some(&super::AVERBAKH_VARIATION),
    variations: &[&BURGESS_LINE],
    lines: &[Line {
