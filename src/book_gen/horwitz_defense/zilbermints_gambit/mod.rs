...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::horwitz_defense::ZILBERMINTS_GAMBIT;
assert_eq!(ZILBERMINTS_GAMBIT.original_name(), "Horwitz Defense: Zilbermints Gambit");
```"#
)]
pub static ZILBERMINTS_GAMBIT: Variation = Variation {
    name: "Zilbermints Gambit",
    parent: Some(&super::HORWITZ_DEFENSE),
    variations: &[],
    lines: &[Line {
