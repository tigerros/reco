...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::english_opening::kings_english_variation::TWO_KNIGHTS_VARIATION;
assert_eq!(TWO_KNIGHTS_VARIATION.original_name(), "English Opening: King's English Variation, Two Knights Variation");
```"#
)]
