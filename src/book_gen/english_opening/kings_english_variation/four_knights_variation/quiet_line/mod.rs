...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::english_opening::kings_english_variation::four_knights_variation::QUIET_LINE;
assert_eq!(QUIET_LINE.original_name(), "English Opening: King's English Variation, Four Knights Variation, Quiet Line");
```"#
)]
