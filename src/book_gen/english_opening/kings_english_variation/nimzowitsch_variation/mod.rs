...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::english_opening::kings_english_variation::NIMZOWITSCH_VARIATION;
assert_eq!(NIMZOWITSCH_VARIATION.original_name(), "English Opening: King's English Variation, Nimzowitsch Variation");
```"#
)]
