...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::english_opening::symmetrical_variation::BOTVINNIK_SYSTEM;
assert_eq!(BOTVINNIK_SYSTEM.original_name(), "English Opening: Symmetrical Variation, Botvinnik System");
```"#
)]
