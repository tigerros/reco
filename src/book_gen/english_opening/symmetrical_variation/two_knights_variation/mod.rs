...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::english_opening::symmetrical_variation::TWO_KNIGHTS_VARIATION;
assert_eq!(TWO_KNIGHTS_VARIATION.original_name(), "English Opening: Symmetrical Variation, Two Knights Variation");
```"#
)]
