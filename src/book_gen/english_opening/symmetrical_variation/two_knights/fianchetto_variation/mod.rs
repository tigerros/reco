...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::english_opening::symmetrical_variation::two_knights::FIANCHETTO_VARIATION;
assert_eq!(FIANCHETTO_VARIATION.original_name(), "English Opening: Symmetrical Variation, Two Knights, Fianchetto Variation");
```"#
)]
pub static FIANCHETTO_VARIATION: Variation = Variation {
    name: "Fianchetto Variation",
    parent: Some(&super::TWO_KNIGHTS),
    variations: &[],
    lines: &[Line {
