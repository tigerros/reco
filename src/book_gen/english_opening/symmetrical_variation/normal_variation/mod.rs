...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::english_opening::symmetrical_variation::NORMAL_VARIATION;
assert_eq!(NORMAL_VARIATION.original_name(), "English Opening: Symmetrical Variation, Normal Variation");
```"#
)]
