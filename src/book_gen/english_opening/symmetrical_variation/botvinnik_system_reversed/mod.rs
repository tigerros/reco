...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::english_opening::symmetrical_variation::BOTVINNIK_SYSTEM_REVERSED;
assert_eq!(BOTVINNIK_SYSTEM_REVERSED.original_name(), "English Opening: Symmetrical Variation, Botvinnik System Reversed");
```"#
)]
