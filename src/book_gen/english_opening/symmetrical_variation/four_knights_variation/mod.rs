...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::english_opening::symmetrical_variation::FOUR_KNIGHTS_VARIATION;
assert_eq!(FOUR_KNIGHTS_VARIATION.original_name(), "English Opening: Symmetrical Variation, Four Knights Variation");
```"#
)]
