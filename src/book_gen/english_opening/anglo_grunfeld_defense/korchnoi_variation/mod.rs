...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::english_opening::anglo_grunfeld_defense::KORCHNOI_VARIATION;
assert_eq!(KORCHNOI_VARIATION.original_name(), "English Opening: Anglo-Grünfeld Defense, Korchnoi Variation");
```"#
)]
