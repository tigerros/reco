...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::english_opening::anglo_indian_defense::SCANDINAVIAN_DEFENSE;
assert_eq!(SCANDINAVIAN_DEFENSE.original_name(), "English Opening: Anglo-Indian Defense, Scandinavian Defense");
```"#
)]
