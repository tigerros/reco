...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::queens_gambit_accepted::CLASSICAL;
assert_eq!(CLASSICAL.original_name(), "Queen's Gambit Accepted: Classical");
```"#
)]
pub static CLASSICAL: Variation = Variation {
    name: "Classical",
    parent: Some(&super::QUEENS_GAMBIT_ACCEPTED),
    variations: &[&FLOHR_VARIATION, &FURMAN_VARIATION],
    lines: &[],
};
