...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::queens_gambit_accepted::classical_defense::ALEKHINE_SYSTEM;
assert_eq!(ALEKHINE_SYSTEM.original_name(), "Queen's Gambit Accepted: Classical Defense, Alekhine System");
```"#
)]
pub static ALEKHINE_SYSTEM: Variation = Variation {
    name: "Alekhine System",
    parent: Some(&super::CLASSICAL_DEFENSE),
    variations: &[&MAIN_LINE, &SMYSLOV_VARIATION],
    lines: &[
        Line {
