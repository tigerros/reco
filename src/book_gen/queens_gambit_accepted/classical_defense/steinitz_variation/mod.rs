...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::queens_gambit_accepted::classical_defense::STEINITZ_VARIATION;
assert_eq!(STEINITZ_VARIATION.original_name(), "Queen's Gambit Accepted: Classical Defense, Steinitz Variation");
```"#
)]
