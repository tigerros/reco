...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::queens_gambit_accepted::classical_defense::steinitz_variation::EXCHANGE_VARIATION;
assert_eq!(EXCHANGE_VARIATION.original_name(), "Queen's Gambit Accepted: Classical Defense, Steinitz Variation, Exchange Variation");
```"#
)]
