...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::queens_gambit_accepted::classical_defense::RUBINSTEIN_VARIATION;
assert_eq!(RUBINSTEIN_VARIATION.original_name(), "Queen's Gambit Accepted: Classical Defense, Rubinstein Variation");
```"#
)]
