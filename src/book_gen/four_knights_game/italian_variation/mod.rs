...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::four_knights_game::ITALIAN_VARIATION;
assert_eq!(ITALIAN_VARIATION.original_name(), "Four Knights Game: Italian Variation");
```"#
)]
pub static ITALIAN_VARIATION: Variation = Variation {
    name: "Italian Variation",
    parent: Some(&super::FOUR_KNIGHTS_GAME),
    variations: &[&NOA_GAMBIT],
    lines: &[
        Line {
