...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::four_knights_game::spanish_variation::JANOWSKI_VARIATION;
assert_eq!(JANOWSKI_VARIATION.original_name(), "Four Knights Game: Spanish Variation, Janowski Variation");
```"#
)]
