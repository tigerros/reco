...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::four_knights_game::spanish_variation::rubinstein_variation::MARSHALL_GAMBIT;
assert_eq!(MARSHALL_GAMBIT.original_name(), "Four Knights Game: Spanish Variation, Rubinstein Variation, Marshall Gambit");
```"#
)]
