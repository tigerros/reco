...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::four_knights_game::spanish_variation::DOUBLE_SPANISH;
assert_eq!(DOUBLE_SPANISH.original_name(), "Four Knights Game: Spanish Variation, Double Spanish");
```"#
)]
pub static DOUBLE_SPANISH: Variation = Variation {
    name: "Double Spanish",
    parent: Some(&super::SPANISH_VARIATION),
    variations: &[],
    lines: &[
        Line {
            parent: &DOUBLE_SPANISH,
            code: Code {
                volume: Volume::C,
