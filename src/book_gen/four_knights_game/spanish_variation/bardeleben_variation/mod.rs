...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::four_knights_game::spanish_variation::BARDELEBEN_VARIATION;
assert_eq!(BARDELEBEN_VARIATION.original_name(), "Four Knights Game: Spanish Variation, Bardeleben Variation");
```"#
)]
