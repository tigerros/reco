...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::four_knights_game::spanish_variation::ALATORTSEV_VARIATION;
assert_eq!(ALATORTSEV_VARIATION.original_name(), "Four Knights Game: Spanish Variation, Alatortsev Variation");
```"#
)]
