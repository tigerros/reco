...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::four_knights_game::spanish_variation::SPIELMANN_VARIATION;
assert_eq!(SPIELMANN_VARIATION.original_name(), "Four Knights Game: Spanish Variation, Spielmann Variation");
```"#
)]
