...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::four_knights_game::HALLOWEEN_GAMBIT;
assert_eq!(HALLOWEEN_GAMBIT.original_name(), "Four Knights Game: Halloween Gambit");
```"#
)]
pub static HALLOWEEN_GAMBIT: Variation = Variation {
    name: "Halloween Gambit",
    parent: Some(&super::FOUR_KNIGHTS_GAME),
    variations: &[&OLDTIMER_VARIATION, &PLASMA_VARIATION],
    lines: &[Line {
        parent: &HALLOWEEN_GAMBIT,
        code: Code {
            volume: Volume::C,
