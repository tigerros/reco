...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::BONGCLOUD_ATTACK;
assert_eq!(BONGCLOUD_ATTACK.original_name(), "Bongcloud Attack");
```"#
)]
pub static BONGCLOUD_ATTACK: Variation = Variation {
    name: "Bongcloud Attack",
    parent: None,
    variations: &[],
    lines: &[Line {
        parent: &BONGCLOUD_ATTACK,
        code: Code {
            volume: Volume::C,
