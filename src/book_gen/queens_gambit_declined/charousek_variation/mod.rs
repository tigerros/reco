...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::queens_gambit_declined::CHAROUSEK_VARIATION;
assert_eq!(CHAROUSEK_VARIATION.original_name(), "Queen's Gambit Declined: Charousek Variation");
```"#
)]
pub static CHAROUSEK_VARIATION: Variation = Variation {
    name: "Charousek Variation",
    parent: Some(&super::QUEENS_GAMBIT_DECLINED),
    variations: &[&MILADINOVIC_GAMBIT],
    lines: &[Line {
