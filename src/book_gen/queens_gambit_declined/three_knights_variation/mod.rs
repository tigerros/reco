...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::queens_gambit_declined::THREE_KNIGHTS_VARIATION;
assert_eq!(THREE_KNIGHTS_VARIATION.original_name(), "Queen's Gambit Declined: Three Knights Variation");
```"#
)]
