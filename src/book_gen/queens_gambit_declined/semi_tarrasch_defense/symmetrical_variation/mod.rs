...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::queens_gambit_declined::semi_tarrasch_defense::SYMMETRICAL_VARIATION;
assert_eq!(SYMMETRICAL_VARIATION.original_name(), "Queen's Gambit Declined: Semi-Tarrasch Defense, Symmetrical Variation");
```"#
)]
