...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::queens_gambit_declined::semi_tarrasch_defense::MAIN_LINE;
assert_eq!(MAIN_LINE.original_name(), "Queen's Gambit Declined: Semi-Tarrasch Defense, Main Line");
```"#
)]
