...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::queens_gambit_declined::VIENNA_VARIATION;
assert_eq!(VIENNA_VARIATION.original_name(), "Queen's Gambit Declined: Vienna Variation");
```"#
)]
pub static VIENNA_VARIATION: Variation = Variation {
    name: "Vienna Variation",
    parent: Some(&super::QUEENS_GAMBIT_DECLINED),
    variations: &[&QUIET_VARIATION],
    lines: &[Line {
