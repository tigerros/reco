...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::queens_gambit_declined::chigorin_defense::JANOWSKI_VARIATION;
assert_eq!(JANOWSKI_VARIATION.original_name(), "Queen's Gambit Declined: Chigorin Defense, Janowski Variation");
```"#
)]
