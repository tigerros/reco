...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::queens_gambit_declined::chigorin_defense::MODERN_GAMBIT;
assert_eq!(MODERN_GAMBIT.original_name(), "Queen's Gambit Declined: Chigorin Defense, Modern Gambit");
```"#
)]
