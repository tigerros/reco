...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::queens_gambit_declined::harrwitz_attack::ORTHODOX_DEFENSE;
assert_eq!(ORTHODOX_DEFENSE.original_name(), "Queen's Gambit Declined: Harrwitz Attack, Orthodox Defense");
```"#
)]
