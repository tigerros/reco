...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::queens_gambit_declined::albin_countergambit::FIANCHETTO_VARIATION;
assert_eq!(FIANCHETTO_VARIATION.original_name(), "Queen's Gambit Declined: Albin Countergambit, Fianchetto Variation");
```"#
)]
