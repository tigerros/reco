...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::queens_gambit_declined::HASTINGS_VARIATION;
assert_eq!(HASTINGS_VARIATION.original_name(), "Queen's Gambit Declined: Hastings Variation");
```"#
)]
