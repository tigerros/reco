...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::queens_gambit_declined::exchange_variation::SAMISCH_VARIATION;
assert_eq!(SAMISCH_VARIATION.original_name(), "Queen's Gambit Declined: Exchange Variation, Sämisch Variation");
```"#
)]
