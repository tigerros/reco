...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::queens_gambit_declined::BALTIC_DEFENSE;
assert_eq!(BALTIC_DEFENSE.original_name(), "Queen's Gambit Declined: Baltic Defense");
```"#
)]
pub static BALTIC_DEFENSE: Variation = Variation {
    name: "Baltic Defense",
    ...
    variations: &[
        ...
        &PSEUDO_SLAV,
        &QUEEN_ATTACK,
        &QUEEN_ATTACK_DEFERRED,
    ],
    lines: &[Line {
        parent: &BALTIC_DEFENSE,
        code: Code {
            volume: Volume::D,
