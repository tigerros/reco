...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::queens_gambit_declined::semi_slav::ABRAHAMS_VARIATION;
assert_eq!(ABRAHAMS_VARIATION.original_name(), "Queen's Gambit Declined: Semi-Slav, Abrahams Variation");
```"#
)]
