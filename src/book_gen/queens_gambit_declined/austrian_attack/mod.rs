...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::queens_gambit_declined::AUSTRIAN_ATTACK;
assert_eq!(AUSTRIAN_ATTACK.original_name(), "Queen's Gambit Declined: Austrian Attack");
```"#
)]
pub static AUSTRIAN_ATTACK: Variation = Variation {
    name: "Austrian Attack",
    parent: Some(&super::QUEENS_GAMBIT_DECLINED),
    variations: &[&SALVIO_COUNTERGAMBIT],
    lines: &[],
};
