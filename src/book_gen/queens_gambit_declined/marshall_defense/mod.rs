...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::queens_gambit_declined::MARSHALL_DEFENSE;
assert_eq!(MARSHALL_DEFENSE.original_name(), "Queen's Gambit Declined: Marshall Defense");
```"#
)]
pub static MARSHALL_DEFENSE: Variation = Variation {
    name: "Marshall Defense",
    parent: Some(&super::QUEENS_GAMBIT_DECLINED),
    variations: &[&TAN_GAMBIT],
    lines: &[Line {
        parent: &MARSHALL_DEFENSE,
        code: Code {
            volume: Volume::D,
