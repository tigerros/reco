...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::queens_gambit_declined::modern_variation::NORMAL_LINE;
assert_eq!(NORMAL_LINE.original_name(), "Queen's Gambit Declined: Modern Variation, Normal Line");
```"#
)]
