...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::queens_gambit_declined::modern_variation::KNIGHT_DEFENSE;
assert_eq!(KNIGHT_DEFENSE.original_name(), "Queen's Gambit Declined: Modern Variation, Knight Defense");
```"#
)]
pub static KNIGHT_DEFENSE: Variation = Variation {
    name: "Knight Defense",
    parent: Some(&super::MODERN_VARIATION),
    variations: &[],
    lines: &[
        Line {
            parent: &KNIGHT_DEFENSE,
            code: Code {
                volume: Volume::D,
