...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::queens_gambit_declined::orthodox_defense::RUBINSTEIN_VARIATION;
assert_eq!(RUBINSTEIN_VARIATION.original_name(), "Queen's Gambit Declined: Orthodox Defense, Rubinstein Variation");
```"#
)]
pub static RUBINSTEIN_VARIATION: Variation = Variation {
    name: "Rubinstein Variation",
    parent: Some(&super::ORTHODOX_DEFENSE),
    variations: &[&FLOHR_LINE],
    lines: &[Line {
