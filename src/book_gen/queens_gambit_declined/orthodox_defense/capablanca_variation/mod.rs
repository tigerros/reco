...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::queens_gambit_declined::orthodox_defense::CAPABLANCA_VARIATION;
assert_eq!(CAPABLANCA_VARIATION.original_name(), "Queen's Gambit Declined: Orthodox Defense, Capablanca Variation");
```"#
)]
