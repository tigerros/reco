...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::queens_gambit_declined::orthodox_defense::RUBINSTEIN_ATTACK;
assert_eq!(RUBINSTEIN_ATTACK.original_name(), "Queen's Gambit Declined: Orthodox Defense, Rubinstein Attack");
```"#
)]
pub static RUBINSTEIN_ATTACK: Variation = Variation {
    name: "Rubinstein Attack",
