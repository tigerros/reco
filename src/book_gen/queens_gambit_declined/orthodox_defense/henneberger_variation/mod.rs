...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::queens_gambit_declined::orthodox_defense::HENNEBERGER_VARIATION;
assert_eq!(HENNEBERGER_VARIATION.original_name(), "Queen's Gambit Declined: Orthodox Defense, Henneberger Variation");
```"#
)]
