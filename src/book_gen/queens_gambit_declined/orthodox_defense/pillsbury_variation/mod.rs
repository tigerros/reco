...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::queens_gambit_declined::orthodox_defense::PILLSBURY_VARIATION;
assert_eq!(PILLSBURY_VARIATION.original_name(), "Queen's Gambit Declined: Orthodox Defense, Pillsbury Variation");
```"#
)]
