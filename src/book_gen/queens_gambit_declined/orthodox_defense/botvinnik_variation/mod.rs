...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::queens_gambit_declined::orthodox_defense::BOTVINNIK_VARIATION;
assert_eq!(BOTVINNIK_VARIATION.original_name(), "Queen's Gambit Declined: Orthodox Defense, Botvinnik Variation");
```"#
)]
