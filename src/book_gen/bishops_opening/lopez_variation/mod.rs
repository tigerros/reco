...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::bishops_opening::LOPEZ_VARIATION;
assert_eq!(LOPEZ_VARIATION.original_name(), "Bishop's Opening: Lopez Variation");
```"#
)]
pub static LOPEZ_VARIATION: Variation = Variation {
    name: "Lopez Variation",
    parent: Some(&super::BISHOPS_OPENING),
    variations: &[&LOPEZ_GAMBIT],
    lines: &[Line {
