...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::bishops_opening::BOI_VARIATION;
assert_eq!(BOI_VARIATION.original_name(), "Bishop's Opening: Boi Variation");
```"#
)]
pub static BOI_VARIATION: Variation = Variation {
    name: "Boi Variation",
    parent: Some(&super::BISHOPS_OPENING),
    variations: &[],
    lines: &[Line {
        parent: &BOI_VARIATION,
        code: Code {
            volume: Volume::C,
