...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::caro_kann_defense::DE_BRUYCKER_DEFENSE;
assert_eq!(DE_BRUYCKER_DEFENSE.original_name(), "Caro-Kann Defense: De Bruycker Defense");
```"#
)]
pub static DE_BRUYCKER_DEFENSE: Variation = Variation {
    name: "De Bruycker Defense",
    parent: Some(&super::CARO_KANN_DEFENSE),
    variations: &[],
    lines: &[
        Line {
            parent: &DE_BRUYCKER_DEFENSE,
            code: Code {
                volume: Volume::B,
