...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::caro_kann_defense::PANOV_ATTACK;
assert_eq!(PANOV_ATTACK.original_name(), "Caro-Kann Defense: Panov Attack");
```"#
)]
pub static PANOV_ATTACK: Variation = Variation {
    name: "Panov Attack",
