...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::caro_kann_defense::BRONSTEIN_LARSEN_VARIATION;
assert_eq!(BRONSTEIN_LARSEN_VARIATION.original_name(), "Caro-Kann Defense: Bronstein-Larsen Variation");
```"#
)]
pub static BRONSTEIN_LARSEN_VARIATION: Variation = Variation {
