...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::caro_kann_defense::GOLDMAN_VARIATION;
assert_eq!(GOLDMAN_VARIATION.original_name(), "Caro-Kann Defense: Goldman Variation");
```"#
)]
pub static GOLDMAN_VARIATION: Variation = Variation {
    name: "Goldman Variation",
    parent: Some(&super::CARO_KANN_DEFENSE),
    variations: &[],
    lines: &[Line {
        parent: &GOLDMAN_VARIATION,
        code: Code {
            volume: Volume::B,
