...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::caro_kann_defense::TWO_KNIGHTS_ATTACK;
assert_eq!(TWO_KNIGHTS_ATTACK.original_name(), "Caro-Kann Defense: Two Knights Attack");
```"#
)]
pub static TWO_KNIGHTS_ATTACK: Variation = Variation {
    name: "Two Knights Attack",
    parent: Some(&super::CARO_KANN_DEFENSE),
    variations: &[&MINDENO_VARIATION],
    lines: &[Line {
        parent: &TWO_KNIGHTS_ATTACK,
        code: Code {
            volume: Volume::B,
