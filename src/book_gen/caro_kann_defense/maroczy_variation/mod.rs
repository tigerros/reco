...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::caro_kann_defense::MAROCZY_VARIATION;
assert_eq!(MAROCZY_VARIATION.original_name(), "Caro-Kann Defense: Maróczy Variation");
```"#
)]
pub static MAROCZY_VARIATION: Variation = Variation {
    name: "Maróczy Variation",
    parent: Some(&super::CARO_KANN_DEFENSE),
    variations: &[&MAROCZY_GAMBIT],
    lines: &[Line {
