...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::caro_kann_defense::classical_variation::FLOHR_VARIATION;
assert_eq!(FLOHR_VARIATION.original_name(), "Caro-Kann Defense: Classical Variation, Flohr Variation");
```"#
)]
