...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::caro_kann_defense::classical_variation::SEIRAWAN_VARIATION;
assert_eq!(SEIRAWAN_VARIATION.original_name(), "Caro-Kann Defense: Classical Variation, Seirawan Variation");
```"#
)]
pub static SEIRAWAN_VARIATION: Variation = Variation {
    name: "Seirawan Variation",
    parent: Some(&super::CLASSICAL_VARIATION),
    variations: &[],
    lines: &[Line {
        parent: &SEIRAWAN_VARIATION,
        code: Code {
            volume: Volume::B,
