...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::caro_kann_defense::classical_variation::LOBRON_SYSTEM;
assert_eq!(LOBRON_SYSTEM.original_name(), "Caro-Kann Defense: Classical Variation, Lobron System");
```"#
)]
pub static LOBRON_SYSTEM: Variation = Variation {
    name: "Lobron System",
    parent: Some(&super::CLASSICAL_VARIATION),
    variations: &[],
    lines: &[Line {
        parent: &LOBRON_SYSTEM,
        code: Code {
            volume: Volume::B,
