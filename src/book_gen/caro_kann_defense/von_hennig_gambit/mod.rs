...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::caro_kann_defense::VON_HENNIG_GAMBIT;
assert_eq!(VON_HENNIG_GAMBIT.original_name(), "Caro-Kann Defense: von Hennig Gambit");
```"#
)]
