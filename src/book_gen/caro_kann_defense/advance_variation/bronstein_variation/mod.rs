...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::caro_kann_defense::advance_variation::BRONSTEIN_VARIATION;
assert_eq!(BRONSTEIN_VARIATION.original_name(), "Caro-Kann Defense: Advance Variation, Bronstein Variation");
```"#
)]
