...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::caro_kann_defense::ACCELERATED_PANOV_ATTACK;
assert_eq!(ACCELERATED_PANOV_ATTACK.original_name(), "Caro-Kann Defense: Accelerated Panov Attack");
```"#
)]
pub static ACCELERATED_PANOV_ATTACK: Variation = Variation {
    ...
    lines: &[
        Line {
            parent: &ACCELERATED_PANOV_ATTACK,
            code: Code {
                volume: Volume::B,
        ...
        Line {
            ...
            setup: Setup {
                board: if let Ok(board) = Board::try_from_bitboards(
                    ByRole {
                        pawn: Bitboard(68402852082543360),
                        knight: Bitboard(4755801206503243842),
                        bishop: Bitboard(2594073385365405732),
                        rook: Bitboard(9295429630892703873),
                        queen: Bitboard(576460752303423496),
