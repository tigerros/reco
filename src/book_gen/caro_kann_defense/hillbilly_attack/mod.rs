...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::caro_kann_defense::HILLBILLY_ATTACK;
assert_eq!(HILLBILLY_ATTACK.original_name(), "Caro-Kann Defense: Hillbilly Attack");
```"#
)]
pub static HILLBILLY_ATTACK: Variation = Variation {
    name: "Hillbilly Attack",
    parent: Some(&super::CARO_KANN_DEFENSE),
    variations: &[&SCHAEFFER_GAMBIT],
    lines: &[Line {
        parent: &HILLBILLY_ATTACK,
        code: Code {
            volume: Volume::B,
