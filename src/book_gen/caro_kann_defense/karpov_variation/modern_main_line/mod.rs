...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::caro_kann_defense::karpov_variation::MODERN_MAIN_LINE;
assert_eq!(MODERN_MAIN_LINE.original_name(), "Caro-Kann Defense: Karpov Variation, Modern Main Line");
```"#
)]
