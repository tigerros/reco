...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::ware_opening::MEADOW_HAY_TRAP;
assert_eq!(MEADOW_HAY_TRAP.original_name(), "Ware Opening: Meadow Hay Trap");
```"#
)]
pub static MEADOW_HAY_TRAP: Variation = Variation {
    name: "Meadow Hay Trap",
    parent: Some(&super::WARE_OPENING),
    variations: &[],
    lines: &[Line {
        parent: &MEADOW_HAY_TRAP,
        code: Code {
            volume: Volume::A,
