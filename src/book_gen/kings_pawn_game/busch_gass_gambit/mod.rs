...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::kings_pawn_game::BUSCH_GASS_GAMBIT;
assert_eq!(BUSCH_GASS_GAMBIT.original_name(), "King's Pawn Game: Busch-Gass Gambit");
```"#
)]
pub static BUSCH_GASS_GAMBIT: Variation = Variation {
    name: "Busch-Gass Gambit",
    parent: Some(&super::KINGS_PAWN_GAME),
    variations: &[&CHIODINI_GAMBIT],
    lines: &[Line {
        parent: &BUSCH_GASS_GAMBIT,
        code: Code {
            volume: Volume::C,
