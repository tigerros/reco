...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::kings_pawn_game::WEBER_GAMBIT;
assert_eq!(WEBER_GAMBIT.original_name(), "King's Pawn Game: Weber Gambit");
```"#
)]
pub static WEBER_GAMBIT: Variation = Variation {
    name: "Weber Gambit",
