...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::kings_pawn_game::MAC_LEOD_ATTACK;
assert_eq!(MAC_LEOD_ATTACK.original_name(), "King's Pawn Game: MacLeod Attack");
```"#
)]
pub static MAC_LEOD_ATTACK: Variation = Variation {
    name: "MacLeod Attack",
    parent: Some(&super::KINGS_PAWN_GAME),
    variations: &[&LASA_GAMBIT, &NORWALDE_GAMBIT],
    lines: &[Line {
        parent: &MAC_LEOD_ATTACK,
        code: Code {
            volume: Volume::C,
