...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::kings_pawn_game::damiano_defense::DAMIANO_GAMBIT;
assert_eq!(DAMIANO_GAMBIT.original_name(), "King's Pawn Game: Damiano Defense, Damiano Gambit");
```"#
)]
pub static DAMIANO_GAMBIT: Variation = Variation {
    name: "Damiano Gambit",
    parent: Some(&super::DAMIANO_DEFENSE),
    variations: &[&CHIGORIN_GAMBIT],
    lines: &[Line {
        parent: &DAMIANO_GAMBIT,
        code: Code {
            volume: Volume::C,
