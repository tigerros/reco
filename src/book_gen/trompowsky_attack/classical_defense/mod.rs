...
#[cfg_attr(
    feature = "alloc",
    doc = r#"```rust
# use reco::book::trompowsky_attack::CLASSICAL_DEFENSE;
assert_eq!(CLASSICAL_DEFENSE.original_name(), "Trompowsky Attack: Classical Defense");
```"#
)]
pub static CLASSICAL_DEFENSE: Variation = Variation {
    name: "Classical Defense",
    parent: Some(&super::TROMPOWSKY_ATTACK),
    variations: &[&BIG_CENTER_VARIATION],
    lines: &[Line {
